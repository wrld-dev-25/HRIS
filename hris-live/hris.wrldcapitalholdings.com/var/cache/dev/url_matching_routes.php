...
return [
    ...
    [ // $staticRoutes
        ...
        '/api/timesheet' => [[['_route' => 'app_reportsapi_timesheet', '_controller' => 'App\\Controller\\ReportsApiController::timesheet'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
        '/api/payrollsheet' => [[['_route' => 'app_reportsapi_payrollsheet', '_controller' => 'App\\Controller\\ReportsApiController::payrollsheet'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
        '/api/payrollsheet-with-taxshield' => [[['_route' => 'app_reportsapi_payrollwithtaxshield', '_controller' => 'App\\Controller\\ReportsApiController::payrollWithTaxshield'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
        '/api/payrollsheet-with-cash-advances' => [[['_route' => 'app_reportsapi_payrollwithcashadv', '_controller' => 'App\\Controller\\ReportsApiController::payrollWithCashAdv'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
        '/api/payrollsheet-with-salary-adjustment' => [[['_route' => 'app_reportsapi_payrollwithsalaryadj', '_controller' => 'App\\Controller\\ReportsApiController::payrollWithSalaryAdj'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
        '/api/get-payroll-summary' => [[['_route' => 'app_reportsapi_payrollsummary', '_controller' => 'App\\Controller\\ReportsApiController::payrollSummary'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
        '/api/gov-total-dues' => [[['_route' => 'app_reportsapi_govduestotal', '_controller' => 'App\\Controller\\ReportsApiController::govDuesTotal'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
        '/api/company-gov-total-dues' => [[['_route' => 'app_reportsapi_govduespercompany', '_controller' => 'App\\Controller\\ReportsApiController::govDuesPerCompany'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
    ...
    [ // $regexpList
        0 => '{^(?'
                ...
                .')'
                .'|/d(?'
                    .'|ownload/attachment/([^/]++)/([^/]++)(*:371)'
                    .'|elete/attachment/([^/]++)/([^/]++)(*:413)'
                .')'
                .'|/reset_password/([^/]++)(*:446)'
                .'|/manpower/(?'
                    .'|attendance/([^/]++)/([^/]++)(*:495)'
    ...
    [ // $dynamicRoutes
        ...
        252 => [[['_route' => 'app_employee_payroll_profile_update', '_controller' => 'App\\Controller\\EmployeePayrollProfileController::updateEmployeePayrollProfile'], ['id'], null, null, false, true, null]],
        275 => [[['_route' => 'app_employee_payroll_profile_delete', '_controller' => 'App\\Controller\\EmployeePayrollProfileController::deleteEmployeePayrollProfile'], ['id'], null, null, false, true, null]],
        299 => [[['_route' => 'employee_profile', '_controller' => 'App\\Controller\\EmployeeProfileController::viewProfile'], ['employee_code'], null, null, false, true, null]],
        321 => [[['_route' => 'error', '_controller' => 'App\\Controller\\ErrorController::error'], ['statusCode'], null, null, false, true, null]],
        371 => [[['_route' => 'download_attachment', '_controller' => 'App\\Controller\\EmployeeProfileController::downloadAttachment'], ['employee_code', 'file'], null, null, false, true, null]],
        413 => [[['_route' => 'delete_attachment', '_controller' => 'App\\Controller\\EmployeeProfileController::deleteAttachment'], ['employee_code', 'id'], null, null, false, true, null]],
        446 => [[['_route' => 'reset_password', '_controller' => 'App\\Controller\\HomeController::resetPassword'], ['token'], null, null, false, true, null]],
        495 => [[['_route' => 'app_manpower', '_controller' => 'App\\Controller\\ManpowerController::viewManpower'], ['id', 'emp_code'], null, null, false, true, null]],
        532 => [[['_route' => 'app_emp_project_id', '_controller' => 'App\\Controller\\ManpowerController::viewEmpProjectsId'], ['id'], null, null, false, true, null]],
        555 => [
