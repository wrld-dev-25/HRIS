...
/* index.html.twig */
class __TwigTemplate_93abae0ebe45117786ab8570771d8a44 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 5
        yield "                ";
        yield $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("breadcrumb", ["pagetitle" => "Dashboards", "title" => "Ecommerce"]);
        yield "
                    ...
                    <div class=\"col-span-12 card 2xl:col-span-4 2xl:row-span-2\">
                        <div class=\"card-body\">
                            <div class=\"flex items-center mb-3\">
                                ...
                                <div class=\"relative\">
                                    <a href=\"#!\" class=\"underline transition-all duration-200 ease-linear text-custom-500 hover:text-custom-600\">View All <i data-lucide=\"move-right\" class=\"inline-block size-4 align-middle ltr:ml-1 rtl:mr-1\"></i></a>
                                </div>
                            </div>
                            ...
                            <div class=\"grid grid-cols-12 gap-4 mb-3\">
                                <div class=\"col-span-12 md:col-span-6 lg:col-span-3\">
                                    <div class=\"flex items-center gap-3\">
                                        <div class=\"flex items-center justify-center size-12 rounded-md text-sky-500 bg-sky-50 shrink-0 dark:bg-sky-500/10\">
                                ...
                                <div class=\"col-span-12 md:col-span-6 lg:col-span-3\">
                                    <div class=\"flex items-center gap-3\">
                                        <div class=\"flex items-center justify-center size-12 text-green-500 rounded-md bg-green-50 shrink-0 dark:bg-green-500/10\">
                            ...
                            <div class=\"col-span-12 card lg:col-span-6 2xl:col-span-12\">
                                <div class=\"card-body\">
                                    <div class=\"flex items-center mb-3\">
                                        ...
                                        <div class=\"relative\">
                                            <a href=\"#!\" class=\"transition-all duration-300 ease-linear text-custom-500 hover:text-custom-700\">View Status <i data-lucide=\"move-right\" class=\"inline-block size-4 align-middle ltr:ml-1 rtl:mr-1\"></i></a>
                                        </div>
                                    </div>
                                ...
                                <table class=\"w-full whitespace-nowrap\">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500\"><a href=\"apps-ecommerce-order-overview\">#TWT5015100365</a></td>
                                            ...
                                            <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500\">
                                                <div class=\"relative dropdown\">
                                                    ...
                                                    <ul class=\"absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600\" aria-labelledby=\"orderAction1\">
                                                        <li>
                                                            <a class=\"block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200\" href=\"apps-ecommerce-order-overview\"><i data-lucide=\"eye\" class=\"inline-block size-3 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">Overview</span></a>
                                                        </li>
                                                        <li>
                                        ...
                                        <tr>
                                            ...
                                            <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500\"><a href=\"apps-ecommerce-order-overview\">#TWT5015100366</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500\"><a href=\"apps-ecommerce-order-overview\">#TWT5015100367</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500\"><a href=\"apps-ecommerce-order-overview\">#TWT5015100368</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500\"><a href=\"apps-ecommerce-order-overview\">#TWT5015100369</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500\"><a href=\"apps-ecommerce-order-overview\">#TWT5015100370</a></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 border-y border-slate-200 dark:border-zink-500\"><a href=\"apps-ecommerce-order-overview\">#TWT5015100371</a></td>
                            ...
                            <ul class=\"divide-y divide-slate-200 dark:divide-zink-500\">
                                <li class=\"flex items-center gap-3 py-2 first:pt-0 last:pb-0\">
                                    ...
                                    <div class=\"grow\">
                                        ...
                                        <p class=\"text-slate-500 dark:text-zink-200\">arthur@gmail.com</p>
                                    </div>
                                    <div class=\"shrink-0\">
                                        <h6>\$2,452</h6>
                                    </div>
                                ...
                                <li class=\"flex items-center gap-3 py-2 first:pt-0 last:pb-0\">
                                    ...
                                    <div class=\"grow\">
                                        ...
                                        <p class=\"text-slate-500 dark:text-zink-200\">natalie@gmail.com</p>
                                    </div>
                                    <div class=\"shrink-0\">
                                        <h6>\$1,893</h6>
                                    </div>
                                ...
                                <li class=\"flex items-center gap-3 py-2 first:pt-0 last:pb-0\">
                                    ...
                                    <div class=\"grow\">
                                        ...
                                        <p class=\"text-slate-500 dark:text-zink-200\">jackson@gmail.com</p>
                                    </div>
                                    <div class=\"shrink-0\">
                                        <h6>\$1,196</h6>
                                    </div>
                                ...
                                <li class=\"flex items-center gap-3 py-2 first:pt-0 last:pb-0\">
                                    ...
                                    <div class=\"grow\">
                                        ...
                                        <p class=\"text-slate-500 dark:text-zink-200\">torres@gmail.com</p>
                                    </div>
                                    <div class=\"shrink-0\">
                                        <h6>\$976</h6>
                                    </div>
                            ...
                            <ul class=\"flex flex-col gap-5\">
                                <li class=\"flex items-center gap-3\">
                                    <div class=\"flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zink-600\">
                                        <img src=\"assets/images/product/img-02.png\" alt=\"\" class=\"h-6\">
                                    </div>
                                    ...
                                    <h6 class=\"shrink-0\"><i data-lucide=\"shopping-cart\" class=\"inline-block size-4 align-middle text-slate-500 dark:text-zink-200 ltr:mr-1 rtl:ml-1\"></i> 798</h6>
                                </li>
                                <li class=\"flex items-center gap-3\">
                                    <div class=\"flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zink-600\">
                                        <img src=\"assets/images/product/img-03.png\" alt=\"\" class=\"h-6\">
                                    </div>
                                    <div class=\"overflow-hidden grow\">
                                    ...
                                    <h6 class=\"shrink-0\"><i data-lucide=\"shopping-cart\" class=\"inline-block size-4 align-middle text-slate-500 dark:text-zink-200 ltr:mr-1 rtl:ml-1\"></i> 695</h6>
                                </li>
                                <li class=\"flex items-center gap-3\">
                                    <div class=\"flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zink-600\">
                                        <img src=\"assets/images/product/img-04.png\" alt=\"\" class=\"h-6\">
                                    </div>
                                    <div class=\"overflow-hidden grow\">
                                    ...
                                    <h6 class=\"shrink-0\"><i data-lucide=\"shopping-cart\" class=\"inline-block size-4 align-middle text-slate-500 dark:text-zink-200 ltr:mr-1 rtl:ml-1\"></i> 985</h6>
                                </li>
                                <li class=\"flex items-center gap-3\">
                                    <div class=\"flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zink-600\">
                                        <img src=\"assets/images/product/img-05.png\" alt=\"\" class=\"h-6\">
                                    </div>
                                    <div class=\"overflow-hidden grow\">
                                    ...
                                    <h6 class=\"shrink-0\"><i data-lucide=\"shopping-cart\" class=\"inline-block size-4 align-middle text-slate-500 dark:text-zink-200 ltr:mr-1 rtl:ml-1\"></i> 813</h6>
                                </li>
                                <li class=\"flex items-center gap-3\">
                                    <div class=\"flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zink-600\">
                                        <img src=\"assets/images/product/img-06.png\" alt=\"\" class=\"h-6\">
                                    </div>
                                    <div class=\"overflow-hidden grow\">
                                    ...
                                    <h6 class=\"shrink-0\"><i data-lucide=\"shopping-cart\" class=\"inline-block size-4 align-middle text-slate-500 dark:text-zink-200 ltr:mr-1 rtl:ml-1\"></i> 915</h6>
                                </li>
                                <li class=\"flex items-center gap-3\">
                                    <div class=\"flex items-center justify-center size-10 rounded-md bg-slate-100 dark:bg-zink-600\">
                                        <img src=\"assets/images/product/img-03.png\" alt=\"\" class=\"h-6\">
                                    ...
                                    <h6 class=\"shrink-0\"><i data-lucide=\"shopping-cart\" class=\"inline-block size-4 align-middle text-slate-500 dark:text-zink-200 ltr:mr-1 rtl:ml-1\"></i> 785</h6>
                                </li>
                            </ul>
                        </div>
                    </div><!--end col-->
...
";
    ...
    {
        return array (  983 => 873,  979 => 871,  969 => 863,  959 => 862,  91 => 5,  81 => 4,  61 => 2,  38 => 1,);
    }
...
{% block content %}
                {{ component('breadcrumb', { pagetitle: 'Dashboards', title: 'Ecommerce' }) }}
...
{% endblock %}", "index.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\index.html.twig");
    }
}
