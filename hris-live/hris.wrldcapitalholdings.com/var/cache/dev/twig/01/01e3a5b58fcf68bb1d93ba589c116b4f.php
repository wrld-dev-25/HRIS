...
class __TwigTemplate_d6aaf8ceb8516e982d73730d157f8eac extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("partials/without-nav.html.twig", "auth-login-basic.html.twig", 1);
...
<body class=\"flex items-center justify-center min-h-screen py-16 lg:py-10 bg-slate-50 dark:bg-zink-800 dark:text-zink-100 font-public\">
    ...
    <div class=\"relative\">
        ...
        yield "\" method=\"post\" class=\"mt-10\" id=\"signInForm\">
...
";
    ...
    {
        return array (  202 => 106,  192 => 105,  176 => 98,  148 => 59,  91 => 4,  81 => 3,  61 => 2,  38 => 1,);
    }
    ...
    <div class=\"relative\">
        ...
        <div class=\"mb-0 w-screen lg:mx-auto lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative\">
            <div class=\"!px-10 !py-12 card-body\">
                ...
                <form action=\"{{ path('login')}}\" method=\"post\" class=\"mt-10\" id=\"signInForm\">
                    <div class=\"hidden px-4 py-3 mb-3 text-sm text-green-500 border border-green-200 rounded-md bg-green-50 dark:bg-green-400/20 dark:border-green-500/50\" id=\"successAlert\">
                        You have <b>successfully</b> signed in.
                    </div>
                    <div class=\"mb-3\">
...
{% endblock %}", "auth-login-basic.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\auth-login-basic.html.twig");
    }
}
