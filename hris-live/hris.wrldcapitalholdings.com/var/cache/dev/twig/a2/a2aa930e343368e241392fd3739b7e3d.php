...
class __TwigTemplate_2531ed98d73336e025855a3a96123f87 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("partials/base.html.twig", "apps-ecommerce-sellers.html.twig", 1);
...
";
        // line 6
        yield $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("breadcrumb", ["pagetitle" => "Ecommerce", "title" => "Sellers"]);
        yield "
                    ...
                    <div class=\"2xl:col-span-3\">
                        <div class=\"card\">
                            <div class=\"card-body\">
                                <div class=\"flex items-center gap-2 mb-4\">
                                    ...
                                    <div class=\"relative dropdown shrink-0\">
                                        ...
                                        <ul class=\"absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600\" aria-labelledby=\"sellersAction1\">
                                            <li>
                                                <a class=\"block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200\" href=\"#!\"><i data-lucide=\"eye\" class=\"inline-block size-3 mr-1\"></i> <span class=\"align-middle\">Overview</span></a>
                                            </li>
                                            <li>
                                                <a data-modal-target=\"addSellerModal\" class=\"block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200\" href=\"#!\"><i data-lucide=\"file-edit\" class=\"inline-block size-3 mr-1\"></i> <span class=\"align-middle\">Edit</span></a>
                                            </li>
                                            <li>
                                ...
                                <div class=\"flex items-center justify-center size-16 mx-auto rounded-full bg-slate-100 outline outline-slate-100 outline-offset-1 dark:bg-zink-600 dark:outline-zink-600\">
                                    <img src=\"assets/images/brand/adwords.png\" alt=\"\" class=\"h-10 rounded-full\">
                                </div>
                    ...
                    <div class=\"2xl:col-span-3\">
                        <div class=\"card\">
                            <div class=\"card-body\">
                                ...
                                <div class=\"flex items-center justify-center size-16 mx-auto rounded-full bg-slate-100 outline outline-slate-100 outline-offset-1 dark:bg-zink-600 dark:outline-zink-600\">
                                    <img src=\"assets/images/brand/app-store.png\" alt=\"\" class=\"h-10 rounded-full\">
                                </div>
                    ...
                    <div class=\"2xl:col-span-3\">
                        <div class=\"card\">
                            <div class=\"card-body\">
                                ...
                                <div class=\"flex items-center justify-center size-16 mx-auto rounded-full bg-slate-100 outline outline-slate-100 outline-offset-1 dark:bg-zink-600 dark:outline-zink-600\">
                                    <img src=\"assets/images/brand/gmail.png\" alt=\"\" class=\"h-10 rounded-full\">
                                </div>
                    ...
                    <div class=\"2xl:col-span-3\">
                        <div class=\"card\">
                            <div class=\"card-body\">
                                ...
                                <div class=\"flex items-center justify-center size-16 mx-auto rounded-full bg-slate-100 outline outline-slate-100 outline-offset-1 dark:bg-zink-600 dark:outline-zink-600\">
                                    <img src=\"assets/images/brand/android.png\" alt=\"\" class=\"h-10 rounded-full\">
                                </div>
                    ...
                    <div class=\"2xl:col-span-3\">
                        <div class=\"card\">
                            <div class=\"card-body\">
                                ...
                                <div class=\"flex items-center justify-center size-16 mx-auto rounded-full bg-slate-100 outline outline-slate-100 outline-offset-1 dark:bg-zink-600 dark:outline-zink-600\">
                                    <img src=\"assets/images/brand/figma.png\" alt=\"\" class=\"h-10 rounded-full\">
                                </div>
                    ...
                    <div class=\"2xl:col-span-3\">
                        <div class=\"card\">
                            <div class=\"card-body\">
                                ...
                                <div class=\"flex items-center justify-center size-16 mx-auto rounded-full bg-slate-100 outline outline-slate-100 outline-offset-1 dark:bg-zink-600 dark:outline-zink-600\">
                                    <img src=\"assets/images/brand/meta.png\" alt=\"\" class=\"h-10 rounded-full\">
                                </div>
                    ...
                    <div class=\"2xl:col-span-3\">
                        <div class=\"card\">
                            <div class=\"card-body\">
                                ...
                                <div class=\"flex items-center justify-center size-16 mx-auto rounded-full bg-slate-100 outline outline-slate-100 outline-offset-1 dark:bg-zink-600 dark:outline-zink-600\">
                                    <img src=\"assets/images/brand/search.png\" alt=\"\" class=\"h-10 rounded-full\">
                                </div>
                    ...
                    <div class=\"2xl:col-span-3\">
                        <div class=\"card\">
                            <div class=\"card-body\">
                                ...
                                <div class=\"flex items-center justify-center size-16 mx-auto rounded-full bg-slate-100 outline outline-slate-100 outline-offset-1 dark:bg-zink-600 dark:outline-zink-600\">
                                    <img src=\"assets/images/brand/telegram.png\" alt=\"\" class=\"h-10 rounded-full\">
                                </div>
...
<script src=\"assets/js/pages/apps-ecommerce-sellers.init.js\"></script>
...
";
    ...
    {
        return array (  631 => 520,  627 => 518,  620 => 513,  610 => 512,  94 => 6,  91 => 5,  81 => 4,  61 => 2,  38 => 1,);
    }
...
{{ component('breadcrumb', { pagetitle: 'Ecommerce', title: 'Sellers' }) }}
...
{% endblock %}", "apps-ecommerce-sellers.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\apps-ecommerce-sellers.html.twig");
    }
}
