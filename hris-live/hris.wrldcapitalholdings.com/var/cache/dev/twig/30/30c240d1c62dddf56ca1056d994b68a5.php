...
class __TwigTemplate_7f92d7a97e77d6c6a73389b7f5017355 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("partials/base.html.twig", "apps-invoice-list.html.twig", 1);
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        yield "
            ";
        // line 6
        yield $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("breadcrumb", ["pagetitle" => "Invoices", "title" => "List View"]);
        yield "
                    ...
                    <div class=\"xl:col-span-3\">
                        <div class=\"sticky card print:hidden top-[calc(theme('spacing.header')_+_theme('spacing.5'))]\">
                            ...
                            <div data-simplebar class=\"h-[calc(100vh_-_theme('height.14')_-_theme('spacing.5')_-_theme('height.header')_*_3.5)]\">
                                <a href=\"#!\" class=\"block transition-all duration-150 ease-linear border-t card-body border-slate-200 hover:bg-slate-50 [&.active]:bg-slate-100 dark:border-zink-500 dark:hover:bg-zink-600 dark:[&.active]:bg-zink-600 active\">
                                    ...
                                    <div class=\"flex\">
                                        ...
                                        <p class=\"self-end mb-0 text-slate-500 dark:text-zink-200 shrink-0\"><i data-lucide=\"calendar-clock\" class=\"inline-block size-4 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">21 Jan, 2024</span></p>
                                    </div>
                                </a>
                                <a href=\"#!\" class=\"block transition-all duration-150 ease-linear border-t card-body border-slate-200 hover:bg-slate-50 [&.active]:bg-slate-100 dark:border-zink-500 dark:hover:bg-zink-600 dark:[&.active]:bg-zink-600\">
                                    <div class=\"float-right\">
                                    ...
                                    <div class=\"flex\">
                                        ...
                                        <p class=\"self-end mb-0 text-slate-500 dark:text-zink-200 shrink-0\"><i data-lucide=\"calendar-clock\" class=\"inline-block size-4 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">27 Oct, 2023</span></p>
                                    </div>
                                </a>
                                <a href=\"#!\" class=\"block transition-all duration-150 ease-linear border-t card-body border-slate-200 hover:bg-slate-50 [&.active]:bg-slate-100 dark:border-zink-500 dark:hover:bg-zink-600 dark:[&.active]:bg-zink-600\">
                                    <div class=\"float-right\">
                                    ...
                                    <div class=\"flex\">
                                        ...
                                        <p class=\"self-end mb-0 text-slate-500 dark:text-zink-200 shrink-0\"><i data-lucide=\"calendar-clock\" class=\"inline-block size-4 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">04 Feb, 2024</span></p>
                                    </div>
                                </a>
                                <a href=\"#!\" class=\"block transition-all duration-150 ease-linear border-t card-body border-slate-200 hover:bg-slate-50 [&.active]:bg-slate-100 dark:border-zink-500 dark:hover:bg-zink-600 dark:[&.active]:bg-zink-600\">
                                    <div class=\"float-right\">
                                        <span class=\"px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-red-100 border-transparent text-red-500 dark:bg-red-500/20 dark:border-transparent\">Cancel</span>
                                    </div>
                                    <h6>#TW15090254</h6>
                                    <div class=\"flex\">
                                        <div class=\"grow\">
                                        ...
                                        <p class=\"self-end mb-0 text-slate-500 dark:text-zink-200 shrink-0\"><i data-lucide=\"calendar-clock\" class=\"inline-block size-4 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">14 July, 2023</span></p>
                                    </div>
                                </a>
                                <a href=\"#!\" class=\"block transition-all duration-150 ease-linear border-t card-body border-slate-200 hover:bg-slate-50 [&.active]:bg-slate-100 dark:border-zink-500 dark:hover:bg-zink-600 dark:[&.active]:bg-zink-600\">
                                    <div class=\"float-right\">
                                        <span class=\"px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-slate-100 border-transparent text-slate-500 dark:bg-slate-500/20 dark:text-zink-200 dark:border-transparent\">Refund</span>
                                    </div>
                                    <h6>#TW15090255</h6>
                                    <div class=\"flex\">
                                        <div class=\"grow\">
                                        ...
                                        <p class=\"self-end mb-0 text-slate-500 dark:text-zink-200 shrink-0\"><i data-lucide=\"calendar-clock\" class=\"inline-block size-4 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">11 April, 2023</span></p>
                                    </div>
                                </a>
                                <a href=\"#!\" class=\"block transition-all duration-150 ease-linear border-t card-body border-slate-200 hover:bg-slate-50 [&.active]:bg-slate-100 dark:border-zink-500 dark:hover:bg-zink-600 dark:[&.active]:bg-zink-600\">
                                    <div class=\"float-right\">
                                    ...
                                    <div class=\"flex\">
                                        ...
                                        <p class=\"self-end mb-0 text-slate-500 dark:text-zink-200 shrink-0\"><i data-lucide=\"calendar-clock\" class=\"inline-block size-4 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">03 Aug, 2023</span></p>
                                    </div>
                                </a>
                                <a href=\"#!\" class=\"block transition-all duration-150 ease-linear border-t card-body border-slate-200 hover:bg-slate-50 [&.active]:bg-slate-100 dark:border-zink-500 dark:hover:bg-zink-600 dark:[&.active]:bg-zink-600\">
                                    <div class=\"float-right\">
                                    ...
                                    <div class=\"flex\">
                                        ...
                                        <p class=\"self-end mb-0 text-slate-500 dark:text-zink-200 shrink-0\"><i data-lucide=\"calendar-clock\" class=\"inline-block size-4 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">15 Dec, 2024</span></p>
                                    </div>
                                </a>
                            </div>
                        </div><!--end card-->
                                    ...
                                    <div class=\"flex items-center gap-2 shrink-0\">
                                        ...
                                        <div class=\"relative dropdown\">
                                            ...
                                            <ul class=\"absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600\" aria-labelledby=\"categoryNotes1\">
                                                <li>
                                                    <a class=\"block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200\" href=\"apps-invoice-add-new\"><i data-lucide=\"file-edit\" class=\"inline-block size-3 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">Edit</span></a>
                                                </li>
                                                <li>
                                    ...
                                    <div class=\"mt-6 overflow-x-auto\">
                                        <table class=\"w-full whitespace-nowrap\">
                                            <thead class=\"ltr:text-left rtl:text-right\">
                                                <tr>
                                                    <th class=\"px-3.5 py-2.5 font-semibold text-slate-500 dark:text-zink-200 border-b border-slate-200 dark:border-zink-500\">#</th>
                                                    <th class=\"px-3.5 py-2.5 font-semibold text-slate-500 dark:text-zink-200 border-b border-slate-200 dark:border-zink-500\">Item Name</th>
                                                    <th class=\"px-3.5 py-2.5 font-semibold text-slate-500 dark:text-zink-200 border-b border-slate-200 dark:border-zink-500\">Rate</th>
                                                    <th class=\"px-3.5 py-2.5 font-semibold text-slate-500 dark:text-zink-200 border-b border-slate-200 dark:border-zink-500\">Quantity</th>
                                                    <th class=\"px-3.5 py-2.5 font-semibold text-slate-500 dark:text-zink-200 border-b border-slate-200 dark:border-zink-500\">Amount</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
...
";
    ...
    {
        return array (  443 => 332,  439 => 330,  435 => 328,  425 => 327,  94 => 6,  91 => 5,  81 => 4,  61 => 2,  38 => 1,);
    }
...
{% block content %}
            ...
            {{ component('breadcrumb', { pagetitle: 'Invoices', title: 'List View' }) }}
...
{% endblock %}", "apps-invoice-list.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\apps-invoice-list.html.twig");
    }
}
