...
/* forget_password/auth-reset-password-basic.html.twig */
class __TwigTemplate_7d58cf996e3fa99d9b5abd6f04a84bfe extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "forget_password/auth-reset-password-basic.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "forget_password/auth-reset-password-basic.html.twig"));

        $this->parent = $this->loadTemplate("partials/without-nav.html.twig", "forget_password/auth-reset-password-basic.html.twig", 1);
...
<body class=\"flex items-center justify-center min-h-screen py-16 lg:py-10 bg-slate-50 dark:bg-zink-800 dark:text-zink-100 font-public\">
    ...
    <div class=\"relative\">
        ...
        // line 66
        yield $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("email_forget_password");
        yield "\" method=\"post\">
                    <div>
                        <label for=\"email\" class=\"inline-block mb-2 text-base font-medium\">Email</label>
                        <input type=\"text\" name=\"email\" class=\"form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" required placeholder=\"Enter email\" id=\"email\">
                    </div>
                    <div class=\"mt-8\">
                    ...
                    <div class=\"mt-4 text-center\">
                        <p class=\"mb-0\">Wait, I remember my password... <a href=\"";
        // line 75
...
";
    ...
    ";
        // line 86
        yield ((array_key_exists("javascriptSnippet", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["javascriptSnippet"]) || array_key_exists("javascriptSnippet", $context) ? $context["javascriptSnippet"] : (function () { throw new RuntimeError('Variable "javascriptSnippet" does not exist.', 86, $this->source); })()), "")) : (""));
        yield "
";
    ...
    {
        return "forget_password/auth-reset-password-basic.html.twig";
    }
    ...
    {
        return array (  201 => 86,  196 => 85,  186 => 84,  166 => 75,  154 => 66,  146 => 60,  141 => 56,  91 => 4,  81 => 3,  61 => 2,  38 => 1,);
    }
...
<body class=\"flex items-center justify-center min-h-screen py-16 lg:py-10 bg-slate-50 dark:bg-zink-800 dark:text-zink-100 font-public\">
    ...
    <div class=\"relative\">
        ...
        <div class=\"mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative\">
            <div class=\"!px-10 !py-12 card-body\">
                {# <a href=\"#!\">
                    <img src=\"{{ asset('assets/images/wrld-logo-white-2.png') }}\" alt=\"\" class=\"hidden h-6 mx-auto dark:block\">
                    <img src=\"{{ asset('assets/images/wrld-logo.png') }}\" alt=\"\" class=\"block h-6 mx-auto dark:hidden\">
                </a> #}
                ...
                <form autocomplete=\"off\" action=\"{{ path('email_forget_password') }}\" method=\"post\">
                    <div>
                        <label for=\"email\" class=\"inline-block mb-2 text-base font-medium\">Email</label>
                        <input type=\"text\" name=\"email\" class=\"form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" required placeholder=\"Enter email\" id=\"email\">
                    </div>
                    ...
                    <div class=\"mt-4 text-center\">
                        <p class=\"mb-0\">Wait, I remember my password... <a href=\"{{ path('login') }}\" class=\"underline fw-medium text-custom-500\"> Click here </a> </p>
                    </div>
                </form>
            </div>
        </div>
...
{% endblock %}", "forget_password/auth-reset-password-basic.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\forget_password\\auth-reset-password-basic.html.twig");
    }
}
