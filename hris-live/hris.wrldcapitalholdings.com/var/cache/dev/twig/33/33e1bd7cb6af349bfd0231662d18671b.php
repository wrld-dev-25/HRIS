...
class __TwigTemplate_f1459fbb16e174797cf1867b29421e36 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "project_management/subdivision-wizard.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "project_management/subdivision-wizard.html.twig"));
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        yield "
            ";
        // line 6
        yield $this->env->getRuntime('Symfony\UX\TwigComponent\Twig\ComponentRuntime')->render("breadcrumb", ["pagetitle" => "Subdivision", "title" => "Subdivision Wizard"]);
        yield "
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["subdivisions"]) || array_key_exists("subdivisions", $context) ? $context["subdivisions"] : (function () { throw new RuntimeError('Variable "subdivisions" does not exist.', 76, $this->source); })()));
        ...
        // line 136
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["models"]) || array_key_exists("models", $context) ? $context["models"] : (function () { throw new RuntimeError('Variable "models" does not exist.', 136, $this->source); })()));
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_key'], $context['modelItem'], $context['_parent']);
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 139
        yield "                                                </select>
                                            </div>
        ...
        // line 167
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["owner"]) || array_key_exists("owner", $context) ? $context["owner"] : (function () { throw new RuntimeError('Variable "owner" does not exist.', 167, $this->source); })()));
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_key'], $context['ownerItem'], $context['_parent']);
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 170
        yield "                                                </select>
                                            </div>
...
";
    ...
    public function block_javascripts(array $context, array $blocks = []): iterable
    {
        ...
        // line 222
        yield ((array_key_exists("javascriptSnippet", $context)) ? (Twig\Extension\CoreExtension::default((isset($context["javascriptSnippet"]) || array_key_exists("javascriptSnippet", $context) ? $context["javascriptSnippet"] : (function () { throw new RuntimeError('Variable "javascriptSnippet" does not exist.', 222, $this->source); })()), "")) : (""));
        yield "
<script src=\"";
        // line 223
...
";
    ...
    {
        return array (  764 => 623,  657 => 517,  371 => 227,  367 => 225,  362 => 223,  358 => 222,  345 => 221,  321 => 206,  290 => 170,  277 => 168,  273 => 167,  243 => 139,  228 => 137,  224 => 136,  179 => 93,  173 => 79,  158 => 77,  154 => 76,  146 => 70,  144 => 45,  138 => 41,  133 => 38,  104 => 6,  101 => 5,  88 => 4,  65 => 2,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("{% extends 'partials/base.html.twig' %}
{% block title %}Subdivision Wizard{% endblock %}

{% block content %}

            {{ component('breadcrumb', { pagetitle: 'Subdivision', title: 'Subdivision Wizard' }) }}
                    ...
                    <div class=\"card\">
                        <div class=\"card-body\">
                            <ul class=\"grid grid-cols-1 gap-3 lg:grid-cols-4 nav-tabs form-wizard\">
                                ...
                                {# <li class=\"group/item\">
                                    <a href=\"#!\" data-target=\"completed\" data-tab-id=\"4\" class=\"block px-4 py-5 text-center rounded-md text-slate-500 bg-slate-50 dark:text-zink-200 dark:bg-zink-600 group-[.active]/item:bg-custom-500 group-[.active]/item:text-custom-50\">
                                        <i data-lucide=\"party-popper\" class=\"block h-6 mx-auto fill-slate-200 dark:fill-zink-400 group-[.active]/item:fill-slate-200 dark:group-[.active]/item:fill-custom-500\"></i>
                                        <span class=\"block mt-3 font-medium text-15\">2. Completed</span>
                                    </a>
                                </li> #}
                            </ul>

                            <div class=\"mt-5 tab-content\">
                            <form action=\"{{path('wizard_project')}}\" method=\"post\">
                                <div class=\"block tab-pane\" data-tab-id=\"1\" id=\"subdivisionDetails\">
                                    <h5 class=\"mb-3\">Subdivision Details</h5>
                                        ...
                                        {# <div class=\"grid grid-cols-1 gap-3 mb-4 md:grid-cols-3 lg:grid-cols-4\">
                                            <div>
                                                ...
                                                <label for=\"brandingRadio\" class=\"block px-3 text-center border rounded-md cursor-pointer border-slate-200 py-7 text-slate-500 dark:border-zink-500 dark:text-zink-200 peer-checked/business:border-custom-500 dark:peer-checked/business:border-custom-500 peer-checked/business:text-custom-500 dark:peer-checked/business:text-custom-500\">
                                                    <i data-lucide=\"gem\" class=\"block size-8 mx-auto mb-3 stroke-1 fill-slate-100 dark:fill-zink-600\"></i>
                                            ...
                                            <div>
                                                ...
                                                <label for=\"mobileDesignRadio\" class=\"block px-3 text-center border rounded-md cursor-pointer border-slate-200 py-7 text-slate-500 dark:border-zink-500 dark:text-zink-200 peer-checked/business:border-custom-500 dark:peer-checked/business:border-custom-500 peer-checked/business:text-custom-500 dark:peer-checked/business:text-custom-500\">
                                                    <i data-lucide=\"smartphone\" class=\"block size-8 mx-auto mb-3 stroke-1 fill-slate-100 dark:fill-zink-600\"></i>
                                            ...
                                            <div>
                                                ...
                                                <label for=\"webDesignRadio\" class=\"block px-3 text-center border rounded-md cursor-pointer border-slate-200 py-7 text-slate-500 dark:border-zink-500 dark:text-zink-200 peer-checked/business:border-custom-500 dark:peer-checked/business:border-custom-500 peer-checked/business:text-custom-500 dark:peer-checked/business:text-custom-500\">
                                                    <i data-lucide=\"globe\" class=\"block size-8 mx-auto mb-3 stroke-1 fill-slate-100 dark:fill-zink-600\"></i>
                                        ...
                                        <div class=\"grid grid-cols-1 gap-4 md:grid-cols-2\">
                                            <div>
                                                ...
                                                <select class=\"form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" id=\"choices-subid-code\" name=\"subid_code\">
                                                    ...
                                                    {% for subdivisionItem in subdivisions %}
                                                        <option value=\"{{subdivisionItem.id}}\" data-subcode=\"{{subdivisionItem.subdivisionCode}}\">{{subdivisionItem.subdivisionCode}} : {{subdivisionItem.name}}</option>
                                                    {% endfor %}
                                                </select>
                                                <div id=\"nameError\" class=\"text-red-500\"></div>
                                            ...
                                            {# <div>
                                                <label for=\"subname\" class=\"inline-block mb-2 text-base font-medium\">Name<span class=\"text-red-500\">*</span></label>
                                                <select class=\"form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" data-choices id=\"choices-subid-name\" name=\"subid_name\">
                                                    <option value=\"\">Select Subdivision</option>
                                                    {% for subdivisionItem in subdivisions %}
                                                        <option value=\"{{subdivisionItem.id}}\">{{subdivisionItem.name}}</option>
                                                    {% endfor %}
                                                </select>
                                                <div id=\"usernameError\" class=\"text-red-500\"></div>
                                            </div> #}
                                        ...
                                        <div class=\"grid grid-cols-1 gap-4 md:grid-cols-2\">
                                            <div>
                                                ...
                                                {% for modelItem in models %}
                                                    <option value=\"{{ modelItem.id }}\" data-type=\"{{ modelItem.model_type.code }}\" data-option={{ modelItem.model_type.add_option }}>{{ modelItem.name }}</option>
                                                {% endfor %}
                                                </select>
                                            </div>
                                            <div hidden>
                                            ...
                                            <div>
                                                ...
                                                <select class=\"form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" name=\"category_owner\">
                                                <option value=\"\"></option>
                                                {% for ownerItem in owner %}
                                                    <option value=\"{{ ownerItem.id }}\">{{ ownerItem.firstname }} {{ ownerItem.lastname }}</option>
                                                {% endfor %}
                                                </select>
                                            </div>
                                ...
                                {# <div class=\"hidden tab-pane\" data-tab-id=\"4\" id=\"completed\">
                                    <div class=\"px-4 py-6 mx-auto text-center lg:w-2/3\">
                                        <i data-lucide=\"check-circle\" class=\"block size-10 mx-auto mb-4 text-green-500 fill-green-100 dark:fill-green-500/20 animate-icons\"></i>
...
<script>
        ...
        {# \$(document).on('change', 'select[name=\"categoryblock\"]', function() {
            var subdivisionId = \$('#subid_code').val();
            var phaseId = \$('#subphase').val();
            console.log(subid_code)
            updateLots(subdivisionId,phaseId);
        }); #}
        ...
        \$('select[name=\"category_owner\"]').on('change', updateDescription);
        //update project code
        {# /\$('#label_subcode').attr('data-subcode').on('change', updateProjectCode); #}
        \$('select[name=\"sub_code\"]').on('change', updateProjectCode);
        \$('select[name=\"categorymodel\"]').on('change', updateProjectCode);
        \$('select[name=\"categorymodel\"]').on('change', updateProjectCode);
        \$('select[name=\"categoryblock\"]').on('change', updateProjectCode);
        \$('select[name=\"categorylot\"]').on('change', updateProjectCode);
...
{% endblock %}", "project_management/subdivision-wizard.html.twig", "C:\\xampp\\htdocs\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\project_management\\subdivision-wizard.html.twig");
    }
}
