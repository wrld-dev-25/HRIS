...
class __TwigTemplate_54ee7aeb14371987126c9d39eeac35db extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "pages-account.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "pages-account.html.twig"));

        $this->parent = $this->loadTemplate("partials/base.html.twig", "pages-account.html.twig", 1);
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 5
        yield "                ";
        yield $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("breadcrumb", ["pagetitle" => "pages", "title" => "Account"]);
        yield "
                            ...
                            <div class=\"card\">
                                <div class=\"card-body\">
                                    ...
                                    <div class=\"mt-3 text-center\">
                                        <a href=\"#!\" class=\"inline-block underline text-custom-500\">Add New Card <i data-lucide=\"move-right\" class=\"inline-block size-4 ml-2 rtl:-rotate-180\"></i></a>
                                    </div>
                                </div>
                            </div><!--end card-->
                            <div class=\"card\">
                                    ...
                                    <tr class=\"bg-white dark:bg-zink-700\">
                                        ...
                                        <td class=\"px-3.5 py-2.5 border-y border-transparent\">
                                            <div class=\"flex items-center justify-end gap-2\">
                                                <a href=\"#!\" class=\"flex items-center justify-center size-8 transition-all duration-150 ease-linear rounded-md bg-slate-100 hover:bg-slate-200 dark:bg-zink-600 dark:hover:bg-zink-500\"><i data-lucide=\"eye\" class=\"size-3\"></i></a>
                                                <a href=\"#!\" class=\"flex items-center justify-center size-8 transition-all duration-150 ease-linear rounded-md bg-slate-100 hover:bg-slate-200 dark:bg-zink-600 dark:hover:bg-zink-500\"><i data-lucide=\"file-edit\" class=\"size-3\"></i></a>
                                                <a href=\"#!\" class=\"flex items-center justify-center size-8 transition-all duration-150 ease-linear rounded-md bg-slate-100 hover:bg-slate-200 dark:bg-zink-600 dark:hover:bg-zink-500\"><i data-lucide=\"arrow-down-to-line\" class=\"size-3\"></i></a>
                                                <a href=\"#!\" class=\"flex items-center justify-center size-8 transition-all duration-150 ease-linear rounded-md bg-slate-100 hover:bg-slate-200 dark:bg-zink-600 dark:hover:bg-zink-500\"><i data-lucide=\"trash-2\" class=\"size-3\"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class=\"bg-white dark:bg-zink-700\">
                                        ...
                                        <div class=\"shrink-0\">
                                            <div class=\"relative dropdown\">
                                                ...
                                                <ul class=\"absolute z-50 hidden py-2 mt-1 text-left list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem]\" aria-labelledby=\"projectDropdownmenu1\">
                                                    <li>
                                                        <a class=\"block px-4 py-1.5 text-base transition-all duration-200 ease-linear bg-white text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500\" href=\"#!\"><i data-lucide=\"eye\" class=\"inline-block size-3 mr-1\"></i> Overview</a>
                                                    </li>
                                                    <li>
                                                        <a class=\"block px-4 py-1.5 text-base transition-all duration-200 ease-linear bg-white text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500\" href=\"#!\"><i data-lucide=\"file-edit\" class=\"inline-block size-3 mr-1\"></i> Edit</a>
                                                    </li>
                                                    <li>
                                                        <a class=\"block px-4 py-1.5 text-base transition-all duration-200 ease-linear bg-white text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500\" href=\"#!\"><i data-lucide=\"trash-2\" class=\"inline-block size-3 mr-1\"></i> Delete</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
...
";
    ...
    {
        return "pages-account.html.twig";
    }
    ...
    {
        return array (  1348 => 1238,  1344 => 1236,  1334 => 1228,  1324 => 1227,  91 => 5,  81 => 4,  61 => 2,  38 => 1,);
    }
...
{% block content %}
                {{ component('breadcrumb', { pagetitle: 'pages', title: 'Account' }) }}
...
{% endblock %}", "pages-account.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\pages-account.html.twig");
    }
}
