...
/* apps-ecommerce-product-grid.html.twig */
class __TwigTemplate_e4d3f4ebc4072af8aef50eebc21f4fa2 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps-ecommerce-product-grid.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps-ecommerce-product-grid.html.twig"));

        $this->parent = $this->loadTemplate("partials/base.html.twig", "apps-ecommerce-product-grid.html.twig", 1);
...
";
        // line 6
        yield $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("breadcrumb", ["pagetitle" => "Ecommerce", "title" => "Grid View"]);
        yield "
                                ...
                                <div class=\"mt-4 collapsible\">
                                    ...
                                    <div class=\"mt-4 collapsible-content\">
                                        <div class=\"flex flex-wrap items-center gap-2\">
                                            <input id=\"color1\" class=\"size-5 border rounded-sm appearance-none cursor-pointer border-custom-500 bg-custom-500 checked:bg-custom-500 checked:border-custom-500\" type=\"checkbox\" value=\"\">
                                            <input id=\"color2\" class=\"size-5 bg-red-300 border border-red-300 rounded-sm appearance-none cursor-pointer checked:bg-red-300 checked:border-red-300\" type=\"checkbox\" value=\"\">
                                            <input id=\"color3\" class=\"size-5 bg-green-300 border border-green-300 rounded-sm appearance-none cursor-pointer checked:bg-green-300 checked:border-green-300\" type=\"checkbox\" value=\"\">
                                            <input id=\"color4\" class=\"size-5 border rounded-sm appearance-none cursor-pointer border-slate-500 bg-slate-500 checked:bg-slate-500 checked:border-slate-500\" type=\"checkbox\" value=\"\">
                                            <input id=\"color5\" class=\"size-5 bg-purple-500 border border-purple-500 rounded-sm appearance-none cursor-pointer checked:bg-purple-500 checked:border-purple-500\" type=\"checkbox\" value=\"\">
                                            <input id=\"color6\" class=\"size-5 border rounded-sm appearance-none cursor-pointer bg-sky-500 border-sky-500 checked:bg-sky-500 checked:border-sky-500\" type=\"checkbox\" value=\"\">
                                            <input id=\"color7\" class=\"size-5 bg-yellow-500 border border-yellow-500 rounded-sm appearance-none cursor-pointer checked:bg-yellow-500 checked:border-yellow-500\" type=\"checkbox\" value=\"\">
                                            <input id=\"color7\" class=\"size-5 bg-green-500 border border-green-500 rounded-sm appearance-none cursor-pointer checked:bg-green-500 checked:border-green-500\" type=\"checkbox\" value=\"\">
                                            <input id=\"color8\" class=\"size-5 border rounded-sm appearance-none cursor-pointer bg-slate-800 border-slate-800 checked:bg-slate-800 checked:border-slate-800\" type=\"checkbox\" value=\"\">
                                            <input id=\"color9\" class=\"size-5 border rounded-sm appearance-none cursor-pointer bg-slate-200 border-slate-200 checked:bg-slate-200 checked:border-slate-200\" type=\"checkbox\" value=\"\">
                                            <input id=\"color10\" class=\"size-5 border rounded-sm appearance-none cursor-pointer bg-emerald-300 border-embg-emerald-300 checked:bg-emerald-300 checked:border-embg-emerald-300\" type=\"checkbox\" value=\"\">
                                        </div>
                                    </div>
                                </div>
                                <div class=\"mt-4 collapsible\">
                                        ...
                                        <div class=\"flex flex-col gap-2\">
                                            ...
                                            <div class=\"flex items-center gap-2\">
                                                ...
                                                <label for=\"rating5\" class=\"align-middle cursor-pointer\">
                                                    <i data-lucide=\"star\" class=\"inline-block size-4 ml-1 text-yellow-500 align-middle\"></i> <span class=\"align-middle\">5 Rating</span>
                                                </label>
                                            </div>
                                            <div class=\"flex items-center gap-2\">
                                                <input id=\"rating4\" class=\"size-4 cursor-pointer bg-white border border-slate-200 checked:bg-none dark:bg-zink-700 dark:border-zink-500 rounded-sm appearance-none arrow-none relative after:absolute after:content-['\\eb7b'] after:top-0 after:left-0 after:font-remix after:leading-none after:opacity-0 checked:after:opacity-100 after:text-custom-500 checked:border-custom-500 dark:after:text-custom-500 dark:checked:border-custom-800\" type=\"checkbox\" value=\"\">
                                                <label for=\"rating4\" class=\"align-middle cursor-pointer\">
                                                    <i data-lucide=\"star\" class=\"inline-block size-4 ml-1 text-yellow-500 align-middle\"></i> <span class=\"align-middle\">4 Rating and Up</span>
                                                </label>
                                            </div>
                                            <div class=\"flex items-center gap-2\">
                                                <input id=\"rating3\" class=\"size-4 cursor-pointer bg-white border border-slate-200 checked:bg-none dark:bg-zink-700 dark:border-zink-500 rounded-sm appearance-none arrow-none relative after:absolute after:content-['\\eb7b'] after:top-0 after:left-0 after:font-remix after:leading-none after:opacity-0 checked:after:opacity-100 after:text-custom-500 checked:border-custom-500 dark:after:text-custom-500 dark:checked:border-custom-800\" type=\"checkbox\" value=\"\">
                                                <label for=\"rating3\" class=\"align-middle cursor-pointer\">
                                                    <i data-lucide=\"star\" class=\"inline-block size-4 ml-1 text-yellow-500 align-middle\"></i> <span class=\"align-middle\">3 Rating and Up</span>
                                                </label>
                                            </div>
                                            <div class=\"flex items-center gap-2\">
                                                <input id=\"rating2\" class=\"size-4 cursor-pointer bg-white border border-slate-200 checked:bg-none dark:bg-zink-700 dark:border-zink-500 rounded-sm appearance-none arrow-none relative after:absolute after:content-['\\eb7b'] after:top-0 after:left-0 after:font-remix after:leading-none after:opacity-0 checked:after:opacity-100 after:text-custom-500 checked:border-custom-500 dark:after:text-custom-500 dark:checked:border-custom-800\" type=\"checkbox\" value=\"\">
                                                <label for=\"rating2\" class=\"align-middle cursor-pointer\">
                                                    <i data-lucide=\"star\" class=\"inline-block size-4 ml-1 text-yellow-500 align-middle\"></i> <span class=\"align-middle\">2 Rating and Up</span>
                                                </label>
                                            </div>
                                            <div class=\"flex items-center gap-2\">
                                                <input id=\"rating1\" class=\"size-4 cursor-pointer bg-white border border-slate-200 checked:bg-none dark:bg-zink-700 dark:border-zink-500 rounded-sm appearance-none arrow-none relative after:absolute after:content-['\\eb7b'] after:top-0 after:left-0 after:font-remix after:leading-none after:opacity-0 checked:after:opacity-100 after:text-custom-500 checked:border-custom-500 dark:after:text-custom-500 dark:checked:border-custom-800\" type=\"checkbox\" value=\"\">
                                                <label for=\"rating1\" class=\"align-middle cursor-pointer\">
                                                    <i data-lucide=\"star\" class=\"inline-block size-4 ml-1 text-yellow-500 align-middle\"></i> <span class=\"align-middle\">1 Rating and Up</span>
                                                </label>
                                            </div>
                                            <div class=\"flex items-center gap-2\">
                                                <input id=\"rating0\" class=\"size-4 cursor-pointer bg-white border border-slate-200 checked:bg-none dark:bg-zink-700 dark:border-zink-500 rounded-sm appearance-none arrow-none relative after:absolute after:content-['\\eb7b'] after:top-0 after:left-0 after:font-remix after:leading-none after:opacity-0 checked:after:opacity-100 after:text-custom-500 checked:border-custom-500 dark:after:text-custom-500 dark:checked:border-custom-800\" type=\"checkbox\" value=\"\">
                                                <label for=\"rating0\" class=\"align-middle cursor-pointer\">
                                                    <i data-lucide=\"star\" class=\"inline-block size-4 ml-1 text-yellow-500 align-middle\"></i> <span class=\"align-middle\">0 Rating</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class=\"grid grid-cols-1 mt-5 md:grid-cols-2 [&.gridView]:grid-cols-1 xl:grid-cols-4 group [&.gridView]:xl:grid-cols-1 gap-x-5\" id=\"cardGridView\">
                            <div class=\"card md:group-[.gridView]:flex relative\">
                                <div class=\"relative group-[.gridView]:static p-8 group-[.gridView]:p-5\">
                                    ...
                                    <div class=\"group-[.gridView]:p-3 group-[.gridView]:bg-slate-100 dark:group-[.gridView]:bg-zink-600 group-[.gridView]:inline-block rounded-md\">
                                        <img src=\"assets/images/product/img-02.png\" alt=\"\" class=\"group-[.gridView]:h-16\">
                                    </div>
                                </div>
                                <div class=\"card-body !pt-0 md:group-[.gridView]:flex group-[.gridView]:!p-5 group-[.gridView]:gap-3 group-[.gridView]:grow\">
                                    <div class=\"group-[.gridView]:grow\">
                                        <h6 class=\"mb-1 truncate transition-all duration-200 ease-linear text-15 hover:text-custom-500\"><a href=\"apps-ecommerce-product-overview\">Mesh Ergonomic Black Chair</a></h6>
                            ...
                            <div class=\"card md:group-[.gridView]:flex relative\">
                                <div class=\"relative group-[.gridView]:static p-8 group-[.gridView]:p-5\">
                                    ...
                                    <div class=\"group-[.gridView]:p-3 group-[.gridView]:bg-slate-100 dark:group-[.gridView]:bg-zink-600 group-[.gridView]:inline-block rounded-md\">
                                        <img src=\"assets/images/product/img-03.png\" alt=\"\" class=\"group-[.gridView]:h-16\">
                                    </div>
                                </div>
                                <div class=\"card-body !pt-0 md:group-[.gridView]:flex group-[.gridView]:!p-5 group-[.gridView]:gap-3 group-[.gridView]:grow\">
                                    <div class=\"group-[.gridView]:grow\">
                                        <h6 class=\"mb-1 truncate transition-all duration-200 ease-linear text-15 hover:text-custom-500\"><a href=\"apps-ecommerce-product-overview\">Fastcolors Typography Men</a></h6>
                                    ...
                                    <div class=\"flex items-center gap-2 mt-4 group-[.gridView]:mt-0 group-[.gridView]:self-end\">
                                        <button type=\"button\" class=\"w-full bg-white border-dashed text-slate-500 btn border-slate-500 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-600 focus:text-slate-600 focus:bg-slate-50 focus:border-slate-600 active:text-slate-600 active:bg-slate-50 active:border-slate-600 dark:bg-zink-700 dark:text-zink-200 dark:border-zink-400 dark:ring-zink-400/20 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:focus:bg-zink-600 dark:focus:text-zink-100 dark:active:bg-zink-600 dark:active:text-zink-100\"><i data-lucide=\"shopping-cart\" class=\"inline-block size-3 leading-none\"></i> <span class=\"align-middle\">Add to Cart</span></button>
                                        <div class=\"relative float-right dropdown\">
                                            <button class=\"flex items-center justify-center w-[38.39px] h-[38.39px] dropdown-toggle p-0 text-slate-500 btn bg-slate-100 hover:text-white hover:bg-slate-600 focus:text-white focus:bg-slate-600 focus:ring focus:ring-slate-100 active:text-white active:bg-slate-600 active:ring active:ring-slate-100 dark:bg-slate-500/20 dark:text-slate-400 dark:hover:bg-slate-500 dark:hover:text-white dark:focus:bg-slate-500 dark:focus:text-white dark:active:bg-slate-500 dark:active:text-white dark:ring-slate-400/20\" id=\"productList2\" data-bs-toggle=\"dropdown\"><i data-lucide=\"more-horizontal\" class=\"size-3\"></i></button>
                            ...
                            <div class=\"card md:group-[.gridView]:flex relative\">
                                <div class=\"relative group-[.gridView]:static p-8 group-[.gridView]:p-5\">
                                    <a href=\"#!\" class=\"absolute group/item toggle-button top-6 ltr:right-6 rtl:left-6\"><i data-lucide=\"heart\" class=\"size-5 text-slate-400 fill-slate-200 transition-all duration-150 ease-linear dark:text-zink-200 dark:fill-zink-600 group-[.active]/item:text-red-500 dark:group-[.active]/item:text-red-500 group-[.active]/item:fill-red-200 dark:group-[.active]/item:fill-red-500/20 group-hover/item:text-red-500 dark:group-hover/item:text-red-500 group-hover/item:fill-red-200 dark:group-hover/item:fill-red-500/20\"></i></a>
                                    <div class=\"group-[.gridView]:p-3 group-[.gridView]:bg-slate-100 dark:group-[.gridView]:bg-zink-600 group-[.gridView]:inline-block rounded-md\">
                                        <img src=\"assets/images/product/img-04.png\" alt=\"\" class=\"group-[.gridView]:h-16\">
                                    </div>
                                </div>
                                <div class=\"card-body !pt-0 md:group-[.gridView]:flex group-[.gridView]:!p-5 group-[.gridView]:gap-3 group-[.gridView]:grow\">
                                    <div class=\"group-[.gridView]:grow\">
                                        <h6 class=\"mb-1 truncate transition-all duration-200 ease-linear text-15 hover:text-custom-500\"><a href=\"apps-ecommerce-product-overview\">Mesh Ergonomic Green Chair</a></h6>
                            ...
                            <div class=\"card md:group-[.gridView]:flex relative\">
                                <div class=\"relative group-[.gridView]:static p-8 group-[.gridView]:p-5\">
                                    <a href=\"#!\" class=\"absolute group/item toggle-button top-6 ltr:right-6 rtl:left-6 active\"><i data-lucide=\"heart\" class=\"size-5 text-slate-400 fill-slate-200 transition-all duration-150 ease-linear dark:text-zink-200 dark:fill-zink-600 group-[.active]/item:text-red-500 dark:group-[.active]/item:text-red-500 group-[.active]/item:fill-red-200 dark:group-[.active]/item:fill-red-500/20 group-hover/item:text-red-500 dark:group-hover/item:text-red-500 group-hover/item:fill-red-200 dark:group-hover/item:fill-red-500/20\"></i></a>
                                    <div class=\"group-[.gridView]:p-3 group-[.gridView]:bg-slate-100 dark:group-[.gridView]:bg-zink-600 group-[.gridView]:inline-block rounded-md\">
                                        <img src=\"assets/images/product/img-05.png\" alt=\"\" class=\"group-[.gridView]:h-16\">
                                    </div>
                                </div>
                                <div class=\"card-body !pt-0 md:group-[.gridView]:flex group-[.gridView]:!p-5 group-[.gridView]:gap-3 group-[.gridView]:grow\">
                                    <div class=\"group-[.gridView]:grow\">
                                        <h6 class=\"mb-1 truncate transition-all duration-200 ease-linear text-15 hover:text-custom-500\"><a href=\"apps-ecommerce-product-overview\">Techel Black Bluetooth Soundbar</a></h6>
                            ...
                            <div class=\"card md:group-[.gridView]:flex relative\">
                                <div class=\"relative group-[.gridView]:static p-8 group-[.gridView]:p-5\">
                                    <a href=\"#!\" class=\"absolute group/item toggle-button top-6 ltr:right-6 rtl:left-6\"><i data-lucide=\"heart\" class=\"size-5 text-slate-400 fill-slate-200 transition-all duration-150 ease-linear dark:text-zink-200 dark:fill-zink-600 group-[.active]/item:text-red-500 dark:group-[.active]/item:text-red-500 group-[.active]/item:fill-red-200 dark:group-[.active]/item:fill-red-500/20 group-hover/item:text-red-500 dark:group-hover/item:text-red-500 group-hover/item:fill-red-200 dark:group-hover/item:fill-red-500/20\"></i></a>
                                    <div class=\"group-[.gridView]:p-3 group-[.gridView]:bg-slate-100 dark:group-[.gridView]:bg-zink-600 group-[.gridView]:inline-block rounded-md\">
                                        <img src=\"assets/images/product/img-06.png\" alt=\"\" class=\"group-[.gridView]:h-16\">
                                    </div>
                                </div>
                                <div class=\"card-body !pt-0 md:group-[.gridView]:flex group-[.gridView]:!p-5 group-[.gridView]:gap-3 group-[.gridView]:grow\">
                                    <div class=\"group-[.gridView]:grow\">
                                        <h6 class=\"mb-1 truncate transition-all duration-200 ease-linear text-15 hover:text-custom-500\"><a href=\"apps-ecommerce-product-overview\">Bovet Fleurier AIFSQ029</a></h6>
                            ...
                            <div class=\"card md:group-[.gridView]:flex relative\">
                                <div class=\"relative group-[.gridView]:static p-8 group-[.gridView]:p-5\">
                                    <a href=\"#!\" class=\"absolute group/item toggle-button top-6 ltr:right-6 rtl:left-6 active\"><i data-lucide=\"heart\" class=\"size-5 text-slate-400 fill-slate-200 transition-all duration-150 ease-linear dark:text-zink-200 dark:fill-zink-600 group-[.active]/item:text-red-500 dark:group-[.active]/item:text-red-500 group-[.active]/item:fill-red-200 dark:group-[.active]/item:fill-red-500/20 group-hover/item:text-red-500 dark:group-hover/item:text-red-500 group-hover/item:fill-red-200 dark:group-hover/item:fill-red-500/20\"></i></a>
                                    <div class=\"group-[.gridView]:p-3 group-[.gridView]:bg-slate-100 dark:group-[.gridView]:bg-zink-600 group-[.gridView]:inline-block rounded-md\">
                                        <img src=\"assets/images/product/img-08.png\" alt=\"\" class=\"group-[.gridView]:h-16\">
                                    </div>
                                </div>
                                <div class=\"card-body !pt-0 md:group-[.gridView]:flex group-[.gridView]:!p-5 group-[.gridView]:gap-3 group-[.gridView]:grow\">
                                    <div class=\"group-[.gridView]:grow\">
                                        <h6 class=\"mb-1 truncate transition-all duration-200 ease-linear text-15 hover:text-custom-500\"><a href=\"apps-ecommerce-product-overview\">Roar Twill Blue Baseball Cap</a></h6>
                            ...
                            <div class=\"card md:group-[.gridView]:flex relative\">
                                <div class=\"relative group-[.gridView]:static p-8 group-[.gridView]:p-5\">
                                    <a href=\"#!\" class=\"absolute group/item toggle-button top-6 ltr:right-6 rtl:left-6\"><i data-lucide=\"heart\" class=\"size-5 text-slate-400 fill-slate-200 transition-all duration-150 ease-linear dark:text-zink-200 dark:fill-zink-600 group-[.active]/item:text-red-500 dark:group-[.active]/item:text-red-500 group-[.active]/item:fill-red-200 dark:group-[.active]/item:fill-red-500/20 group-hover/item:text-red-500 dark:group-hover/item:text-red-500 group-hover/item:fill-red-200 dark:group-hover/item:fill-red-500/20\"></i></a>
                                    <div class=\"group-[.gridView]:p-3 group-[.gridView]:bg-slate-100 dark:group-[.gridView]:bg-zink-600 group-[.gridView]:inline-block rounded-md\">
                                        <img src=\"assets/images/product/img-01.png\" alt=\"\" class=\"group-[.gridView]:h-16\">
                                    </div>
                                </div>
                                <div class=\"card-body !pt-0 md:group-[.gridView]:flex group-[.gridView]:!p-5 group-[.gridView]:gap-3 group-[.gridView]:grow\">
                                    <div class=\"group-[.gridView]:grow\">
                                        <h6 class=\"mb-1 truncate transition-all duration-200 ease-linear text-15 hover:text-custom-500\"><a href=\"apps-ecommerce-product-overview\">Smartest Printed T-shirt</a></h6>
                                    ...
                                    <div class=\"flex items-center gap-2 mt-4 group-[.gridView]:mt-0 group-[.gridView]:self-end\">
                                        <button type=\"button\" class=\"w-full bg-white border-dashed text-slate-500 btn border-slate-500 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-600 focus:text-slate-600 focus:bg-slate-50 focus:border-slate-600 active:text-slate-600 active:bg-slate-50 active:border-slate-600 dark:bg-zink-700 dark:text-zink-200 dark:border-zink-400 dark:ring-zink-400/20 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:focus:bg-zink-600 dark:focus:text-zink-100 dark:active:bg-zink-600 dark:active:text-zink-100\"><i data-lucide=\"shopping-cart\" class=\"inline-block size-3 leading-none\"></i> <span class=\"align-middle\">Add to Cart</span></button>
                                        <div class=\"relative float-right dropdown\">
                                            <button class=\"flex items-center justify-center w-[38.39px] h-[38.39px] dropdown-toggle p-0 text-slate-500 btn bg-slate-100 hover:text-white hover:bg-slate-600 focus:text-white focus:bg-slate-600 focus:ring focus:ring-slate-100 active:text-white active:bg-slate-600 active:ring active:ring-slate-100 dark:bg-slate-500/20 dark:text-slate-400 dark:hover:bg-slate-500 dark:hover:text-white dark:focus:bg-slate-500 dark:focus:text-white dark:active:bg-slate-500 dark:active:text-white dark:ring-slate-400/20\" id=\"productList7\" data-bs-toggle=\"dropdown\"><i data-lucide=\"more-horizontal\" class=\"size-3\"></i></button>
                            ...
                            <div class=\"card md:group-[.gridView]:flex relative\">
                                <div class=\"relative group-[.gridView]:static p-8 group-[.gridView]:p-5\">
                                    <a href=\"#!\" class=\"absolute group/item toggle-button top-6 ltr:right-6 rtl:left-6 active\"><i data-lucide=\"heart\" class=\"size-5 text-slate-400 fill-slate-200 transition-all duration-150 ease-linear dark:text-zink-200 dark:fill-zink-600 group-[.active]/item:text-red-500 dark:group-[.active]/item:text-red-500 group-[.active]/item:fill-red-200 dark:group-[.active]/item:fill-red-500/20 group-hover/item:text-red-500 dark:group-hover/item:text-red-500 group-hover/item:fill-red-200 dark:group-hover/item:fill-red-500/20\"></i></a>
                                    <div class=\"group-[.gridView]:p-3 group-[.gridView]:bg-slate-100 dark:group-[.gridView]:bg-zink-600 group-[.gridView]:inline-block rounded-md\">
                                        <img src=\"assets/images/product/img-10.png\" alt=\"\" class=\"group-[.gridView]:h-16\">
                                    </div>
                                </div>
                                <div class=\"card-body !pt-0 md:group-[.gridView]:flex group-[.gridView]:!p-5 group-[.gridView]:gap-3 group-[.gridView]:grow\">
                                    <div class=\"group-[.gridView]:grow\">
                                        <h6 class=\"mb-1 truncate transition-all duration-200 ease-linear text-15 hover:text-custom-500\"><a href=\"apps-ecommerce-product-overview\">Crop tops for Women western wear</a></h6>
                                    ...
                                    <div class=\"flex items-center gap-2 mt-4 group-[.gridView]:mt-0 group-[.gridView]:self-end\">
                                        <button type=\"button\" class=\"w-full bg-white border-dashed text-slate-500 btn border-slate-500 hover:text-slate-500 hover:bg-slate-50 hover:border-slate-600 focus:text-slate-600 focus:bg-slate-50 focus:border-slate-600 active:text-slate-600 active:bg-slate-50 active:border-slate-600 dark:bg-zink-700 dark:text-zink-200 dark:border-zink-400 dark:ring-zink-400/20 dark:hover:bg-zink-600 dark:hover:text-zink-100 dark:focus:bg-zink-600 dark:focus:text-zink-100 dark:active:bg-zink-600 dark:active:text-zink-100\"><i data-lucide=\"shopping-cart\" class=\"inline-block size-3 leading-none\"></i> <span class=\"align-middle\">Add to Cart</span></button>
                                        <div class=\"relative float-right dropdown\">
                                            <button class=\"flex items-center justify-center w-[38.39px] h-[38.39px] dropdown-toggle p-0 text-slate-500 btn bg-slate-100 hover:text-white hover:bg-slate-600 focus:text-white focus:bg-slate-600 focus:ring focus:ring-slate-100 active:text-white active:bg-slate-600 active:ring active:ring-slate-100 dark:bg-slate-500/20 dark:text-slate-400 dark:hover:bg-slate-500 dark:hover:text-white dark:focus:bg-slate-500 dark:focus:text-white dark:active:bg-slate-500 dark:active:text-white dark:ring-slate-400/20\" id=\"productList8\" data-bs-toggle=\"dropdown\"><i data-lucide=\"more-horizontal\" class=\"size-3\"></i></button>
...
";
    ...
    {
        return "apps-ecommerce-product-grid.html.twig";
    }
    ...
    {
        return array (  816 => 705,  812 => 703,  805 => 698,  795 => 697,  94 => 6,  91 => 5,  81 => 4,  61 => 2,  38 => 1,);
    }
...
{{ component('breadcrumb', { pagetitle: 'Ecommerce', title: 'Grid View' }) }}
...
{% endblock %}", "apps-ecommerce-product-grid.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\apps-ecommerce-product-grid.html.twig");
    }
}
