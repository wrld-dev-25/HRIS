...
class __TwigTemplate_36b7b855e6ba7ac6a84a108a7f856bfe extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("partials/base.html.twig", "apps-ecommerce-cart.html.twig", 1);
...
";
        // line 6
        yield $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("breadcrumb", ["pagetitle" => "Ecommerce", "title" => "Shopping Cart"]);
        yield "
                ...
                <div class=\"grid grid-cols-1 xl:grid-cols-12 gap-x-5\">
                    <div class=\"xl:col-span-9 products-list\">
                        <div class=\"flex items-center gap-3 mb-5\">
                            ...
                            <div>
                                <a href=\"#!\" class=\"text-red-500 transition-all duration-300 ease-linear hover:text-red-600\"><i data-lucide=\"trash-2\" class=\"inline-block size-4 mr-1 align-middle\"></i> <span class=\"align-middle\">Delete All</span></a>
                            </div>
                        </div>
                            ...
                            <div class=\"card-body\">
                                <div class=\"grid grid-cols-1 gap-4 lg:grid-cols-12\">
                                    <div class=\"p-4 rounded-md lg:col-span-2 bg-slate-100 dark:bg-zink-600\">
                                        <img src=\"assets/images/product/img-08.png\" alt=\"\">
                                    </div><!--end col-->
                                    <div class=\"flex flex-col lg:col-span-4\">
                                        <div>
                                            <h5 class=\"mb-1 text-16\"><a href=\"apps-ecommerce-product-overview\">Roar Twill Blue Baseball Cap</a></h5>
                                        ...
                                        <div class=\"flex items-center gap-2 mt-auto\">
                                            ...
                                            <button data-modal-target=\"deleteModal\" type=\"button\" class=\"flex items-center justify-center size-[37.5px] p-0 text-red-500 bg-red-100 btn hover:text-white hover:bg-red-600 focus:text-white focus:bg-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:ring active:ring-red-100 dark:bg-red-500/20 dark:text-red-500 dark:hover:bg-red-500 dark:hover:text-white dark:focus:bg-red-500 dark:focus:text-white dark:active:bg-red-500 dark:active:text-white dark:ring-red-400/20 remove-button\"><i data-lucide=\"trash-2\" class=\"size-4\"></i></button>
                                        </div>
                                    </div><!--end col-->
                        ...
                        <div class=\"card products\" id=\"product2\">
                            <div class=\"card-body\">
                                <div class=\"grid grid-cols-1 gap-4 lg:grid-cols-12\">
                                    <div class=\"p-4 rounded-md lg:col-span-2 bg-slate-100 dark:bg-zink-600\">
                                        <img src=\"assets/images/product/img-04.png\" alt=\"\">
                                    </div><!--end col-->
                                    <div class=\"flex flex-col lg:col-span-4\">
                                        <div>
                                            <h5 class=\"mb-1 text-16\"><a href=\"apps-ecommerce-product-overview\">Mesh Ergonomic Green Chair</a></h5>
                        ...
                        <div class=\"card products\" id=\"product3\">
                            <div class=\"card-body\">
                                <div class=\"grid grid-cols-1 gap-4 lg:grid-cols-12\">
                                    ...
                                    <div class=\"flex flex-col lg:col-span-4\">
                                        <div>
                                            <h5 class=\"mb-1 text-16\"><a href=\"apps-ecommerce-product-overview\">Smartest Printed T-shirt</a></h5>
                    ...
                    <div class=\"xl:col-span-3\">
                        <div class=\"sticky top-[calc(theme('spacing.header')_*_1.3)] mb-5\">
                            ...
                            <div class=\"flex gap-2 mt-5 shrink-0\">
                                <a href=\"apps-ecommerce-product-list\" class=\"w-full text-white bg-red-500 border-red-500 btn hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:border-red-600 active:ring active:ring-red-100 dark:ring-red-400/20\">Continue to Shopping</a>
                                <a href=\"apps-ecommerce-checkout\" class=\"w-full text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20\">Checkout</a>
                            </div>
...
";
    ...
    public function block_javascripts($context, array $blocks = [])
    {
        ...
        // line 214
        yield "<script src=\"assets/js/pages/apps-ecommerce-cart.init.js\"></script>
<!-- App js -->
<script src=\"";
        // line 216
...
";
    ...
    {
        return array (  329 => 218,  325 => 216,  321 => 214,  311 => 213,  94 => 6,  91 => 5,  81 => 4,  61 => 2,  38 => 1,);
    }
...
{{ component('breadcrumb', { pagetitle: 'Ecommerce', title: 'Shopping Cart' }) }}
...
{% block javascripts %}
<script src=\"assets/js/pages/apps-ecommerce-cart.init.js\"></script>
<!-- App js -->
<script src=\"{{ asset('assets/js/app.js') }}\"></script>
{# <script src=\"assets/js/app.js\"></script> #}

{% endblock %}", "apps-ecommerce-cart.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\apps-ecommerce-cart.html.twig");
    }
}
