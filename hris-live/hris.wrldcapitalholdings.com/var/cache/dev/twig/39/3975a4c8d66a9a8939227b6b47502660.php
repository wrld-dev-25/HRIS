...
class __TwigTemplate_7fb235df56b11b14c391ba620a0ea599 extends Template
{
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 189
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["companyList"]) || array_key_exists("companyList", $context) ? $context["companyList"] : (function () { throw new RuntimeError('Variable "companyList" does not exist.', 189, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["companyItem"]) {
            // line 190
            yield "                                            <option value=\"";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["companyItem"], "id", [], "any", false, false, false, 190), "html", null, true);
            yield "\">";
            yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["companyItem"], "name", [], "any", false, false, false, 190), "html", null, true);
            yield "</option>
                                        ";
        }
        $_parent = $context['_parent'];
...
\$(\"#datetimepicker\").prop('readonly', false)
  ...
  function syncName() {
    ...
    nameField.value = opt ? opt.dataset.code || opt.text : '';
  }
...
";
    ...
    {
        return array (  427 => 312,  423 => 310,  419 => 308,  409 => 307,  326 => 233,  311 => 192,  300 => 190,  296 => 189,  286 => 182,  267 => 166,  248 => 150,  229 => 134,  210 => 118,  191 => 102,  172 => 86,  153 => 70,  141 => 60,  139 => 46,  132 => 40,  121 => 38,  117 => 37,  107 => 30,  100 => 25,  94 => 6,  91 => 5,  81 => 4,  61 => 2,  38 => 1,);
    }
...
{% endblock %}", "payroll_reports/payroll_reports_generation.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\payroll_reports\\payroll_reports_generation.html.twig");
    }
}
