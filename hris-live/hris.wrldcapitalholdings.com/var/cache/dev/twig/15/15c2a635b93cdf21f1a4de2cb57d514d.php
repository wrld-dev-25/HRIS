...
class __TwigTemplate_a03bf06d42aea5eb6086ecd9ab8e6c40 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "project_management/apps-subdivision.html.twig"));
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        yield "
            ";
        // line 6
        yield $this->env->getRuntime('Symfony\UX\TwigComponent\Twig\ComponentRuntime')->render("breadcrumb", ["pagetitle" => "Subdivisions", "title" => "Subdivisions"]);
        yield "
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["subdivisions"]) || array_key_exists("subdivisions", $context) ? $context["subdivisions"] : (function () { throw new RuntimeError('Variable "subdivisions" does not exist.', 42, $this->source); })()));
...
";
        // line 172
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["subdivisions"]) || array_key_exists("subdivisions", $context) ? $context["subdivisions"] : (function () { throw new RuntimeError('Variable "subdivisions" does not exist.', 172, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["subdivisionItem"]) {
            // line 173
...
";
        // line 218
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["subdivisions"]) || array_key_exists("subdivisions", $context) ? $context["subdivisions"] : (function () { throw new RuntimeError('Variable "subdivisions" does not exist.', 218, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["subdivisionItem"]) {
            // line 219
...
";
        // line 246
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 246, $this->source); })()), "flashes", ["status"], "method", false, false, false, 246));
...
";
        ...
        // line 249
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 249, $this->source); })()), "flashes", ["info"], "method", false, false, false, 249));
        foreach ($context['_seq'] as $context["_key"] => $context["flash_message"]) {
            // line 250
...
";
    ...
    {
        return array (  523 => 300,  519 => 298,  514 => 296,  510 => 295,  506 => 294,  462 => 252,  453 => 250,  449 => 249,  440 => 247,  436 => 246,  433 => 245,  420 => 244,  408 => 241,  393 => 232,  389 => 231,  385 => 230,  377 => 225,  367 => 219,  363 => 218,  359 => 216,  346 => 209,  342 => 208,  336 => 205,  329 => 201,  320 => 197,  312 => 196,  305 => 192,  298 => 188,  291 => 185,  287 => 180,  281 => 177,  273 => 173,  269 => 172,  236 => 141,  231 => 135,  217 => 123,  205 => 76,  192 => 69,  186 => 66,  177 => 60,  173 => 59,  169 => 58,  165 => 57,  158 => 52,  154 => 48,  147 => 43,  143 => 42,  104 => 6,  101 => 5,  88 => 4,  65 => 2,  42 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("{% extends 'partials/base.html.twig' %}
{% block title %}Subdivisions{% endblock %}

{% block content %}

            {{ component('breadcrumb', { pagetitle: 'Subdivisions', title: 'Subdivisions' }) }}
                <div class=\"grid grid-cols-1 gap-x-5 xl:grid-cols-12\">
                    <div class=\"xl:col-span-12\">
                        <div class=\"card\" id=\"subdivisionTable\">
                            <div class=\"card-body\">
                                        ...
                                        <tbody class=\"list\">
                                            {% for subdivisionItem in subdivisions %}
                                                <tr class=\"relative rounded-md after:absolute ltr:after:border-l-2 rtl:after:border-r-2 ltr:after:left-0 rtl:after:right-0 after:top-0 after:bottom-0 after:border-transparent [&.active]:after:border-custom-500 [&.active]:bg-slate-100 dark:[&.active]:bg-zink-600\">
                                                    ...
                                                    <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 name\">{{ subdivisionItem.name }}</td>
                                                    <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 location\">{{ subdivisionItem.location }}</td>
                                                    <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 phase\">{{ subdivisionItem.total_phases }}</td>
                                                    <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 lot\">{{ subdivisionItem.total_lots }}</td>
                                                    <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5\">
                                                        <div class=\"action-subdivision relative dropdown\">
                                                            <button class=\"flex items-center justify-center size-[30px] dropdown-toggle p-0 text-slate-500 btn bg-slate-100 hover:text-white hover:bg-slate-600 focus:text-white focus:bg-slate-600 focus:ring focus:ring-slate-100 active:text-white active:bg-slate-600 active:ring active:ring-slate-100 dark:bg-slate-500/20 dark:text-slate-400 dark:hover:bg-slate-500 dark:hover:text-white dark:focus:bg-slate-500 dark:focus:text-white dark:active:bg-slate-500 dark:active:text-white dark:ring-slate-400/20\" id=\"usersAction1\" data-bs-toggle=\"dropdown\"><i data-lucide=\"more-horizontal\" class=\"size-3\"></i></button>
                                                            <ul class=\"absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600\" aria-labelledby=\"usersAction1\">
                                                                <li>
                                                                    <a data-modal-target=\"editUserModal{{ subdivisionItem.id }}\" class=\"edit-subdivision block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200\" href=\"#!\"><i data-lucide=\"file-edit\" class=\"inline-block size-3 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">Edit</span></a>
                                                                </li>
                                                                <li>
                                                                    <a data-modal-target=\"deleteModal{{ subdivisionItem.id }}\" class=\"delete-subdivision block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200\" href=\"#!\" style=\"position: relative; z-index: 10;\"><i data-lucide=\"trash-2\" class=\"inline-block size-3 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">Delete</span></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
...
{% for subdivisionItem in subdivisions %}
<div id=\"editUserModal{{ subdivisionItem.id }}\" modal-center class=\"fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show \">
    <div class=\"w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600\">
        <div class=\"flex items-center justify-between p-4 border-b dark:border-zink-300/20\">
            <h5 class=\"text-16\">Edit Subdivision</h5>
            <button data-modal-close=\"editUserModal{{ subdivisionItem.id }}\" class=\"transition-all duration-200 ease-linear text-slate-400 hover:text-red-500\"><i data-lucide=\"x\" class=\"size-5\"></i></button>
        </div>
        <div class=\"max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto\">
            <form action=\"{{ path('update_subdivision_form') }}\" method=\"post\">
                {# <div class=\"mb-3\">
                    <label for=\"userId\" class=\"inline-block mb-2 text-base font-medium\">User ID</label>
                    <input type=\"text\" id=\"userId\" class=\"form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" disabled value=\"#TW1500004\" required>
                </div> #}
                <input type=\"hidden\" name=\"subdivision_id\" value=\"{{ subdivisionItem.id }}\">
                <div class=\"mb-3\">
                    <label for=\"code\" class=\"inline-block mb-2 text-base font-medium\">Subdivision code</label>
                    <input type=\"text\" id=\"code\" name=\"code\" class=\"form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" placeholder=\"Enter code\" value=\"{{ subdivisionItem.subdivisionCode }}\" required>
                </div>
                <div class=\"mb-3\">
                    <label for=\"name\" class=\"inline-block mb-2 text-base font-medium\">Subdivsion Name</label>
                    <input type=\"text\" id=\"name\" name=\"name\" class=\"form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" placeholder=\"Enter subdivision name\" value=\"{{ subdivisionItem.name }}\" required>
                </div>
                <div class=\"mb-3\">
                        <label for=\"total_lots\" class=\"inline-block mb-2 text-base font-medium\">Total Lots</label>
                        <input type=\"number\" min=\"0\" id=\"edit_total_lots\" name=\"total_lots\" class=\"form-input edit_total_lots border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" min=\"0\" value=\"{{ subdivisionItem.total_lots }}\" data-minimum=\"{{subdivisionItem.total_consumed_lots}}\" data-id=\"{{subdivisionItem.id}}\" placeholder=\"Enter subdivision name\" required>
                         <span id=\"total_lots_error{{ subdivisionItem.id }}\" class=\"text-red-500 hidden\">Total lots must be greater than {{ subdivisionItem.total_consumed_lots }}</span>
                </div>
                <div class=\"mb-3\">
                    <label for=\"description\" class=\"inline-block mb-2 text-base font-medium\">Description</label>
                    <input type=\"text\" id=\"description\" name=\"description\" class=\"form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" placeholder=\"Enter subdivision description\" value=\"{{ subdivisionItem.description }}\" required>
                </div>
                <div class=\"mb-3\">
                    <label for=\"location\" class=\"inline-block mb-2 text-base font-medium\">Location</label>
                    <input type=\"text\" id=\"location\" name=\"location\" class=\"form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" placeholder=\"Enter subdivision location\" value=\"{{ subdivisionItem.location }}\" required>
                </div>
                <div class=\"flex justify-end gap-2 mt-4\">
                    <button type=\"reset\" data-modal-close=\"editUserModal{{ subdivisionItem.id }}\" class=\"text-red-500 transition-all duration-200 ease-linear bg-white border-white btn hover:text-red-600 focus:text-red-600 active:text-red-600 dark:bg-zink-500 dark:border-zink-500\">Cancel</button>
                    <button type=\"submit\" class=\"text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20\" id=\"submit_button_{{ subdivisionItem.id }}\">Update</button>
                </div>
            </form>
        </div>
    </div>
...
{% for subdivisionItem in subdivisions %}
<div id=\"deleteModal{{ subdivisionItem.id }}\" modal-center class=\"fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show\">
    <div class=\"w-screen md:w-[25rem] bg-white shadow rounded-md dark:bg-zink-600\">
        <div class=\"max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto px-6 py-8\">
            <div class=\"float-right\">
                <button data-modal-close=\"deleteModal\" class=\"transition-all duration-200 ease-linear text-slate-500 hover:text-red-500\"><i data-lucide=\"x\" class=\"size-5\"></i></button>
            ...
            <div class=\"mt-5 text-center\">
                ...
                <p class=\"text-slate-500 dark:text-zink-200\">Are you certain you want to delete this record?</p>
                <div class=\"flex justify-center gap-2 mt-6\">
                <form action=\"{{path('delete_subdivision_form')}}\" method=\"post\">
                    <input type=\"hidden\" name=\"subdivision_id\" value=\"{{ subdivisionItem.id }}\">
                    <button type=\"reset\" data-modal-close=\"deleteModal{{ subdivisionItem.id }}\" class=\"bg-white text-slate-500 btn hover:text-slate-500 hover:bg-slate-100 focus:text-slate-500 focus:bg-slate-100 active:text-slate-500 active:bg-slate-100 dark:bg-zink-600 dark:hover:bg-slate-500/10 dark:focus:bg-slate-500/10 dark:active:bg-slate-500/10\">Cancel</button>
                    <button type=\"submit\" class=\"text-white bg-red-500 border-red-500 btn hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:border-red-600 active:ring active:ring-red-100 dark:ring-custom-400/20\">Yes, Delete It!</button>
                </form> 
                </div>
            </div>
...
{% endblock %}", "project_management/apps-subdivision.html.twig", "C:\\xampp\\htdocs\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\project_management\\apps-subdivision.html.twig");
    }
}
