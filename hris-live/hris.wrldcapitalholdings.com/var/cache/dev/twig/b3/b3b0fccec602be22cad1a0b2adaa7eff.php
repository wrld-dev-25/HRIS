...
class __TwigTemplate_f6f3a5134a139b34f730dbc8a7610e22 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("partials/base.html.twig", "apps-ecommerce-orders.html.twig", 1);
...
";
        // line 6
        yield $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("breadcrumb", ["pagetitle" => "Ecommerce", "title" => "Order Lists"]);
        yield "
                ...
                <div class=\"grid grid-cols-1 gap-x-5 md:grid-cols-2 2xl:grid-cols-12\">
                    <div class=\"2xl:col-span-2 2xl:row-span-1\">
                        <div class=\"card\">
                            <div class=\"flex items-center gap-3 card-body\">
                                <div class=\"flex items-center justify-center size-12 rounded-md text-15 bg-custom-50 text-custom-500 dark:bg-custom-500/20 shrink-0\"><i data-lucide=\"boxes\"></i></div>
                                <div class=\"grow\">
                    ...
                    <div class=\"2xl:col-span-2 2xl:row-span-1\">
                        <div class=\"card\">
                            <div class=\"flex items-center gap-3 card-body\">
                                <div class=\"flex items-center justify-center size-12 rounded-md text-15 bg-sky-50 text-sky-500 dark:bg-sky-500/20 shrink-0\"><i data-lucide=\"package-plus\"></i></div>
                                <div class=\"grow\">
                    ...
                    <div class=\"2xl:col-span-2 2xl:row-span-1\">
                        <div class=\"card\">
                            <div class=\"flex items-center gap-3 card-body\">
                                <div class=\"flex items-center justify-center size-12 text-yellow-500 rounded-md text-15 bg-yellow-50 dark:bg-yellow-500/20 shrink-0\"><i data-lucide=\"loader\"></i></div>
                                <div class=\"grow\">
                    ...
                    <div class=\"2xl:col-span-2 2xl:row-span-1\">
                        <div class=\"card\">
                            <div class=\"flex items-center gap-3 card-body\">
                                <div class=\"flex items-center justify-center size-12 text-purple-500 rounded-md text-15 bg-purple-50 dark:bg-purple-500/20 shrink-0\"><i data-lucide=\"truck\"></i></div>
                                <div class=\"grow\">
                    ...
                    <div class=\"2xl:col-span-2 2xl:row-span-1\">
                        <div class=\"card\">
                            <div class=\"flex items-center gap-3 card-body\">
                                <div class=\"flex items-center justify-center size-12 text-green-500 rounded-md text-15 bg-green-50 dark:bg-green-500/20 shrink-0\"><i data-lucide=\"package-check\"></i></div>
                                <div class=\"grow\">
                    ...
                    <div class=\"2xl:col-span-2 2xl:row-span-1\">
                        <div class=\"card\">
                            <div class=\"flex items-center gap-3 card-body\">
                                <div class=\"flex items-center justify-center size-12 text-red-500 rounded-md text-15 bg-red-50 dark:bg-red-500/20 shrink-0\"><i data-lucide=\"package-x\"></i></div>
                                <div class=\"grow\">
...
";
    ...
    {
        return array (  700 => 589,  696 => 587,  685 => 578,  675 => 577,  94 => 6,  91 => 5,  81 => 4,  61 => 2,  38 => 1,);
    }
...
{{ component('breadcrumb', { pagetitle: 'Ecommerce', title: 'Order Lists' }) }}
...
{% endblock %}", "apps-ecommerce-orders.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\apps-ecommerce-orders.html.twig");
    }
}
