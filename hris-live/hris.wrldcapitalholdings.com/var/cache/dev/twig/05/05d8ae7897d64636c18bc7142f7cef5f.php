...
/* dashboards-analytics.html.twig */
class __TwigTemplate_ec1559c23bf7000f3d73e49e0e7e7318 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "dashboards-analytics.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "dashboards-analytics.html.twig"));

        $this->parent = $this->loadTemplate("partials/base.html.twig", "dashboards-analytics.html.twig", 1);
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        yield "
            ";
        // line 6
        yield $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("breadcrumb", ["pagetitle" => "Dashboards", "title" => "Analytics"]);
        yield "
                ...
                <div class=\"grid grid-cols-12 gap-x-5\">
                    <div class=\"order-1 md:col-span-6 lg:col-span-3 col-span-12 2xl:order-1 bg-green-100 dark:bg-green-500/20 card 2xl:col-span-2 group-data-[skin=bordered]:border-green-500/20 relative overflow-hidden\">
                        <div class=\"card-body\">
                            <i data-lucide=\"kanban\" class=\"absolute top-0 size-32 stroke-1 text-green-200/50 dark:text-green-500/20 ltr:-right-10 rtl:-left-10\"></i>
                    ...
                    <div class=\"order-5 col-span-12 2xl:order-1 card 2xl:row-span-2 2xl:col-span-8\">
                        <div class=\"card-body\">
                            ...
                            <div id=\"platformPerspective\" class=\"apex-charts\" data-chart-colors='[\"bg-custom-500\"]' dir=\"ltr\"></div>
                            <div id=\"chartdiv\"></div>
                        </div>
                    </div><!--end col-->
                    <div class=\"order-3 md:col-span-6 lg:col-span-3 col-span-12 2xl:order-1 bg-sky-100 dark:bg-sky-500/20 card 2xl:col-span-2 group-data-[skin=bordered]:border-sky-500/20 relative overflow-hidden\">
                        <div class=\"card-body\">
                            <i data-lucide=\"list-filter\" class=\"absolute top-0 size-32 stroke-1 text-sky-200/50 dark:text-sky-500/20 ltr:-right-10 rtl:-left-10\"></i>
                        ...
                        <div class=\"card-body\">
                            ...
                            <ul class=\"flex flex-col gap-5\">
                                <li class=\"flex items-center gap-3\">
                                    <div class=\"flex items-center justify-center size-8 text-red-500 bg-red-100 rounded-md dark:bg-red-500/20 shrink-0\">
                                ...
                                <li class=\"flex items-center gap-3\">
                                    <div class=\"flex items-center justify-center size-8 rounded-md text-sky-500 bg-sky-100 dark:bg-sky-500/20 shrink-0\">
                                ...
                                <li class=\"flex items-center gap-3\">
                                    <div class=\"flex items-center justify-center size-8 text-orange-500 bg-orange-100 rounded-md dark:bg-orange-500/20 shrink-0\">
                                ...
                                <li class=\"flex items-center gap-3\">
                                    <div class=\"flex items-center justify-center size-8 text-green-500 bg-green-100 rounded-md dark:bg-green-500/20 shrink-0\">
                                ...
                                <li class=\"flex items-center gap-3\">
                                    <div class=\"flex items-center justify-center size-8 rounded-md text-slate-500 bg-slate-100 dark:bg-zink-600 dark:text-zink-200 shrink-0\">
...
<script src=\"assets/js/pages/dashboards-analytics.init.js\"></script>
...
";
    ...
    {
        return "dashboards-analytics.html.twig";
    }
...
{% block content %}
            ...
            {{ component('breadcrumb', { pagetitle: 'Dashboards', title: 'Analytics' }) }}
...
{% endblock %}", "dashboards-analytics.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\dashboards-analytics.html.twig");
    }
}
