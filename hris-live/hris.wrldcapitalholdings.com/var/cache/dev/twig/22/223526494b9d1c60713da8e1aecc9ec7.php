...
/* apps-invoice-add-new.html.twig */
class __TwigTemplate_2a8a39adf4c9a62a73a59fb04c96918c extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps-invoice-add-new.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps-invoice-add-new.html.twig"));

        $this->parent = $this->loadTemplate("partials/base.html.twig", "apps-invoice-add-new.html.twig", 1);
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        yield "
            ";
        // line 6
        yield $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("breadcrumb", ["pagetitle" => "Invoices", "title" => "Add New"]);
        yield "
                ...
                <div class=\"grid items-center grid-cols-1 gap-5 mb-5 xl:grid-cols-12\">
                    ...
                    <div class=\"xl:col-span-3 xl:col-start-10\">
                        <div class=\"flex justify-end gap-2\">
                            ...
                            <button type=\"button\" class=\"text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20\"><i data-lucide=\"save\" class=\"inline-block size-4 mr-1\"></i> <span class=\"align-middle\">Save & Download</span></button>
                        </div>
                    </div>
                </div><!--end grid-->
                        ...
                        <form action=\"#!\">
                                    ...
                                    <tbody class=\"before:block before:h-3 item-list\">
                                        ...
                                        <tr>
                                            ...
                                            <td class=\"border border-slate-200 px-3.5 py-1.5 text-center dark:border-zink-500\">
                                                <button type=\"button\" class=\"px-2 py-1.5 text-xs text-red-500 bg-red-100 btn hover:text-white hover:bg-red-600 focus:text-white focus:bg-red-600 focus:ring focus:ring-red-100 active:text-white active:bg-red-600 active:ring active:ring-red-100 dark:bg-red-500/20 dark:text-red-500 dark:hover:bg-red-500 dark:hover:text-white dark:focus:bg-red-500 dark:focus:text-white dark:active:bg-red-500 dark:active:text-white dark:ring-red-400/20 product-removal\"><i data-lucide=\"trash-2\" class=\"inline-block size-3 mr-1 align-middle\"></i> <span class=\"align-middle\">Delete</span></button>
                                            </td>
                            ...
                            <div class=\"grid grid-cols-1 gap-5 xl:grid-cols-12\">
                                <div class=\"xl:col-span-3\">
                                    ...
                                    <select class=\"form-input border-slate-300 focus:outline-none focus:border-custom-500\" data-choices data-choices-search-false name=\"paymentMethod\" id=\"paymentMethod\">
                            ...
                            <div class=\"flex justify-end gap-2 mt-5\">
                                <button type=\"button\" class=\"text-slate-500 btn bg-slate-200 border-slate-200 hover:text-slate-600 hover:bg-slate-300 hover:border-slate-300 focus:text-slate-600 focus:bg-slate-300 focus:border-slate-300 focus:ring focus:ring-slate-100 active:text-slate-600 active:bg-slate-300 active:border-slate-300 active:ring active:ring-slate-100 dark:bg-zink-600 dark:hover:bg-zink-500 dark:border-zink-600 dark:hover:border-zink-500 dark:text-zink-200 dark:ring-zink-400/50\"><i data-lucide=\"refresh-ccw\" class=\"inline-block size-4 mr-1\"></i> <span class=\"align-middle\">Reset</span></button>
                                <button type=\"button\" class=\"text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20\"><i data-lucide=\"save\" class=\"inline-block size-4 mr-1\"></i> <span class=\"align-middle\">Save</span></button>
                                <button type=\"button\" class=\"text-white bg-green-500 border-green-500 btn hover:text-white hover:bg-green-600 hover:border-green-600 focus:text-white focus:bg-green-600 focus:border-green-600 focus:ring focus:ring-green-100 active:text-white active:bg-green-600 active:border-green-600 active:ring active:ring-green-100 dark:ring-green-400/10\"><i data-lucide=\"download\" class=\"inline-block size-4 mr-1\"></i> <span class=\"align-middle\">Download</span></button>
                            </div>
                        </form>
                    </div>
                </div><!--end card-->
...
";
    ...
    {
        return "apps-invoice-add-new.html.twig";
    }
    ...
    {
        return array (  428 => 317,  424 => 315,  419 => 312,  409 => 311,  94 => 6,  91 => 5,  81 => 4,  61 => 2,  38 => 1,);
    }
...
{% block content %}
            ...
            {{ component('breadcrumb', { pagetitle: 'Invoices', title: 'Add New' }) }}
...
{% endblock %}", "apps-invoice-add-new.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\apps-invoice-add-new.html.twig");
    }
}
