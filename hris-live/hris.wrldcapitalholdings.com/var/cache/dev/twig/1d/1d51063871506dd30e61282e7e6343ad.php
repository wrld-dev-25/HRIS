...
class __TwigTemplate_cc7209f8074347bbeccb0c4d7785b5ef extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "partials/_topbar.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "partials/_topbar.html.twig"));
    ...
    <div class=\"layout-width\">
        ...
        yield "
                    ";
        // line 103
        yield from $this->load("partials/_notification-area.html.twig", 103)->unwrap()->yield($context);
        // line 104
        yield "
        ...
        // line 115
        yield "                                <img src=\"";
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 115, $this->source); })()), "session", [], "any", false, false, false, 115), "get", ["profile_image_path"], "method", false, false, false, 115)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 115, $this->source); })()), "session", [], "any", false, false, false, 115), "get", ["profile_image_path"], "method", false, false, false, 115)), "html", null, true)) : ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/users/user-dummy-img.jpg"), "html", null, true)));
        ...
        // line 127
        yield "                                        <img src=\"";
        yield (((($tmp = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 127, $this->source); })()), "session", [], "any", false, false, false, 127), "get", ["profile_image_path"], "method", false, false, false, 127)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 127, $this->source); })()), "session", [], "any", false, false, false, 127), "get", ["profile_image_path"], "method", false, false, false, 127)), "html", null, true)) : ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/users/user-dummy-img.jpg"), "html", null, true)));
        ...
        // line 132
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 132, $this->source); })()), "session", [], "any", false, false, false, 132), "get", ["fullname"], "method", false, false, false, 132), "html", null, true);
        yield "</h6>
                                    <p class=\"text-slate-500 dark:text-zink-300 text-balance\">";
        // line 133
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 133, $this->source); })()), "session", [], "any", false, false, false, 133), "get", ["userTypeName"], "method", false, false, false, 133), "html", null, true);
        yield "</p>
                                </div>
                            </a>
                            <ul>
                                <li>
                                    ";
        // line 138
        $context["empCode"] = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 138, $this->source); })()), "session", [], "any", false, false, false, 138), "get", ["empCode"], "method", false, false, false, 138);
        // line 139
        ...
        yield (((array_key_exists("empCode", $context) && (Twig\Extension\CoreExtension::length($this->env->getCharset(), (isset($context["empCode"]) || array_key_exists("empCode", $context) ? $context["empCode"] : (function () { throw new RuntimeError('Variable "empCode" does not exist.', 139, $this->source); })())) > 0))) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("employee_profile", ["employee_code" => (isset($context["empCode"]) || array_key_exists("empCode", $context) ? $context["empCode"] : (function () { throw new RuntimeError('Variable "empCode" does not exist.', 139, $this->source); })())]), "html", null, true)) : ("#"));
...
<div id=\"cartSidePenal\" drawer-end class=\"fixed inset-y-0 flex flex-col w-full transition-transform duration-300 ease-in-out transform bg-white shadow dark:bg-zink-600 ltr:right-0 rtl:left-0 md:w-96 z-drawer show\">
    ...
    {
        return array (  274 => 230,  246 => 205,  218 => 180,  186 => 151,  183 => 150,  177 => 139,  175 => 138,  167 => 133,  163 => 132,  154 => 127,  152 => 125,  139 => 115,  127 => 104,  125 => 103,  122 => 102,  113 => 89,  84 => 20,  78 => 17,  73 => 15,  67 => 12,  61 => 9,  56 => 7,  48 => 1,);
    }

    public function getSourceContext(): Source
    {
        return new Source("<header id=\"page-topbar\" class=\"ltr:md:left-vertical-menu rtl:md:right-vertical-menu group-data-[sidebar-size=md]:ltr:md:left-vertical-menu-md group-data-[sidebar-size=md]:rtl:md:right-vertical-menu-md group-data-[sidebar-size=sm]:ltr:md:left-vertical-menu-sm group-data-[sidebar-size=sm]:rtl:md:right-vertical-menu-sm group-data-[layout=horizontal]:ltr:left-0 group-data-[layout=horizontal]:rtl:right-0 fixed right-0 z-[1000] left-0 print:hidden group-data-[navbar=bordered]:m-4 group-data-[navbar=bordered]:[&.is-sticky]:mt-0 transition-all ease-linear duration-300 group-data-[navbar=hidden]:hidden group-data-[navbar=scroll]:absolute group/topbar group-data-[layout=horizontal]:z-[1004]\">
    <div class=\"layout-width\">
        <div class=\"flex items-center px-4 mx-auto bg-topbar border-b-2 border-topbar group-data-[topbar=dark]:bg-topbar-dark group-data-[topbar=dark]:border-topbar-dark group-data-[topbar=brand]:bg-topbar-brand group-data-[topbar=brand]:border-topbar-brand shadow-md h-header shadow-slate-200/50 group-data-[navbar=bordered]:rounded-md group-data-[navbar=bordered]:group-[.is-sticky]/topbar:rounded-t-none group-data-[topbar=dark]:dark:bg-zink-700 group-data-[topbar=dark]:dark:border-zink-700 dark:shadow-none group-data-[topbar=dark]:group-[.is-sticky]/topbar:dark:shadow-zink-500 group-data-[topbar=dark]:group-[.is-sticky]/topbar:dark:shadow-md group-data-[navbar=bordered]:shadow-none group-data-[layout=horizontal]:group-data-[navbar=bordered]:rounded-b-none group-data-[layout=horizontal]:shadow-none group-data-[layout=horizontal]:dark:group-[.is-sticky]/topbar:shadow-none\">
            <div class=\"flex items-center w-full group-data-[layout=horizontal]:mx-auto group-data-[layout=horizontal]:max-w-screen-2xl navbar-header group-data-[layout=horizontal]:ltr:xl:pr-3 group-data-[layout=horizontal]:rtl:xl:pl-3\">
                <!-- LOGO -->
                <div class=\"items-center justify-center hidden px-5 text-center h-header group-data-[layout=horizontal]:md:flex group-data-[layout=horizontal]:ltr::pl-0 group-data-[layout=horizontal]:rtl:pr-0\">
                    <a href=\"{{ path(\"dashboard\") }}\">
                        <span class=\"hidden\">
                            <img src=\"{{ asset('assets/images/wrld_complete.png') }}\" alt=\"\" class=\"h-6 mx-auto\">
                        </span>
                        <span class=\"group-data-[topbar=dark]:hidden group-data-[topbar=brand]:hidden\">
                            <img src=\"{{ asset('assets/images/wrld_complete.png') }}\" alt=\"\" class=\"h-6 mx-auto\">
                        </span>
                    </a>
                    <a href=\"{{ path(\"dashboard\") }}\" class=\"hidden group-data-[topbar=dark]:block group-data-[topbar=brand]:block\">
                        <span class=\"group-data-[topbar=dark]:hidden group-data-[topbar=brand]:hidden\">
                            <img src=\"{{ asset('assets/images/wrld_icon_2-removebg.png') }}\" alt=\"\" class=\"h-6 mx-auto\">
                        </span>
                        <span class=\"group-data-[topbar=dark]:block group-data-[topbar=brand]:block\">
                            <img src=\"{{ asset('assets/images/wrld_white_complete2.png') }}\" alt=\"\" class=\"h-6 mx-auto\">
                        </span>
                    </a>
                </div>
                ...
                <div class=\"flex gap-3 ms-auto\">
                    {# <div class=\"relative flex items-center dropdown h-header\">
                        <button type=\"button\" class=\"inline-flex justify-center items-center p-0 text-topbar-item transition-all size-[37.5px] duration-200 ease-linear bg-topbar rounded-md dropdown-toggle btn hover:bg-topbar-item-bg-hover hover:text-topbar-item-hover group-data-[topbar=dark]:bg-topbar-dark group-data-[topbar=dark]:hover:bg-topbar-item-bg-hover-dark group-data-[topbar=dark]:hover:text-topbar-item-hover-dark group-data-[topbar=brand]:bg-topbar-brand group-data-[topbar=brand]:hover:bg-topbar-item-bg-hover-brand group-data-[topbar=brand]:hover:text-topbar-item-hover-brand group-data-[topbar=dark]:dark:bg-zink-700 group-data-[topbar=dark]:dark:hover:bg-zink-600 group-data-[topbar=dark]:dark:text-zink-500 group-data-[topbar=dark]:dark:hover:text-zink-50\" id=\"flagsDropdown\" data-bs-toggle=\"dropdown\">
                            <img src=\"assets/images/flags/20/us.svg\" alt=\"\" id=\"header-lang-img\" class=\"h-5 rounded-sm\">
                        </button>
                    ...
                    {# <div class=\"relative flex items-center h-header\">
                        <button type=\"button\" data-drawer-target=\"cartSidePenal\" class=\"inline-flex relative justify-center items-center p-0 text-topbar-item transition-all size-[37.5px] duration-200 ease-linear bg-topbar rounded-md btn hover:bg-topbar-item-bg-hover hover:text-topbar-item-hover group-data-[topbar=dark]:bg-topbar-dark group-data-[topbar=dark]:hover:bg-topbar-item-bg-hover-dark group-data-[topbar=dark]:hover:text-topbar-item-hover-dark group-data-[topbar=brand]:bg-topbar-brand group-data-[topbar=brand]:hover:bg-topbar-item-bg-hover-brand group-data-[topbar=brand]:hover:text-topbar-item-hover-brand group-data-[topbar=dark]:dark:bg-zink-700 group-data-[topbar=dark]:dark:hover:bg-zink-600 group-data-[topbar=brand]:text-topbar-item-brand group-data-[topbar=dark]:dark:hover:text-zink-50 group-data-[topbar=dark]:dark:text-zink-200 group-data-[topbar=dark]:text-topbar-item-dark\">
                            <i data-lucide=\"shopping-cart\" class=\"inline-block size-5 stroke-1 fill-slate-100 group-data-[topbar=dark]:fill-topbar-item-bg-hover-dark group-data-[topbar=brand]:fill-topbar-item-bg-hover-brand\"></i>
                    ...
                    {% include 'partials/_notification-area.html.twig' %}
                    ...
                    <div class=\"relative flex items-center dropdown h-header\">
                        <button type=\"button\" class=\"inline-block p-0 transition-all duration-200 ease-linear bg-topbar rounded-full text-topbar-item dropdown-toggle btn hover:bg-topbar-item-bg-hover hover:text-topbar-item-hover group-data-[topbar=dark]:text-topbar-item-dark group-data-[topbar=dark]:bg-topbar-dark group-data-[topbar=dark]:hover:bg-topbar-item-bg-hover-dark group-data-[topbar=dark]:hover:text-topbar-item-hover-dark group-data-[topbar=brand]:bg-topbar-brand group-data-[topbar=brand]:hover:bg-topbar-item-bg-hover-brand group-data-[topbar=brand]:hover:text-topbar-item-hover-brand group-data-[topbar=dark]:dark:bg-zink-700 group-data-[topbar=dark]:dark:hover:bg-zink-600 group-data-[topbar=brand]:text-topbar-item-brand group-data-[topbar=dark]:dark:hover:text-zink-50 group-data-[topbar=dark]:dark:text-zink-200\" id=\"dropdownMenuButton\" data-bs-toggle=\"dropdown\">
                            <div class=\"bg-pink-100 rounded-full\">
                                {# <img src=\"{{asset('assets/images/users/user-profile.png')}}\" alt=\"\" class=\"size-[37.5px] rounded-full\"> #}
                                <img src=\"{{ app.session.get('profile_image_path') ? asset(app.session.get('profile_image_path')) : asset('assets/images/users/user-dummy-img.jpg') }}\" alt=\"\" class=\"size-[37.5px] rounded-full\">
                        ...
                        <div class=\"absolute z-50 hidden p-4 ltr:text-left rtl:text-right bg-white rounded-md shadow-md !top-4 dropdown-menu min-w-[14rem] dark:bg-zink-600\" aria-labelledby=\"dropdownMenuButton\">
                            ...
                            <a href=\"#!\" class=\"flex gap-3 mb-3\">
                                <div class=\"relative inline-block shrink-0\">
                                    <div class=\"rounded bg-slate-100 dark:bg-zink-500\">
                                        {# <img src=\"{{asset('assets/images/users/user-profile.png')}}\" alt=\"\" class=\"size-12 rounded\"> #}
                                        {# <img src=\"{{ asset( app.session.get('profile_image_path')) }}\" alt=\"\" class=\"size-12 rounded\"> 
                                        <img src=\"{{ asset( app.session.get('profile_image_path')) }}\" alt=\"\" class=\"size-12 rounded\">  #}
                                        <img src=\"{{ app.session.get('profile_image_path') ? asset(app.session.get('profile_image_path')) : asset('assets/images/users/user-dummy-img.jpg') }}\" alt=\"\" class=\"size-12 rounded>
                                    </div>
                                    <span class=\"-top-1 ltr:-right-1 rtl:-left-1 absolute w-2.5 h-2.5 bg-green-400 border-2 border-white rounded-full dark:border-zink-600\"></span>
                                </div>
                                <div>
                                    <h6 class=\"mb-1 text-15 text-balance\">{{ app.session.get('fullname') }}</h6>
                                    <p class=\"text-slate-500 dark:text-zink-300 text-balance\">{{ app.session.get('userTypeName') }}</p>
                                </div>
                            </a>
                            <ul>
                                <li>
                                    {% set empCode = app.session.get('empCode') %}
                                    <a class=\"block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500\" href=\"{{ empCode is defined and empCode|length > 0 ? path('employee_profile', parameters = {'employee_code': empCode}) : '#' }}\"><i data-lucide=\"user-2\" class=\"inline-block size-4 ltr:mr-2 rtl:ml-2\"></i> Profile</a>
                                </li>
                                {# <li>
                                    <a class=\"block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500\" href=\"#!\"><i data-lucide=\"mail\" class=\"inline-block size-4 ltr:mr-2 rtl:ml-2\"></i> Inbox <span class=\"inline-flex items-center justify-center size-5 ltr:ml-2 rtl:mr-2 text-[11px] font-medium border rounded-full text-white bg-red-500 border-red-500\">15</span></a>
                                </li>
                                <li>
                                ...
                                <li class=\"pt-2 mt-2 border-t border-slate-200 dark:border-zink-500\">
                                    <a class=\"block ltr:pr-4 rtl:pl-4 py-1.5 text-base font-medium transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:text-custom-500 focus:text-custom-500 dark:text-zink-200 dark:hover:text-custom-500 dark:focus:text-custom-500\" href=\"{{path('logout')}}\"><i data-lucide=\"log-out\" class=\"inline-block size-4 ltr:mr-2 rtl:ml-2\"></i> Sign Out</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <div>
        <div class=\"h-[calc(100vh_-_370px)] p-4 overflow-y-auto product-list\">
            <div class=\"flex flex-col gap-4\">
                <div class=\"flex gap-2 product\">
                    <div class=\"flex items-center justify-center size-12 rounded-md bg-slate-100 shrink-0 dark:bg-zink-500\">
                        <img src=\"{{asset('assets/images/product/img-01.png')}}\" alt=\"\" class=\"h-8\">
                    </div>
                    <div class=\"overflow-hidden grow\">
                        <div class=\"ltr:float-right rtl:float-left\">
                            <button class=\"transition-all duration-150 ease-linear text-slate-500 dark:text-zink-200 hover:text-red-500 dark:hover:text-red-500\"><i data-lucide=\"x\" class=\"size-4\"></i></button>
                ...
                <div class=\"flex gap-2 product\">
                    <div class=\"flex items-center justify-center size-12 rounded-md bg-slate-100 shrink-0 dark:bg-zink-500\">
                        <img src=\"{{asset('assets/images/product/img-03.png')}}\" alt=\"\" class=\"h-8\">
                    </div>
                    <div class=\"overflow-hidden grow\">
                        <div class=\"ltr:float-right rtl:float-left\">
                            <button class=\"transition-all duration-150 ease-linear text-slate-500 dark:text-zink-200 hover:text-red-500 dark:hover:text-red-500\"><i data-lucide=\"x\" class=\"size-4\"></i></button>
                ...
                <div class=\"flex gap-2 product\">
                    <div class=\"flex items-center justify-center size-12 rounded-md bg-slate-100 shrink-0 dark:bg-zink-500\">
                        <img src=\"{{asset('assets/images/product/img-09.png')}}\" alt=\"\" class=\"h-8\">
                    </div>
                    <div class=\"overflow-hidden grow\">
                        <div class=\"ltr:float-right rtl:float-left\">
                            <button class=\"transition-all duration-150 ease-linear text-slate-500 dark:text-zink-200 hover:text-red-500 dark:hover:text-red-500\"><i data-lucide=\"x\" class=\"size-4\"></i></button>
...
</div>", "partials/_topbar.html.twig", "C:\\xampp\\htdocs\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\partials\\_topbar.html.twig");
    }
}
