...
class __TwigTemplate_4ff8b37da1822934c38d7bf86400f340 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        // line 21
        yield "                        ";
        $context["workerId"] = CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 21), "get", ["id"], "method", false, false, false, 21);
        // line 22
        yield "                        <div id=\"workerIdParams\" class=\"hidden\" data-worker-id=\"";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["workerId"] ?? null), "html", null, true);
        yield "\"></div>
                                    ...
                                    <div class=\"flex flex-row gap-5\">
                                        <div class=\"\">
                                            <div class=\"mb-1 size-20 rounded-md\">
                                                <img src=\"";
        // line 29
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((CoreExtension::getAttribute($this->env, $this->source, ($context["employee"] ?? null), "profile_photo_path", [], "any", false, false, false, 29)) ? ($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(CoreExtension::getAttribute($this->env, $this->source, ($context["employee"] ?? null), "profile_photo_path", [], "any", false, false, false, 29))) : ($this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("assets/images/users/user-dummy-img.jpg"))), "html", null, true);
        yield "\" alt=\"\" class=\"h-20 w-40 rounded-md\">
                                            </div>
                                            <h5 id=\"employeeId\" class=\"border-transparent text-16 font-semibold\">";
        // line 31
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["employee"] ?? null), "employee_code", [], "any", false, false, false, 31), "html", null, true);
        yield "</h5>
                                        </div>
                                        <div class=\"\">
                                            <h6 class=\"text-16\"><a href=\"#!\" id=\"emp_name\">";
        // line 34
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["employee"] ?? null), "last_name", [], "any", false, false, false, 34), "html", null, true);
        yield ", ";
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["employee"] ?? null), "first_name", [], "any", false, false, false, 34), "html", null, true);
        yield "</a></h6>
                                            <p class=\"text-slate-500 dark:text-zink-200\" id=\"emp_position\">";
        // line 35
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["employee"] ?? null), "position", [], "any", false, false, false, 35), "html", null, true);
        yield "</p>
                                            <div class=\"mt-1\">
                                                <p class=\"text-slate-500 dark:text-zink-200\" id=\"emp_cellphone\">";
        // line 37
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["employee"] ?? null), "cellphone", [], "any", false, false, false, 37), "html", null, true);
        yield "</p>
                                                <p class=\"text-slate-500 dark:text-zink-200\" id=\"emp_email\">";
        // line 38
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["employee"] ?? null), "email", [], "any", false, false, false, 38), "html", null, true);
        yield "</p>
                                            </div>
                                        </div>
                                    </div>
        ...
        // line 393
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["employee"] ?? null), "id", [], "any", false, false, false, 393), "html", null, true);
        yield ">
                                <input type=\"hidden\" name=\"emp_code\" value=";
        // line 394
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, ($context["employee"] ?? null), "employee_code", [], "any", false, false, false, 394), "html", null, true);
        yield ">
...
";
    ...
    {
        return array (  2087 => 1987,  536 => 437,  531 => 434,  526 => 432,  522 => 431,  518 => 430,  515 => 429,  508 => 428,  476 => 402,  465 => 400,  461 => 399,  454 => 395,  450 => 394,  446 => 393,  441 => 391,  428 => 380,  413 => 350,  410 => 348,  363 => 302,  360 => 284,  337 => 256,  326 => 254,  322 => 253,  147 => 80,  140 => 38,  136 => 37,  131 => 35,  125 => 34,  119 => 31,  114 => 29,  103 => 22,  100 => 21,  93 => 8,  90 => 7,  83 => 6,  70 => 3,  56 => 2,  39 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "manpower/apps-manpower.html.twig", "C:\\xampp\\htdocs\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\manpower\\apps-manpower.html.twig");
    }
}
