...
/* apps-social-marketplace.html.twig */
class __TwigTemplate_c575ffabecaf7e5951a160b179e4a0a6 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps-social-marketplace.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps-social-marketplace.html.twig"));

        $this->parent = $this->loadTemplate("partials/base.html.twig", "apps-social-marketplace.html.twig", 1);
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        yield "
            ";
        // line 6
        yield $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("breadcrumb", ["pagetitle" => "Social Media", "title" => "Marketplace"]);
        yield "
                        ...
                        <div class=\"grid grid-cols-1 gap-5 md:grid-cols-12\">
                            ...
                            <div class=\"relative mb-0 overflow-hidden card md:col-span-6 lg:col-span-4 xl:col-span-3 group/item\">
                                <div class=\"!p-10 card-body\">
                                    <img src=\"assets/images/product/img-05.png\" alt=\"\" class=\"h-40 mx-auto\">
                            ...
                            <div class=\"relative mb-0 overflow-hidden card md:col-span-6 lg:col-span-4 xl:col-span-3 group/item\">
                                <div class=\"!p-10 card-body\">
                                    <img src=\"assets/images/product/img-02.png\" alt=\"\" class=\"h-40 mx-auto\">
                                    <div class=\"absolute flex gap-2 transition-all duration-200 ease-linear -translate-x-1/2 translate-y-1/2 opacity-0 bottom-1/3 group-hover/item:opacity-100 group-hover/item:bottom-1/2 left-1/2\">
                                        <button type=\"button\" class=\"flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 rounded-full text-red-500 btn bg-white border-white shadow-md hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 active:text-white active:bg-red-600 active:border-red-600 dark:bg-zink-600 dark:border-zink-500 dark:hover:bg-red-600\"><i data-lucide=\"shopping-cart\" class=\"h-4\"></i></button>
                            ...
                            <div class=\"relative mb-0 overflow-hidden card md:col-span-6 lg:col-span-4 xl:col-span-3 group/item\">
                                <div class=\"!p-10 card-body\">
                                    <img src=\"assets/images/product/img-03.png\" alt=\"\" class=\"h-40 mx-auto\">
                                    <div class=\"absolute flex gap-2 transition-all duration-200 ease-linear -translate-x-1/2 translate-y-1/2 opacity-0 bottom-1/3 group-hover/item:opacity-100 group-hover/item:bottom-1/2 left-1/2\">
                                        <button type=\"button\" class=\"flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 rounded-full text-red-500 btn bg-white border-white shadow-md hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 active:text-white active:bg-red-600 active:border-red-600 dark:bg-zink-600 dark:border-zink-500 dark:hover:bg-red-600\"><i data-lucide=\"shopping-cart\" class=\"h-4\"></i></button>
                                        <button type=\"button\" class=\"flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 rounded-full text-sky-500 btn bg-white border-white shadow-md hover:text-white hover:bg-sky-600 hover:border-sky-600 focus:text-white focus:bg-sky-600 focus:border-sky-600 active:text-white active:bg-sky-600 active:border-sky-600 dark:bg-sky-600 dark:border-zink-500 dark:hover:bg-sky-600\"><i data-lucide=\"bookmark\" class=\"h-4\"></i></button>
                                    </div>
                            ...
                            <div class=\"relative mb-0 overflow-hidden card md:col-span-6 lg:col-span-4 xl:col-span-3 group/item\">
                                <div class=\"!p-10 card-body\">
                                    <img src=\"assets/images/product/img-04.png\" alt=\"\" class=\"h-40 mx-auto\">
                                    <div class=\"absolute flex gap-2 transition-all duration-200 ease-linear -translate-x-1/2 translate-y-1/2 opacity-0 bottom-1/3 group-hover/item:opacity-100 group-hover/item:bottom-1/2 left-1/2\">
                                        <button type=\"button\" class=\"flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 rounded-full text-red-500 btn bg-white border-white shadow-md hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 active:text-white active:bg-red-600 active:border-red-600 dark:bg-zink-600 dark:border-zink-500 dark:hover:bg-red-600\"><i data-lucide=\"shopping-cart\" class=\"h-4\"></i></button>
                                        <button type=\"button\" class=\"flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 rounded-full text-sky-500 btn bg-white border-white shadow-md hover:text-white hover:bg-sky-600 hover:border-sky-600 focus:text-white focus:bg-sky-600 focus:border-sky-600 active:text-white active:bg-sky-600 active:border-sky-600 dark:bg-sky-600 dark:border-zink-500 dark:hover:bg-sky-600\"><i data-lucide=\"bookmark\" class=\"h-4\"></i></button>
                                    </div>
                            ...
                            <div class=\"relative mb-0 overflow-hidden card md:col-span-6 lg:col-span-4 xl:col-span-3 group/item\">
                                <div class=\"!p-10 card-body\">
                                    <img src=\"assets/images/product/img-01.png\" alt=\"\" class=\"h-40 mx-auto\">
                                    <div class=\"absolute flex gap-2 transition-all duration-200 ease-linear -translate-x-1/2 translate-y-1/2 opacity-0 bottom-1/3 group-hover/item:opacity-100 group-hover/item:bottom-1/2 left-1/2\">
                                        <button type=\"button\" class=\"flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 rounded-full text-red-500 btn bg-white border-white shadow-md hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 active:text-white active:bg-red-600 active:border-red-600 dark:bg-zink-600 dark:border-zink-500 dark:hover:bg-red-600\"><i data-lucide=\"shopping-cart\" class=\"h-4\"></i></button>
                                        <button type=\"button\" class=\"flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 rounded-full text-sky-500 btn bg-white border-white shadow-md hover:text-white hover:bg-sky-600 hover:border-sky-600 focus:text-white focus:bg-sky-600 focus:border-sky-600 active:text-white active:bg-sky-600 active:border-sky-600 dark:bg-sky-600 dark:border-zink-500 dark:hover:bg-sky-600\"><i data-lucide=\"bookmark\" class=\"h-4\"></i></button>
                                    </div>
                            ...
                            <div class=\"relative mb-0 overflow-hidden card md:col-span-6 lg:col-span-4 xl:col-span-3 group/item\">
                                <div class=\"!p-10 card-body\">
                                    <img src=\"assets/images/product/img-06.png\" alt=\"\" class=\"h-40 mx-auto\">
                                    <div class=\"absolute flex gap-2 transition-all duration-200 ease-linear -translate-x-1/2 translate-y-1/2 opacity-0 bottom-1/3 group-hover/item:opacity-100 group-hover/item:bottom-1/2 left-1/2\">
                                        <button type=\"button\" class=\"flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 rounded-full text-red-500 btn bg-white border-white shadow-md hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 active:text-white active:bg-red-600 active:border-red-600 dark:bg-zink-600 dark:border-zink-500 dark:hover:bg-red-600\"><i data-lucide=\"shopping-cart\" class=\"h-4\"></i></button>
                                        <button type=\"button\" class=\"flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 rounded-full text-sky-500 btn bg-white border-white shadow-md hover:text-white hover:bg-sky-600 hover:border-sky-600 focus:text-white focus:bg-sky-600 focus:border-sky-600 active:text-white active:bg-sky-600 active:border-sky-600 dark:bg-sky-600 dark:border-zink-500 dark:hover:bg-sky-600\"><i data-lucide=\"bookmark\" class=\"h-4\"></i></button>
                                    </div>
                            ...
                            <div class=\"relative mb-0 overflow-hidden card md:col-span-6 lg:col-span-4 xl:col-span-3 group/item\">
                                <div class=\"!p-10 card-body\">
                                    <img src=\"assets/images/product/img-07.png\" alt=\"\" class=\"h-40 mx-auto\">
                                    <div class=\"absolute flex gap-2 transition-all duration-200 ease-linear -translate-x-1/2 translate-y-1/2 opacity-0 bottom-1/3 group-hover/item:opacity-100 group-hover/item:bottom-1/2 left-1/2\">
                                        <button type=\"button\" class=\"flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 rounded-full text-red-500 btn bg-white border-white shadow-md hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 active:text-white active:bg-red-600 active:border-red-600 dark:bg-zink-600 dark:border-zink-500 dark:hover:bg-red-600\"><i data-lucide=\"shopping-cart\" class=\"h-4\"></i></button>
                                        <button type=\"button\" class=\"flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 rounded-full text-sky-500 btn bg-white border-white shadow-md hover:text-white hover:bg-sky-600 hover:border-sky-600 focus:text-white focus:bg-sky-600 focus:border-sky-600 active:text-white active:bg-sky-600 active:border-sky-600 dark:bg-sky-600 dark:border-zink-500 dark:hover:bg-sky-600\"><i data-lucide=\"bookmark\" class=\"h-4\"></i></button>
                                    </div>
                            ...
                            <div class=\"relative mb-0 overflow-hidden card md:col-span-6 lg:col-span-4 xl:col-span-3 group/item\">
                                <div class=\"!p-10 card-body\">
                                    <img src=\"assets/images/product/img-08.png\" alt=\"\" class=\"h-40 mx-auto\">
                                    <div class=\"absolute flex gap-2 transition-all duration-200 ease-linear -translate-x-1/2 translate-y-1/2 opacity-0 bottom-1/3 group-hover/item:opacity-100 group-hover/item:bottom-1/2 left-1/2\">
                                        <button type=\"button\" class=\"flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 rounded-full text-red-500 btn bg-white border-white shadow-md hover:text-white hover:bg-red-600 hover:border-red-600 focus:text-white focus:bg-red-600 focus:border-red-600 active:text-white active:bg-red-600 active:border-red-600 dark:bg-zink-600 dark:border-zink-500 dark:hover:bg-red-600\"><i data-lucide=\"shopping-cart\" class=\"h-4\"></i></button>
                                        <button type=\"button\" class=\"flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 rounded-full text-sky-500 btn bg-white border-white shadow-md hover:text-white hover:bg-sky-600 hover:border-sky-600 focus:text-white focus:bg-sky-600 focus:border-sky-600 active:text-white active:bg-sky-600 active:border-sky-600 dark:bg-sky-600 dark:border-zink-500 dark:hover:bg-sky-600\"><i data-lucide=\"bookmark\" class=\"h-4\"></i></button>
                                    </div>
...
";
    ...
    {
        return "apps-social-marketplace.html.twig";
    }
    ...
    {
        return array (  379 => 268,  375 => 266,  371 => 264,  361 => 263,  94 => 6,  91 => 5,  81 => 4,  61 => 2,  38 => 1,);
    }
...
{% block content %}
            ...
            {{ component('breadcrumb', { pagetitle: 'Social Media', title: 'Marketplace' }) }}
...
{% endblock %}", "apps-social-marketplace.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\apps-social-marketplace.html.twig");
    }
}
