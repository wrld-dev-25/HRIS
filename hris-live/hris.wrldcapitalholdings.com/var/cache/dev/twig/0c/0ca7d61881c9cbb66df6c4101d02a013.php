...
/* apps-hr-leave.html.twig */
class __TwigTemplate_70c490d0b81ed8189769ae717d3a7586 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps-hr-leave.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps-hr-leave.html.twig"));

        $this->parent = $this->loadTemplate("partials/base.html.twig", "apps-hr-leave.html.twig", 1);
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        yield "
            ";
        // line 6
        yield $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("breadcrumb", ["pagetitle" => "Leaves Manage", "title" => "Leave Manage (HR)"]);
        yield "
                ...
                <div class=\"grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-12\">
                    <div class=\"xl:col-span-3\">
                        <div class=\"card\">
                            <div class=\"flex items-center gap-3 card-body\">
                                <div class=\"flex items-center justify-center size-12 rounded-md text-15 bg-custom-100 text-custom-500 dark:bg-custom-500/20 shrink-0\"><i data-lucide=\"file-bar-chart-2\"></i></div>
                                <div class=\"grow\">
                    ...
                    <div class=\"xl:col-span-3\">
                        <div class=\"card\">
                            <div class=\"flex items-center gap-3 card-body\">
                                <div class=\"flex items-center justify-center size-12 text-green-500 bg-green-100 rounded-md text-15 dark:bg-green-500/20 shrink-0\"><i data-lucide=\"calendar-check\"></i></div>
                                <div class=\"grow\">
                    ...
                    <div class=\"xl:col-span-3\">
                        <div class=\"card\">
                            <div class=\"flex items-center gap-3 card-body\">
                                <div class=\"flex items-center justify-center size-12 text-purple-500 bg-purple-100 rounded-md text-15 dark:bg-purple-500/20 shrink-0\"><i data-lucide=\"codepen\"></i></div>
                                <div class=\"grow\">
                    ...
                    <div class=\"xl:col-span-3\">
                        <div class=\"card\">
                            <div class=\"flex items-center gap-3 card-body\">
                                <div class=\"flex items-center justify-center size-12 text-yellow-500 bg-yellow-100 rounded-md text-15 dark:bg-yellow-500/20 shrink-0\"><i data-lucide=\"loader\"></i></div>
                                <div class=\"grow\">
                                    ...
                                    <tr>
                                        ...
                                        <td class=\"px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500\">
                                            <div class=\"flex gap-2\">
                                                <a href=\"#!\" class=\"flex items-center justify-center size-8 transition-all duration-200 ease-linear rounded-md text-slate-500 bg-slate-100 hover:text-white hover:bg-slate-500 dark:bg-zink-600 dark:text-zink-200 dark:hover:text-white dark:hover:bg-zink-500\"><i data-lucide=\"pencil\" class=\"size-4\"></i></a>
                                                ...
                                                <a href=\"#!\" data-modal-target=\"deleteModal\" class=\"flex items-center justify-center size-8 text-red-500 transition-all duration-200 ease-linear bg-red-100 rounded-md hover:text-white hover:bg-red-500 dark:bg-red-500/20 dark:hover:bg-red-500\"><i data-lucide=\"trash-2\" class=\"size-4\"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
...
";
    ...
    {
        return "apps-hr-leave.html.twig";
    }
...
{% block title %}Leave Manage (HR){% endblock %}

{% block content %}

            {{ component('breadcrumb', { pagetitle: 'Leaves Manage', title: 'Leave Manage (HR)' }) }}
...
{% endblock %}", "apps-hr-leave.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\apps-hr-leave.html.twig");
    }
}
