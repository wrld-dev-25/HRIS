...
class __TwigTemplate_50934e0f0cda8fb6407624697148125a extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("partials/base.html.twig", "apps-ecommerce-checkout.html.twig", 1);
...
";
        // line 6
        yield $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("breadcrumb", ["pagetitle" => "Ecommerce", "title" => "Checkout"]);
        yield " ?>
                ...
                <div class=\"grid grid-cols-1 xl:grid-cols-12 gap-x-5\">
                    ...
                    <div class=\"xl:col-span-8\">
                        <div class=\"flex items-center gap-3 mb-5\">
                            <div class=\"grow\">
                                <a href=\"#!\" class=\"transition-all duration-300 ease-linear text-custom-500 hover:text-custom-600\"><i data-lucide=\"chevron-left\" class=\"inline-block size-4 align-middle ltr:mr-1 rtl:ml-1 rtl:rotate-180\"></i> <span class=\"align-middle\">Back to Cart</span></a>
                            </div>
                            <div class=\"shrink-0\">
                                <button type=\"button\" class=\"text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20\"><span class=\"align-middle\">Place Order</span> <i data-lucide=\"move-right\" class=\"inline-block size-4 align-middle ltr:ml-1 rtl:mr-1 rtl:rotate-180\"></i></button>
                            </div>
                        </div>
                        <div class=\"card\">
                            <div class=\"card-body\">
                        ...
                        <div class=\"card\">
                            <div class=\"card-body\">
                                ...
                                <div class=\"grid grid-cols-1 gap-5 xl:grid-cols-2\">
                                    ...
                                    <div class=\"flex items-center gap-3\">
                                        <input id=\"deliveryOption3\" class=\"size-4 border rounded-full appearance-none cursor-pointer bg-slate-100 border-slate-200 dark:bg-zink-600 dark:border-zink-500 checked:bg-purple-500 checked:border-purple-500 dark:checked:bg-purple-500 dark:checked:border-purple-500 checked:disabled:bg-purple-400 checked:disabled:border-purple-400 peer\" type=\"radio\" name=\"deliveryChoose\" value=\"express-delivery\">
                    ...
                    <div class=\"xl:col-span-4\">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class=\"px-3.5 py-4 border-b border-dashed first:pl-0 last:pr-0 border-slate-200 dark:border-zink-500\">
                                                    <div class=\"flex items-center gap-3\">
                                                        <div class=\"flex items-center justify-center size-12 rounded-md bg-slate-100 shrink-0\">
                                                            <img src=\"assets/images/product/img-08.png\" alt=\"\" class=\"h-8\">
                                                        </div>
                                                        <div class=\"grow\">
                                                            <h6 class=\"mb-1 text-15\"><a href=\"apps-ecommerce-product-overview\" class=\"transition-all duration-300 ease-linear hover:text-custom-500\">Roar Twill Blue Baseball Cap</a></h6>
                                            ...
                                            <tr>
                                                <td class=\"px-3.5 py-4 border-b border-dashed first:pl-0 last:pr-0 border-slate-200 dark:border-zink-500\">
                                                    <div class=\"flex items-center gap-3\">
                                                        ...
                                                        <div class=\"grow\">
                                                            <h6 class=\"mb-1 text-15\"><a href=\"apps-ecommerce-product-overview\" class=\"transition-all duration-300 ease-linear hover:text-custom-500\">Mesh Ergonomic Green Chair</a></h6>
                                            ...
                                            <tr>
                                                <td class=\"px-3.5 py-4 border-b border-dashed first:pl-0 last:pr-0 border-slate-200 dark:border-zink-500\">
                                                    <div class=\"flex items-center gap-3\">
                                                        ...
                                                        <div class=\"grow\">
                                                            <h6 class=\"mb-1 text-15\"><a href=\"apps-ecommerce-product-overview\" class=\"transition-all duration-300 ease-linear hover:text-custom-500\">Smartest Printed T-shirt</a></h6>
                            ...
                            <div class=\"flex flex-col gap-3 md:items-center card-body md:flex-row\">
                                ...
                                <div class=\"shrink-0\">
                                    <div class=\"relative inline-block w-10 align-middle transition duration-200 ease-in\">
                                        <input type=\"checkbox\" name=\"carePackage\" id=\"carePackage\" class=\"absolute block size-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-600 bg-white/80 dark:bg-zink-400 peer/published checked:bg-custom-500 dark:checked:bg-custom-500 ltr:checked:right-0 rtl:checked:left-0 checked:border-custom-100 dark:checked:border-custom-900 arrow-none checked:bg-none\">
                        ...
                        <div class=\"card\">
                            <div class=\"flex flex-col gap-3 md:items-center card-body md:flex-row\">
                                ...
                                <div class=\"shrink-0\">
                                    <div class=\"relative inline-block w-10 align-middle transition duration-200 ease-in\">
                                        <input type=\"checkbox\" name=\"friendlyCheckbox\" id=\"friendlyCheckbox\" class=\"absolute block size-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-600 bg-white/80 dark:bg-zink-400 peer/published checked:bg-custom-500 dark:checked:bg-custom-500 ltr:checked:right-0 rtl:checked:left-0 checked:border-custom-100 dark:checked:border-custom-900 arrow-none checked:bg-none\">
...
";
    ...
    {
        return array (  654 => 543,  650 => 541,  646 => 539,  636 => 538,  94 => 6,  91 => 5,  81 => 4,  61 => 2,  38 => 1,);
    }
...
{{ component('breadcrumb', { pagetitle: 'Ecommerce', title: 'Checkout' }) }} ?>
...
{% endblock %}", "apps-ecommerce-checkout.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\apps-ecommerce-checkout.html.twig");
    }
}
