...
class __TwigTemplate_3de7d600dcfe6ccd4f103ed974d2320c extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "administration/overtime_request.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "administration/overtime_request.html.twig"));
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        yield "
            ";
        // line 6
        yield $this->env->getRuntime('Symfony\UX\TwigComponent\Twig\ComponentRuntime')->render("breadcrumb", ["pagetitle" => "Overtime Request", "title" => ""]);
        yield "
        ...
        // line 60
        yield "                                            ";
        if ((($tmp = (isset($context["overtimeRequest"]) || array_key_exists("overtimeRequest", $context) ? $context["overtimeRequest"] : (function () { throw new RuntimeError('Variable "overtimeRequest" does not exist.', 60, $this->source); })())) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
            // line 61
            yield "                                                ";
            $context['_parent'] = $context;
            $context['_seq'] = CoreExtension::ensureTraversable((isset($context["overtimeRequest"]) || array_key_exists("overtimeRequest", $context) ? $context["overtimeRequest"] : (function () { throw new RuntimeError('Variable "overtimeRequest" does not exist.', 61, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["ot_request"]) {
                ...
                // line 68
                yield "                                                            ";
                $context["hours"] = $this->extensions['Twig\Extension\CoreExtension']->formatNumber(((CoreExtension::getAttribute($this->env, $this->source, ($context["timeParts"] ?? null), 0, [], "array", true, true, false, 68)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, (isset($context["timeParts"]) || array_key_exists("timeParts", $context) ? $context["timeParts"] : (function () { throw new RuntimeError('Variable "timeParts" does not exist.', 68, $this->source); })()), 0, [], "array", false, false, false, 68), 0)) : (0)), 0, ".", "");
                // line 69
                yield "                                                            ";
                $context["minutes"] = $this->extensions['Twig\Extension\CoreExtension']->formatNumber(((CoreExtension::getAttribute($this->env, $this->source, ($context["timeParts"] ?? null), 1, [], "array", true, true, false, 69)) ? (Twig\Extension\CoreExtension::default(CoreExtension::getAttribute($this->env, $this->source, (isset($context["timeParts"]) || array_key_exists("timeParts", $context) ? $context["timeParts"] : (function () { throw new RuntimeError('Variable "timeParts" does not exist.', 69, $this->source); })()), 1, [], "array", false, false, false, 69), 0)) : (0)), 0, ".", "");
                // line 70
                yield "                                                            ";
                yield ((((isset($context["hours"]) || array_key_exists("hours", $context) ? $context["hours"] : (function () { throw new RuntimeError('Variable "hours" does not exist.', 70, $this->source); })()) > 0)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((isset($context["hours"]) || array_key_exists("hours", $context) ? $context["hours"] : (function () { throw new RuntimeError('Variable "hours" does not exist.', 70, $this->source); })()) . " hour/s"), "html", null, true)) : (""));
                yield (((((isset($context["hours"]) || array_key_exists("hours", $context) ? $context["hours"] : (function () { throw new RuntimeError('Variable "hours" does not exist.', 70, $this->source); })()) > 0) && ((isset($context["minutes"]) || array_key_exists("minutes", $context) ? $context["minutes"] : (function () { throw new RuntimeError('Variable "minutes" does not exist.', 70, $this->source); })()) > 0))) ? (" and ") : (""));
                yield ((((isset($context["minutes"]) || array_key_exists("minutes", $context) ? $context["minutes"] : (function () { throw new RuntimeError('Variable "minutes" does not exist.', 70, $this->source); })()) > 0)) ? ($this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(((isset($context["minutes"]) || array_key_exists("minutes", $context) ? $context["minutes"] : (function () { throw new RuntimeError('Variable "minutes" does not exist.', 70, $this->source); })()) . " min/s"), "html", null, true)) : (""));
                yield "
                                                        </td>
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 status\">";
                // line 72
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["holiday_status"]) || array_key_exists("holiday_status", $context) ? $context["holiday_status"] : (function () { throw new RuntimeError('Variable "holiday_status" does not exist.', 72, $this->source); })()), CoreExtension::getAttribute($this->env, $this->source, $context["ot_request"], "status", [], "any", false, false, false, 72), [], "array", false, false, false, 72), "html", null, true);
                yield "</td> 
            ...
            unset($context['_seq'], $context['_key'], $context['ot_request'], $context['_parent']);
...
";
        // line 226
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["overtimeRequest"]) || array_key_exists("overtimeRequest", $context) ? $context["overtimeRequest"] : (function () { throw new RuntimeError('Variable "overtimeRequest" does not exist.', 226, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["ot_request"]) {
            // line 227
...
";
    ...
    {
        return array (  445 => 318,  441 => 316,  435 => 313,  431 => 312,  427 => 311,  424 => 310,  411 => 309,  399 => 306,  390 => 304,  386 => 303,  382 => 301,  369 => 294,  361 => 289,  354 => 285,  345 => 279,  339 => 276,  333 => 273,  326 => 269,  316 => 262,  309 => 258,  305 => 257,  297 => 252,  290 => 248,  280 => 241,  273 => 237,  269 => 236,  261 => 231,  253 => 227,  249 => 226,  246 => 225,  243 => 181,  232 => 103,  224 => 96,  221 => 95,  211 => 90,  206 => 85,  200 => 82,  194 => 79,  185 => 73,  181 => 72,  173 => 70,  170 => 69,  167 => 68,  164 => 67,  159 => 64,  155 => 63,  152 => 62,  147 => 61,  144 => 60,  142 => 59,  140 => 54,  121 => 37,  112 => 19,  104 => 6,  101 => 5,  88 => 4,  65 => 2,  42 => 1,);
    }
                                            ...
                                            {% if overtimeRequest %}
                                                {% for ot_request in overtimeRequest %}
                                                    <tr class=\"relative rounded-md after:absolute ltr:after:border-l-2 rtl:after:border-r-2 ltr:after:left-0 rtl:after:right-0 after:top-0 after:bottom-0 after:border-transparent [&.active]:after:border-custom-500 [&.active]:bg-slate-100 dark:[&.active]:bg-zink-600\">
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 worker_logs_date\">{{ ot_request.worker_logs_date|date('Y-m-d') }}</td>
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 reason\">{{ ot_request.reason }}</td>
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 hours_requested\">
                                                            {# this code is for conversion of 2:30 time to 2 hours and 30 mins time #}
                                                            {% set timeParts = ot_request.hours_requested|split(':') %}
                                                        ...
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 status\">{{ holiday_status[ot_request.status] }}</td> 
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 employer_share\">{{ ot_request.approved_by }}</td>
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5\">
                                                            <div class=\"action-model_types relative dropdown\">
                                                                <button class=\"flex items-center justify-center size-[30px] dropdown-toggle p-0 text-slate-500 btn bg-slate-100 hover:text-white hover:bg-slate-600 focus:text-white focus:bg-slate-600 focus:ring focus:ring-slate-100 active:text-white active:bg-slate-600 active:ring active:ring-slate-100 dark:bg-slate-500/20 dark:text-slate-400 dark:hover:bg-slate-500 dark:hover:text-white dark:focus:bg-slate-500 dark:focus:text-white dark:active:bg-slate-500 dark:active:text-white dark:ring-slate-400/20\" id=\"usersAction1\" data-bs-toggle=\"dropdown\"><i data-lucide=\"more-horizontal\" class=\"size-3\"></i></button>
                                                                <ul class=\"absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600\" aria-labelledby=\"usersAction1\">
                                                                    <li>
                                                                        <a data-modal-target=\"editOvertimeRequest{{ot_request.id}}\" class=\"edit-model_types block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200\" href=\"#!\"><i data-lucide=\"file-edit\" class=\"inline-block size-3 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">Edit</span></a>
                                                                    </li>
                                                                    <li>
                                                                        <a data-modal-target=\"approveOvertimeRequest{{ot_request.id}}\" class=\"edit-model_types block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200\" href=\"#!\"><i data-lucide=\"file-edit\" class=\"inline-block size-3 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">Approve</span></a>
                                                                    </li>
                                                                    <li>
                                                                        <a data-modal-target=\"rejectOvertimeRequest{{ot_request.id}}\" class=\"edit-model_types block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200\" href=\"#!\"><i data-lucide=\"file-edit\" class=\"inline-block size-3 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">Reject</span></a>
                                                                    </li>
                                                                    {# <li>
                                                                        <a data-modal-target=\"deletepagibigConfig{{ot_request.id}}\" class=\"delete-model_types block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200\" href=\"#!\"><i data-lucide=\"trash-2\" class=\"inline-block size-3 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">Delete</span></a>
                                                                    </li> #}
                                                                </ul>
                                                            </div>
                                                        </td>
...
{# <div id=\"addLeaveRequest\" modal-center class=\"fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show \">
    <div class=\"w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600\">
        <div class=\"flex items-center justify-between p-4 border-b dark:border-zink-300/20\">
            <h5 class=\"text-16\">Add Overtime Request</h5>
        ...
        <div class=\"max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto\">
            ...
            <div class=\"grid grid-cols-1 gap-4 xl:grid-cols-12\">
                ...
                <div class=\"xl:col-span-12\">
                    ...
                    <span class=\"text-red-500\">*</span>
                    <input type=\"number\" id=\"year\" name=\"year\" class=\"form-input\" placeholder=\"Enter Year\" required>
                </div>
...
{% for ot_request in overtimeRequest %}
<div id=\"approveOvertimeRequest{{ ot_request.id }}\" modal-center class=\"fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show \">
    <div class=\"w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600\">
        <div class=\"flex items-center justify-between p-4 border-b dark:border-zink-300/20\">
            <h5 class=\"text-16\">Update Overtime Request</h5>
            <button data-modal-close=\"approveOvertimeRequest{{ ot_request.id }}\" class=\"transition-all duration-200 ease-linear text-slate-400 hover:text-red-500\"><i data-lucide=\"x\" class=\"size-5\"></i></button>
        </div>
        <div class=\"max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto\">
            <h5 class=\"mb-3 text-16\">Approve Overtime?</h5>
            <p class=\"text-slate-500 dark:text-zink-200\">Are you sure you want to approve this overtime request?</p>
        ...
        <div class=\"flex items-center justify-end p-4 mt-auto border-t border-slate-200 dark:border-zink-500\">
            <button type=\"reset\" data-modal-close=\"approveOvertimeRequest{{ ot_request.id }}\" class=\"text-red-500 bg-white btn\">Cancel</button>
            <button type=\"submit\" class=\"text-white btn bg-custom-500\">Approve</button>
        </div>
    </form>
    </div>
...
<div id=\"rejectOvertimeRequest{{ ot_request.id }}\" modal-center class=\"fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show \">
    <div class=\"w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600\">
        <div class=\"flex items-center justify-between p-4 border-b dark:border-zink-300/20\">
            <h5 class=\"text-16\">Update Overtime Request</h5>
            <button data-modal-close=\"rejectOvertimeRequest{{ ot_request.id }}\" class=\"transition-all duration-200 ease-linear text-slate-400 hover:text-red-500\"><i data-lucide=\"x\" class=\"size-5\"></i></button>
        </div>
        <div class=\"max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto\">
            <h5 class=\"mb-3 text-16\">Reject Overtime?</h5>
            <p class=\"text-slate-500 dark:text-zink-200\">Are you sure you want to reject this overtime request?</p>
        ...
        <div class=\"flex items-center justify-end p-4 mt-auto border-t border-slate-200 dark:border-zink-500\">
            <button type=\"reset\" data-modal-close=\"rejectOvertimeRequest{{ ot_request.id }}\" class=\"text-red-500 bg-white btn\">Cancel</button>
            <button type=\"submit\" class=\"text-white btn bg-custom-500\">Reject</button>
        </div>
    </form>
    </div>
...
<div id=\"editOvertimeRequest{{ot_request.id}}\" modal-center class=\"fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show \">
    <div class=\"w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600\">
        <div class=\"flex items-center justify-between p-4 border-b dark:border-zink-300/20\">
            <h5 class=\"text-16\">Edit Overtime Request</h5>
            <button data-modal-close=\"editOvertimeRequest{{ot_request.id}}\" class=\"transition-all duration-200 ease-linear text-slate-400 hover:text-red-500\"><i data-lucide=\"x\" class=\"size-5\"></i></button>
        </div>
        <div class=\"max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto\">
            ...
            <div class=\"grid grid-cols-1 gap-4 xl:grid-cols-12\">
                ...
                <div class=\"xl:col-span-12\">
                    <label for=\"date_start\" class=\"inline-block mb-2 text-base font-medium\">Overtime hour/s</label>
                    <span class=\"text-red-500\">*</span>
                    <input type=\"text\" id=\"ot_hours\" name=\"ot_hours\" class=\"form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" data-provider=\"timepickr\" data-time-hrs=\"true\"  data-default-time=\"{{ot_request.hours_requested}}\" placeholder=\"Add Time\" value=\"\" required>
                </div>
                <div class=\"xl:col-span-12\">
                    <label for=\"reason\" class=\"inline-block mb-2 text-base font-medium\">Reason</label>
                    <textarea id=\"reason\" name=\"reason\" class=\"form-input\" placeholder=\"Enter Reason (optional)\">{{ ot_request.reason }}</textarea>
                </div>
            </div>
        </div>
        <div class=\"flex items-center justify-end p-4 mt-auto border-t border-slate-200 dark:border-zink-500\">
            <button type=\"reset\" data-modal-close=\"editOvertimeRequest{{ot_request.id}}\" class=\"text-red-500 bg-white btn\">Cancel</button>
            <button type=\"submit\" class=\"text-white btn bg-custom-500\">Save</button>
        </div>
    </form>
    </div>
...
{% endblock %}", "administration/overtime_request.html.twig", "C:\\xampp\\htdocs\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\administration\\overtime_request.html.twig");
    }
}
