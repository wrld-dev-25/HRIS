...
/* apps-ecommerce-product-overview.html.twig */
class __TwigTemplate_da793a0d37fbc64d94e6cb7152ce1882 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps-ecommerce-product-overview.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps-ecommerce-product-overview.html.twig"));

        $this->parent = $this->loadTemplate("partials/base.html.twig", "apps-ecommerce-product-overview.html.twig", 1);
...
";
        // line 6
        yield $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("breadcrumb", ["pagetitle" => "Ecommerce", "title" => "Overview"]);
        yield "
                            ...
                            <div class=\"card\">
                                <div class=\"card-body\">
                                    ...
                                    <div class=\"flex items-center gap-3 mt-3 justify-evenly\">
                                        <a href=\"#!\" class=\"transition-all duration-300 ease-linear hover:text-custom-500\"><i data-lucide=\"repeat\" class=\"inline-block size-3 align-middle ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">Compare</span></a>
                                        <a href=\"#!\" data-modal-target=\"askQuestionModal\" class=\"transition-all duration-300 ease-linear hover:text-custom-500\"><i data-lucide=\"help-circle\" class=\"inline-block size-3 align-middle ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">Ask a Question</span></a>
                                        <a href=\"#!\" data-modal-target=\"shareModal\" class=\"transition-all duration-300 ease-linear hover:text-custom-500\"><i data-lucide=\"share-2\" class=\"inline-block size-3 align-middle ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">Share</span></a>
                                    </div>
                                </div>
                            </div><!--end card-->
                            <div class=\"card\">
                                <div class=\"border-b card-body border-slate-200 dark:border-zink-500\">
                                    <div class=\"flex\">
                                        <h6 class=\"grow text-15\"><i data-lucide=\"store\" class=\"inline-block size-4 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">Themesdesign</span></h6>
                                        <div class=\"shrink-0\">
                                            <i data-lucide=\"star\" class=\"inline-block size-4 text-yellow-500 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">(4.8)</span>
                                        </div>
                                    </div>
                                </div>
                                <div class=\"card-body\">
                                    <div class=\"flex\">
                                        <h6 class=\"grow text-15\"><i data-lucide=\"map-pin\" class=\"inline-block size-4 text-orange-500 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">California, USA</span></h6>
                                        <div class=\"shrink-0\">
                        ...
                        <div class=\"card\">
                            <div class=\"card-body\">
                                ...
                                <div class=\"flex flex-wrap items-center gap-2\">
                                    <input id=\"color1\" class=\"size-5 border rounded-sm appearance-none cursor-pointer border-custom-500 bg-custom-500 checked:bg-custom-500 checked:border-custom-500 disabled:opacity-75 disabled:cursor-default\" type=\"radio\" name=\"SelectColor\" value=\"\" disabled>
                                    <input id=\"color2\" class=\"size-5 bg-red-300 border border-red-300 rounded-sm appearance-none cursor-pointer checked:bg-red-300 checked:border-red-300 disabled:opacity-75 disabled:cursor-default\" type=\"radio\" name=\"SelectColor\" value=\"\">
                                    <input id=\"color3\" class=\"size-5 bg-green-300 border border-green-300 rounded-sm appearance-none cursor-pointer checked:bg-green-300 checked:border-green-300 disabled:opacity-75 disabled:cursor-default\" type=\"radio\" name=\"SelectColor\" value=\"\">
                                    <input id=\"color4\" class=\"size-5 border rounded-sm appearance-none cursor-pointer border-slate-500 bg-slate-500 checked:bg-slate-500 checked:border-slate-500 disabled:opacity-75 disabled:cursor-default\" type=\"radio\" name=\"SelectColor\" value=\"\">
                                    <input id=\"color5\" class=\"size-5 bg-purple-500 border border-purple-500 rounded-sm appearance-none cursor-pointer checked:bg-purple-500 checked:border-purple-500 disabled:opacity-75 disabled:cursor-default\" type=\"radio\" name=\"SelectColor\" value=\"\">
                                    <input id=\"color6\" class=\"size-5 border rounded-sm appearance-none cursor-pointer bg-sky-500 border-sky-500 checked:bg-sky-500 checked:border-sky-500 disabled:opacity-75 disabled:cursor-default\" type=\"radio\" name=\"SelectColor\" value=\"\">
                                    <input id=\"color7\" class=\"size-5 bg-yellow-500 border border-yellow-500 rounded-sm appearance-none cursor-pointer checked:bg-yellow-500 checked:border-yellow-500 disabled:opacity-75 disabled:cursor-default\" type=\"radio\" name=\"SelectColor\" value=\"\">
                                    <input id=\"color7\" class=\"size-5 bg-green-500 border border-green-500 rounded-sm appearance-none cursor-pointer checked:bg-green-500 checked:border-green-500 disabled:opacity-75 disabled:cursor-default\" type=\"radio\" name=\"SelectColor\" value=\"\">
                                    <input id=\"color8\" class=\"size-5 border rounded-sm appearance-none cursor-pointer bg-slate-800 border-slate-800 checked:bg-slate-800 checked:border-slate-800 disabled:opacity-75 disabled:cursor-default\" type=\"radio\" name=\"SelectColor\" value=\"\">
                                    <input id=\"color9\" class=\"size-5 border rounded-sm appearance-none cursor-pointer bg-slate-200 border-slate-200 checked:bg-slate-200 checked:border-slate-200 disabled:opacity-75 disabled:cursor-default\" type=\"radio\" name=\"SelectColor\" value=\"\">
                                    <input id=\"color10\" class=\"size-5 border rounded-sm appearance-none cursor-pointer bg-emerald-300 border-embg-emerald-300 checked:bg-emerald-300 checked:border-embg-emerald-300 disabled:opacity-75 disabled:cursor-default\" type=\"radio\" name=\"SelectColor\" value=\"\">
                                </div>
                                ...
                                <div class=\"flex flex-wrap items-center gap-2\">
                                    <div>
                                        ...
                                        <label for=\"selectSizeXS\" class=\"flex items-center justify-center size-8 text-xs border rounded-md cursor-pointer border-slate-200 dark:border-zink-500 peer-checked:bg-custom-50 dark:peer-checked:bg-custom-500/20 peer-checked:border-custom-300 dark:peer-checked:border-custom-700 peer-disabled:bg-slate-50 dark:peer-disabled:bg-slate-500/20 peer-disabled:border-slate-100 dark:peer-disabled:border-slate-800 peer-disabled:cursor-default peer-disabled:text-slate-500 dark:peer-disabled:text-zink-200\">XS</label>
                                    </div>
                                    <div>
                                        <input id=\"selectSizeS\" class=\"hidden peer\" type=\"radio\" value=\"S\" name=\"selectSize\" checked>
                                        <label for=\"selectSizeS\" class=\"flex items-center justify-center size-8 text-xs border rounded-md cursor-pointer border-slate-200 dark:border-zink-500 peer-checked:bg-custom-50 dark:peer-checked:bg-custom-500/20 peer-checked:border-custom-300 dark:peer-checked:border-custom-700 peer-disabled:bg-slate-50 dark:peer-disabled:bg-slate-500/20 peer-disabled:border-slate-100 dark:peer-disabled:border-slate-800 peer-disabled:cursor-default peer-disabled:text-slate-500 dark:peer-disabled:text-zink-200\">S</label>
                                    </div>
                                    <div>
                                        <input id=\"selectSizeM\" class=\"hidden peer\" type=\"radio\" value=\"M\" name=\"selectSize\" disabled>
                                        <label for=\"selectSizeM\" class=\"flex items-center justify-center size-8 text-xs border rounded-md cursor-pointer border-slate-200 dark:border-zink-500 peer-checked:bg-custom-50 dark:peer-checked:bg-custom-500/20 peer-checked:border-custom-300 dark:peer-checked:border-custom-700 peer-disabled:bg-slate-50 dark:peer-disabled:bg-slate-500/20 peer-disabled:border-slate-100 dark:peer-disabled:border-slate-800 peer-disabled:cursor-default peer-disabled:text-slate-500 dark:peer-disabled:text-zink-200\">M</label>
                                    </div>
                                    <div>
                                        <input id=\"selectSizeL\" class=\"hidden peer\" type=\"radio\" value=\"L\" name=\"selectSize\">
                                        <label for=\"selectSizeL\" class=\"flex items-center justify-center size-8 text-xs border rounded-md cursor-pointer border-slate-200 dark:border-zink-500 peer-checked:bg-custom-50 dark:peer-checked:bg-custom-500/20 peer-checked:border-custom-300 dark:peer-checked:border-custom-700 peer-disabled:bg-slate-50 dark:peer-disabled:bg-slate-500/20 peer-disabled:border-slate-100 dark:peer-disabled:border-slate-800 peer-disabled:cursor-default peer-disabled:text-slate-500 dark:peer-disabled:text-zink-200\">L</label>
                                    </div>
                                    <div>
                                        <input id=\"selectSizeXL\" class=\"hidden peer\" type=\"radio\" value=\"XL\" name=\"selectSize\">
                                        <label for=\"selectSizeXL\" class=\"flex items-center justify-center size-8 text-xs border rounded-md cursor-pointer border-slate-200 dark:border-zink-500 peer-checked:bg-custom-50 dark:peer-checked:bg-custom-500/20 peer-checked:border-custom-300 dark:peer-checked:border-custom-700 peer-disabled:bg-slate-50 dark:peer-disabled:bg-slate-500/20 peer-disabled:border-slate-100 dark:peer-disabled:border-slate-800 peer-disabled:cursor-default peer-disabled:text-slate-500 dark:peer-disabled:text-zink-200\">XL</label>
                                    </div>
                                    <div>
                                        <input id=\"selectSize2XL\" class=\"hidden peer\" type=\"radio\" value=\"2XL\" name=\"selectSize\">
                                        <label for=\"selectSize2XL\" class=\"flex items-center justify-center size-8 text-xs border rounded-md cursor-pointer border-slate-200 dark:border-zink-500 peer-checked:bg-custom-50 dark:peer-checked:bg-custom-500/20 peer-checked:border-custom-300 dark:peer-checked:border-custom-700 peer-disabled:bg-slate-50 dark:peer-disabled:bg-slate-500/20 peer-disabled:border-slate-100 dark:peer-disabled:border-slate-800 peer-disabled:cursor-default peer-disabled:text-slate-500 dark:peer-disabled:text-zink-200\">2XL</label>
                                    </div>
                                </div>

                                <h6 class=\"mt-5 mb-3 text-15\">Available Offers (4)</h6>
                                <ul class=\"flex flex-col gap-2\">
                                    <li><i data-lucide=\"tag\" class=\"inline-block size-4 text-green-500 ltr:mr-1 rtl:ml-1 fill-green-200 dark:fill-green-500/20\"></i> <span class=\"font-semibold\">Bank Offer</span> 10% Instant Discount on Paypal, up to \$1250 on orders of \$5,000 and above <a href=\"#!\" class=\"underline text-custom-500\">T&C</a></li>
                                    <li><i data-lucide=\"tag\" class=\"inline-block size-4 text-green-500 ltr:mr-1 rtl:ml-1 fill-green-200 dark:fill-green-500/20\"></i> <span class=\"font-semibold\">Special Price</span> Get at flat \$199 <a href=\"#!\" class=\"underline text-custom-500\">T&C</a></li>
                                    <li><i data-lucide=\"tag\" class=\"inline-block size-4 text-green-500 ltr:mr-1 rtl:ml-1 fill-green-200 dark:fill-green-500/20\"></i> <span class=\"font-semibold\">Partner Offer</span> Purchase now & get 1 surprise cashback coupon in Future <a href=\"#!\" class=\"underline text-custom-500\">Know More</a></li>
                                    <li><i data-lucide=\"tag\" class=\"inline-block size-4 text-green-500 ltr:mr-1 rtl:ml-1 fill-green-200 dark:fill-green-500/20\"></i> <span class=\"font-semibold\">Bank Offer</span> UPI Offer Men's Clothing <a href=\"#!\" class=\"underline text-custom-500\">T&C</a></li>
                                </ul>
                                ...
                                <div class=\"grid grid-cols-1 gap-5 my-5 xl:grid-cols-3\">
                                    <div class=\"flex items-center gap-5 p-4 border rounded-md border-slate-200 dark:border-zink-500\">
                                        <div class=\"flex items-center justify-center\">
                                            <i data-lucide=\"truck\" class=\"size-6 text-slate-500 fill-slate-200 dark:text-zink-200 dark:fill-zink-500\"></i>
                                        </div>
                                        <div>
                                    ...
                                    <div class=\"flex items-center gap-5 p-4 border rounded-md border-slate-200 dark:border-zink-500\">
                                        <div class=\"flex items-center justify-center\">
                                            <i data-lucide=\"container\" class=\"size-6 text-slate-500 fill-slate-200 dark:text-zink-200 dark:fill-zink-500\"></i>
                                        </div>
                                        <div>
                                ...
                                <div class=\"grid grid-cols-1 gap-5 xl:grid-cols-12\">
                                    ...
                                    <div class=\"xl:col-span-8\">
                                        ...
                                        <div class=\"pt-3 mt-3 border-t border-slate-200 dark:border-zink-500\">
                                            ...
                                            <div class=\"flex items-center gap-3\">
                                                <div class=\"size-10 rounded-full shrink-0 bg-sky-100 dark:bg-sky-500/20\">
                                                    <img src=\"assets/images/users/user-dummy-img.jpg\" alt=\"\" class=\"h-10 rounded-full\">
                                                </div>
                                                <div class=\"grow\">
                                        ...
                                        <div class=\"pt-3 mt-3 border-t border-slate-200 dark:border-zink-500\">
                                            ...
                                            <div class=\"flex items-center gap-3\">
                                                <div class=\"size-10 bg-yellow-100 rounded-full shrink-0 dark:bg-yellow-500/20\">
                                                    <img src=\"assets/images/users/avatar-5.png\" alt=\"\" class=\"h-10 rounded-full\">
                                                </div>
                                                <div class=\"grow\">
                                        ...
                                        <div class=\"pt-3 mt-3 border-t border-slate-200 dark:border-zink-500\">
                                            ...
                                            <div class=\"flex items-center gap-3\">
                                                <div class=\"size-10 bg-green-100 rounded-full shrink-0 dark:bg-green-500/20\">
                                                    <img src=\"assets/images/users/avatar-8.png\" alt=\"\" class=\"h-10 rounded-full\">
                                                </div>
                                                <div class=\"grow\">
    ...
    <div class=\"w-screen md:w-[25rem] bg-white shadow rounded-md dark:bg-zink-600\">
        ...
        <div class=\"max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto\">
            ...
            <ul class=\"flex gap-2 item-center\">
                <li><a href=\"#!\" class=\"flex items-center justify-center transition-all duration-200 ease-linear rounded-md size-9 text-slate-500 bg-slate-100 hover:bg-custom-100 hover:text-custom-500 dark:text-zink-200 dark:bg-zink-500 dark:hover:bg-zink-500 dark:hover:text-custom-500\"><i data-lucide=\"facebook\" class=\"size-4\"></i></a></li>
...
";
    ...
    {
        return "apps-ecommerce-product-overview.html.twig";
    }
    ...
    {
        return array (  695 => 584,  691 => 582,  684 => 577,  674 => 576,  94 => 6,  91 => 5,  81 => 4,  61 => 2,  38 => 1,);
    }
...
{{ component('breadcrumb', { pagetitle: 'Ecommerce', title: 'Overview' }) }}
...
{% endblock %}", "apps-ecommerce-product-overview.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\apps-ecommerce-product-overview.html.twig");
    }
}
