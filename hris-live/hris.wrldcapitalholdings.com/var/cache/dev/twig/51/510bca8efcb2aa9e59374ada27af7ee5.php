...
/* apps-chat.html.twig */
class __TwigTemplate_d01af695529d16169b827172d2079bda extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("partials/base.html.twig", "apps-chat.html.twig", 1);
                    ...
                    <div class=\"fixed inset-x-0 bottom-12 2xl:w-20 shrink-0 xl:relative z-[20] text-center xl:bottom-auto\">
                        <div class=\"xl:min-h-[calc(100vh_-_theme('height.header')_*_2.4)] inline-block card xl:h-[calc(100%_-_theme('spacing.5'))] shadow-lg xl:shadow-md\">
                            <div class=\"flex items-center h-full p-2 2xl:p-4 xl:flex-col\">
                                <a href=\"#!\" class=\"hidden xl:block\"><img src=\"assets/images/logo-sm.png\" alt=\"\" class=\"h-8 mx-auto\"></a>
                                <ul class=\"flex gap-2 my-auto text-center xl:pt-8 xl:flex-col nav-tabs\">
                                    <li class=\"group/item tabs active chatTab\">
                                        <a href=\"#!\" data-tab-toggle data-target=\"mainChatList\" class=\"inline-flex items-center justify-center size-12 transition-all duration-200 ease-linear rounded-md mainChatList\"><i data-lucide=\"messages-square\" class=\"mx-auto transition-all size-5 duration-200 ease-linear fill-slate-100 text-slate-500 dark:text-zink-200 dark:fill-zink-500 group-hover/item:text-custom-500 dark:group-hover/item:text-custom-500 group-[.active]/item:fill-custom-100 dark:group-[.active]/item:fill-custom-500/20 group-[.active]/item:text-custom-500 dark:group-[.active]/item:text-custom-500\"></i></a>
                                    </li>
                                    <li class=\"group/item tabs\">
                                        <a href=\"#!\" data-tab-toggle data-target=\"contactList\" class=\"inline-flex items-center justify-center size-12 transition-all duration-200 ease-linear rounded-md\"><i data-lucide=\"user-square\" class=\"mx-auto transition-all size-5 duration-200 ease-linear fill-slate-100 text-slate-500 dark:text-zink-200 dark:fill-zink-500 group-hover/item:text-custom-500 dark:group-hover/item:text-custom-500 group-[.active]/item:fill-custom-100 dark:group-[.active]/item:fill-custom-500/20 group-[.active]/item:text-custom-500 dark:group-[.active]/item:text-custom-500\"></i></a>
                                    </li>
                                    <li class=\"group/item botTab\">
                                        <a href=\"#!\" data-tab-toggle data-target=\"botChat\" class=\"inline-flex items-center justify-center size-12 transition-all duration-200 ease-linear rounded-md botChat\"><i data-lucide=\"bot\" class=\"mx-auto transition-all size-5 duration-200 ease-linear fill-slate-100 text-slate-500 dark:text-zink-200 dark:fill-zink-500 group-hover/item:text-custom-500 dark:group-hover/item:text-custom-500 group-[.active]/item:fill-custom-100 dark:group-[.active]/item:fill-custom-500/20 group-[.active]/item:text-custom-500 dark:group-[.active]/item:text-custom-500\"></i></a>
                                    </li>
                                    <li class=\"group/item tabs\">
                                        <a href=\"#!\" data-tab-toggle data-target=\"profile\" class=\"inline-flex items-center justify-center size-12 transition-all duration-200 ease-linear rounded-md\"><i data-lucide=\"user-2\" class=\"mx-auto transition-all size-5 duration-200 ease-linear fill-slate-100 text-slate-500 dark:text-zink-200 dark:fill-zink-500 group-hover/item:text-custom-500 dark:group-hover/item:text-custom-500 group-[.active]/item:fill-custom-100 dark:group-[.active]/item:fill-custom-500/20 group-[.active]/item:text-custom-500 dark:group-[.active]/item:text-custom-500\"></i></a>
                                    </li>
                                    <li class=\"group/item tabs\">
                                        <a href=\"#!\" data-tab-toggle data-target=\"fileDocument\" class=\"inline-flex items-center justify-center size-12 transition-all duration-200 ease-linear rounded-md\"><i data-lucide=\"scroll-text\" class=\"mx-auto transition-all size-5 duration-200 ease-linear fill-slate-100 text-slate-500 dark:text-zink-200 dark:fill-zink-500 group-hover/item:text-custom-500 dark:group-hover/item:text-custom-500 group-[.active]/item:fill-custom-100 dark:group-[.active]/item:fill-custom-500/20 group-[.active]/item:text-custom-500 dark:group-[.active]/item:text-custom-500\"></i></a>
                                    </li>
                                </ul>
                                <ul class=\"flex items-center gap-2 my-auto text-center xl:mb-0 xl:mt-auto xl:pt-4 xl:flex-col\">
                                    <li>
                                        <a href=\"pages-account-settings\" class=\"inline-flex items-center justify-center size-12 transition-all duration-200 ease-linear rounded-md group/item\"><i data-lucide=\"settings\" class=\"mx-auto transition-all size-5 duration-200 ease-linear fill-slate-100 text-slate-500 dark:text-zink-200 dark:fill-zink-500 group-hover/item:text-custom-500 dark:group-hover/item:text-custom-500 group-[.active]/item:fill-custom-100 dark:group-[.active]/item:fill-custom-500/20 group-[.active]/item:text-custom-500 dark:group-[.active]/item:text-custom-500\"></i></a>
                                    </li>
                                    <li class=\"hidden md:block\">
                                        <div class=\"relative dropdown\">
                                            <a href=\"#!\" type=\"button\" class=\"inline-flex items-center justify-center size-12 transition-all duration-200 ease-linear bg-pink-100 rounded-md group/item dropdown-toggle dark:bg-pink-500/20\" id=\"profilDropdown\" data-bs-toggle=\"dropdown\">
                                            ...
                                            <ul class=\"absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600\" aria-labelledby=\"profilDropdown\">
                                                <li>
                                                    <a class=\"block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200\" href=\"auth-login-basic\">Logout</a>
                                                </li>
                                                <li>
                                                    <a class=\"block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200\" href=\"auth-login-cover\">Switch Account</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <div class=\"block tab-pane\" id=\"mainChatList\">
                                        <div class=\"card-body\">
                                            <div class=\"flex items-center gap-3\">
                                                <button class=\"inline-flex items-center justify-center size-8 transition-all duration-200 ease-linear rounded-md shrink-0 bg-slate-100 text-slate-500 dark:bg-zink-600 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500\"><i data-lucide=\"chevrons-left\" class=\"size-4 mx-auto\"></i></button>
                                                <h6 class=\"text-15 grow\">Chats</h6>
                                                <button data-modal-target=\"addContactModal\" class=\"inline-flex items-center justify-center size-8 transition-all duration-200 ease-linear rounded-md shrink-0 bg-slate-100 text-slate-500 dark:bg-zink-600 dark:text-zink-200 hover:text-custom-500 dark:hover:text-custom-500\"><i data-lucide=\"plus\" class=\"size-4 mx-auto\"></i></button>
                                            </div>
                                            ...
                                            <ul class=\"flex flex-col gap-1\" id=\"chatList\">
                                                ...
                                                <li>
                                                    <a href=\"#!\" class=\"flex items-center gap-3 px-5 py-2 [&.active]:bg-slate-50 group/item dark:[&.active]:bg-zink-600\">
                                                        <div class=\"relative flex items-center justify-center font-semibold rounded-full text-slate-500 dark:text-zink-200 size-9 bg-slate-100 dark:bg-zink-600\">
                                                            <img src=\"assets/images/users/user-1.jpg\" alt=\"\" class=\"rounded-full h-9\">
                                                            <span class=\"absolute bottom-0 ltr:right-0 rtl:left-0 w-2.5 h-2.5 border-2 border-white dark:border-zink-700 rounded-full group-[.online]/item:bg-green-400 group-[.offline]/item:bg-slate-400 dark:group-[.offline]/item:bg-zink-500 bg-red-500\"></span>
                                                        </div>
                                                        <div class=\"overflow-hidden grow\">
                                                ...
                                                <li>
                                                    <a href=\"#!\" class=\"flex items-center gap-3 px-5 py-2 [&.active]:bg-slate-50 group/item dark:[&.active]:bg-zink-600 offline\">
                                                        <div class=\"relative flex items-center justify-center font-semibold rounded-full text-slate-500 dark:text-zink-200 size-9 bg-slate-100 dark:bg-zink-600\">
                                                            <img src=\"assets/images/users/user-2.jpg\" alt=\"\" class=\"rounded-full h-9\">
                                                            <span class=\"absolute bottom-0 ltr:right-0 rtl:left-0 w-2.5 h-2.5 border-2 border-white dark:border-zink-700 rounded-full group-[.online]/item:bg-green-400 group-[.offline]/item:bg-slate-400 dark:group-[.offline]/item:bg-zink-500 bg-red-500\"></span>
                                                        </div>
                                                        <div class=\"overflow-hidden grow\">
                                                ...
                                                <li>
                                                    <a href=\"#!\" class=\"flex items-center gap-3 px-5 py-2 [&.active]:bg-slate-50 group/item dark:[&.active]:bg-zink-600 offline\">
                                                        <div class=\"relative flex items-center justify-center font-semibold rounded-full text-slate-500 dark:text-zink-200 size-9 bg-slate-100 dark:bg-zink-600\">
                                                            <img src=\"assets/images/users/user-3.jpg\" alt=\"\" class=\"rounded-full h-9\">
                                                            <span class=\"absolute bottom-0 ltr:right-0 rtl:left-0 w-2.5 h-2.5 border-2 border-white dark:border-zink-700 rounded-full group-[.online]/item:bg-green-400 group-[.offline]/item:bg-slate-400 dark:group-[.offline]/item:bg-zink-500 bg-red-500\"></span>
                                                        </div>
                                                        <div class=\"overflow-hidden grow\">
                                                ...
                                                <li>
                                                    <a href=\"#!\" class=\"flex items-center gap-3 px-5 py-2 [&.active]:bg-slate-50 group/item dark:[&.active]:bg-zink-600 offline\">
                                                        <div class=\"relative flex items-center justify-center font-semibold rounded-full text-slate-500 dark:text-zink-200 size-9 bg-slate-100 dark:bg-zink-600\">
                                                            <img src=\"assets/images/users/avatar-8.png\" alt=\"\" class=\"rounded-full h-9\">
                                                            <span class=\"absolute bottom-0 ltr:right-0 rtl:left-0 w-2.5 h-2.5 border-2 border-white dark:border-zink-700 rounded-full group-[.online]/item:bg-green-400 group-[.offline]/item:bg-slate-400 dark:group-[.offline]/item:bg-zink-500 bg-red-500\"></span>
                                                        </div>
                                                        <div class=\"overflow-hidden grow\">
                                                ...
                                                <li>
                                                    <a href=\"#!\" class=\"flex items-center gap-3 px-5 py-2 [&.active]:bg-slate-50 group/item dark:[&.active]:bg-zink-600 online\">
                                                        <div class=\"relative flex items-center justify-center font-semibold rounded-full text-slate-500 dark:text-zink-200 size-9 bg-slate-100 dark:bg-zink-600\">
                                                            <img src=\"assets/images/users/avatar-10.png\" alt=\"\" class=\"rounded-full h-9\">
                                                            <span class=\"absolute bottom-0 ltr:right-0 rtl:left-0 w-2.5 h-2.5 border-2 border-white dark:border-zink-700 rounded-full group-[.online]/item:bg-green-400 group-[.offline]/item:bg-slate-400 dark:group-[.offline]/item:bg-zink-500 bg-red-500\"></span>
                                                        </div>
                                                        <div class=\"overflow-hidden grow\">
                                                ...
                                                <li>
                                                    <a href=\"#!\" class=\"flex items-center gap-3 px-5 py-2 [&.active]:bg-slate-50 group/item dark:[&.active]:bg-zink-600 offline\">
                                                        <div class=\"relative flex items-center justify-center font-semibold rounded-full text-slate-500 dark:text-zink-200 size-9 bg-slate-100 dark:bg-zink-600\">
                                                            <img src=\"assets/images/users/user-4.jpg\" alt=\"\" class=\"rounded-full h-9\">
                                                            <span class=\"absolute bottom-0 ltr:right-0 rtl:left-0 w-2.5 h-2.5 border-2 border-white dark:border-zink-700 rounded-full group-[.online]/item:bg-green-400 group-[.offline]/item:bg-slate-400 dark:group-[.offline]/item:bg-zink-500 bg-red-500\"></span>
                                                        </div>
                                                        <div class=\"overflow-hidden grow\">
                                                ...
                                                <li>
                                                    <div class=\"flex items-center gap-3 px-5 py-2 [&.active]:bg-slate-50 group/item dark:[&.active]:bg-zink-600 offline\">
                                                        ...
                                                        <div class=\"relative dropdown shrink-0\">
                                                            <button type=\"button\" class=\"dropdown-toggle\" id=\"contactListDropdown1\" data-bs-toggle=\"dropdown\"><i data-lucide=\"more-vertical\" class=\"inline-block size-4 ml-1\"></i></button>
                                            ...
                                            <ul class=\"flex flex-col gap-1\">
                                                <li>
                                                    <a href=\"#!\" class=\"flex items-center gap-3 px-5 py-2.5 [&.active]:bg-slate-50 dark:[&.active]:bg-zink-600 active\">
                                                        <div class=\"relative flex items-center justify-center font-semibold rounded-full text-slate-500 size-7 dark:text-zink-200 shrink-0\">
                                    ...
                                    <div class=\"hidden tab-pane\" id=\"profile\">
                                        <div data-simplebar class=\"max-h-[calc(100vh_-_250px)] xl:max-h-full card-body\">
                                            ...
                                            <h6 class=\"text-15 grow\">Profile</h6>
                                                <button class=\"inline-flex items-center justify-center size-8 transition-all duration-200 ease-linear rounded-md shrink-0 bg-slate-100 text-slate-500 hover:text-red-500 dark:bg-zink-600 dark:text-zink-200 dark:hover:text-red-500\"><i data-lucide=\"x\" class=\"size-4 mx-auto \"></i></button>
                                            </div>
                                            ...
                                            <div class=\"mt-5\">
                                                ...
                                                <h6 class=\"mb-3 font-medium\"><i data-lucide=\"phone\" class=\"inline-block size-4 mr-1 text-slate-500 dark:text-zink-200\"></i> <span class=\"align-middle\">+(103) 1234 567 8954</span></h6>
                                                <h6 class=\"mb-3 font-medium\"><i data-lucide=\"map-pin\" class=\"inline-block size-4 mr-1 text-slate-500 dark:text-zink-200\"></i> <span class=\"align-middle\">California, USA</span></h6>
                                                <h6 class=\"font-medium\"><i data-lucide=\"mail\" class=\"inline-block size-4 mr-1 text-slate-500 dark:text-zink-200\"></i> <span class=\"align-middle\">william@tailwick.com</span></h6>
                                            </div>
                                            <div class=\"mt-5\">
                                                ...
                                                <div class=\"flex items-center mb-3\">
                                                    <div class=\"relative inline-block w-10 align-middle transition duration-200 ease-in ltr:mr-2 rtl:ml-2\">
                                                        <input type=\"checkbox\" name=\"blockAccount\" id=\"blockAccount\" class=\"absolute block size-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-600 bg-white/80 dark:bg-zink-400 peer/published checked:bg-custom-500 dark:checked:bg-custom-500 ltr:checked:right-0 rtl:checked:left-0 checked:border-custom-100 dark:checked:border-custom-900 arrow-none checked:bg-none\">
                                                ...
                                                <a href=\"#!\">
                                                    <p class=\"mb-3\"><i data-lucide=\"bell-ring\" class=\"inline-block size-4 mr-1 text-slate-500 dark:text-zink-200\"></i> <span class=\"align-middle\">Custom Notification</span></p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class=\"flex flex-col gap-3\">
                                                <a href=\"#!\" class=\"flex items-center gap-3 !py-3 border-y border-dashed rounded-md card-body border-slate-200 dark:border-zink-500\">
                                                    <div class=\"flex items-center justify-center text-sm font-semibold rounded-md size-9 bg-slate-100 text-slate-500 dark:bg-zink-600 dark:text-zink-200 shrink-0\">
                                                        <img src=\"assets/images/small/img-2.jpg\" alt=\"\" class=\"object-cover rounded-md h-9\">
                                                    </div>
                                                    <div class=\"grow\">
                                                ...
                                                <a href=\"#!\" class=\"flex items-center gap-3 !py-3 border-y border-dashed rounded-md card-body border-slate-200 dark:border-zink-500\">
                                                    <div class=\"flex items-center justify-center text-sm font-semibold rounded-md size-9 bg-slate-100 text-slate-500 dark:bg-zink-600 dark:text-zink-200 shrink-0\">
                                                        <img src=\"assets/images/small/img-6.jpg\" alt=\"\" class=\"object-cover rounded-md h-9\">
                                                    </div>
                                                    <div class=\"grow\">
                            ...
                            <div class=\"card-body\">
                                <div class=\"flex items-center gap-3\">
                                    ...
                                    <ul class=\"flex items-center\">
                                        <li>
                                            <a data-modal-target=\"callModal\" href=\"#!\" class=\"inline-flex items-center justify-center size-10 transition-all duration-200 ease-linear rounded-md group/item\"><i data-lucide=\"phone\" class=\"mx-auto transition-all size-4 duration-200 ease-linear fill-slate-100 text-slate-500 dark:fill-zink-600 dark:text-zink-200 group-hover/item:text-custom-500 dark:group-hover/item:text-custom-500 group-[.active]/item:fill-custom-100 dark:group-[.active]/item:fill-custom-500/20 group-[.active]/item:text-custom-500 dark:group-[.active]/item:text-custom-500\"></i></a>
                                        </li>
                                        <li>
                                            <a href=\"#!\" class=\"inline-flex items-center justify-center size-10 transition-all duration-200 ease-linear rounded-md group/item\"><i data-lucide=\"video\" class=\"mx-auto transition-all size-4 duration-200 ease-linear fill-slate-100 text-slate-500 dark:fill-zink-600 dark:text-zink-200 group-hover/item:text-custom-500 dark:group-hover/item:text-custom-500 group-[.active]/item:fill-custom-100 dark:group-[.active]/item:fill-custom-500/20 group-[.active]/item:text-custom-500 dark:group-[.active]/item:text-custom-500\"></i></a>
                                        </li>
                                        <li>
                                            <a href=\"#!\" id=\"searchChatButton\" class=\"inline-flex items-center justify-center size-10 transition-all duration-200 ease-linear rounded-md group/item\"><i data-lucide=\"search\" class=\"mx-auto transition-all size-4 duration-200 ease-linear fill-slate-100 text-slate-500 dark:fill-zink-600 dark:text-zink-200 group-hover/item:text-custom-500 dark:group-hover/item:text-custom-500 group-[.active]/item:fill-custom-100 dark:group-[.active]/item:fill-custom-500/20 group-[.active]/item:text-custom-500 dark:group-[.active]/item:text-custom-500\"></i></a>
                                        </li>
                                        <li class=\"hidden md:block\">
                                            <a href=\"#!\" data-drawer-target=\"drawerEnd\" class=\"inline-flex items-center justify-center size-10 transition-all duration-200 ease-linear rounded-md group/item\">
                                ...
                                <div data-simplebar class=\"h-[calc(100vh_-_410px)] xl:h-[calc(100vh_-_330px)]\">
                                    <ul class=\"flex flex-col gap-5 list-none card-body\">
                                        <li class=\"flex chat-message group/item [&.right]:justify-end\">
                                            <div class=\"flex gap-3\">
                                                <a href=\"#!\" class=\"flex items-center self-end justify-center text-sm font-semibold rounded-full size-9 bg-slate-100 text-slate-500 dark:bg-zink-600 dark:text-zink-200 shrink-0 group-[.right]/item:order-3\">
                                                    <img src=\"assets/images/users/avatar-7.png\" alt=\"\" class=\"object-cover rounded-full h-9\">
                                                </a>
                                                <div class=\"grow group-[.right]/item:order-2 flex flex-col gap-3\">
                                                    <div class=\"flex gap-3\">
                                                        ...
                                                        <div class=\"relative transition-all duration-200 ease-linear opacity-0 dropdown shrink-0 group-hover/item:opacity-100 group-[.right]/item:order-1\">
                                                            <button type=\"button\" class=\"dropdown-toggle\" id=\"dropdownMenuButton\" data-bs-toggle=\"dropdown\"><i data-lucide=\"more-vertical\" class=\"inline-block size-4 ml-1\"></i></button>
                                        ...
                                        <li class=\"flex chat-message group/item [&.right]:justify-end right\">
                                            <div class=\"flex gap-3\">
                                                <a href=\"#!\" class=\"flex items-center self-end justify-center text-sm font-semibold rounded-full size-9 bg-slate-100 text-slate-500 dark:bg-zink-600 dark:text-zink-200 shrink-0 group-[.right]/item:order-3\">
                                                    <img src=\"assets/images/users/avatar-1.png\" alt=\"\" class=\"object-cover rounded-full h-9\">
                                                </a>
                                                <div class=\"grow group-[.right]/item:order-2 flex flex-col gap-3\">
                                                    <div class=\"flex gap-3\">
                                                        <div class=\"relative p-4 bg-white dark:bg-zink-700 rounded-md ltr:rounded-bl-none rtl:rounded-br-none shadow-sm 2xl:max-w-sm ltr:group-[.right]/item:rounded-br-none rtl:group-[.right]/item:rounded-bl-none ltr:group-[.right]/item:rounded-bl-md rtl:group-[.right]/item:rounded-br-md group-[.right]/item:order-2\">
                        ...
                        <div class=\"relative\">
                            <div data-simplebar class=\"h-[calc(100vh_-_320px)] xl:h-[calc(100vh_-_250px)]\">
                                <div class=\"sticky top-0 flex items-center gap-3 shadow-sm bg-white/60 dark:bg-zink-700/30 backdrop-blur-sm card-body\">
                                    <div class=\"relative flex items-center justify-center size-8 font-semibold rounded-full text-slate-500 bg-slate-100 dark:text-zink-200 dark:bg-zink-600\">
                                ...
                                <div class=\"flex gap-3 card-body bg-slate-50 dark:bg-zink-600\">
                                    <div class=\"flex items-center justify-center size-8 font-semibold rounded-full text-slate-500 bg-slate-100 shrink-0 dark:text-zink-200 dark:bg-zink-600\">
                                ...
                                <div class=\"sticky top-0 flex items-center gap-3 shadow-sm bg-white/60 backdrop-blur-sm card-body dark:bg-zink-700/30\">
                                    <div class=\"relative flex items-center justify-center size-8 font-semibold rounded-full text-slate-500 bg-slate-100\">
                                        <img src=\"assets/images/users/user-2.jpg\" alt=\"\" class=\"h-8 rounded-full\">
                                    </div>
...
<div id=\"drawerEnd\" drawer-end class=\"fixed inset-y-0 flex flex-col w-full transition-transform duration-300 ease-in-out transform bg-white shadow ltr:right-0 rtl:left-0 md:w-80 z-drawer show dark:bg-zink-600\">
    <div class=\"h-full p-4 overflow-y-auto\">
        <div>
            <div class=\"flex items-center gap-3\">
                <button id=\"closeChatRightSidebar\" class=\"inline-flex items-center justify-center h-8 transition-all duration-200 ease-linear rounded-md shrink-0 text-slate-500 hover:text-custom-500\"><i data-lucide=\"chevrons-left\" class=\"size-4 mx-auto\"></i></button>
                <h6 class=\"text-15 grow\">Profile</h6>
                <button data-drawer-close=\"drawerEnd\" class=\"inline-flex items-center justify-center size-8 transition-all duration-200 ease-linear rounded-md shrink-0 bg-slate-100 text-slate-500 hover:text-red-500 dark:bg-zink-600 dark:text-zink-200 dark:hover:text-red-500\"><i data-lucide=\"x\" class=\"size-4 mx-auto\"></i></button>
            </div>
            <div class=\"text-center\">
            ...
            <div class=\"mt-5\">
                ...
                <h6 class=\"font-medium\"><i data-lucide=\"mail\" class=\"inline-block size-4 ltr:mr-1 rtl:ml-1 text-slate-500 dark:text-zink-200\"></i> <span class=\"align-middle\">william@tailwick.com</span></h6>
            </div>
            <div class=\"mt-5\">
                <div class=\"flex items-center gap-2 mb-4\">
                    <p class=\"text-slate-500 dark:text-zink-200 grow\">Settings</p>
                ...
                <div class=\"flex items-center mb-3\">
                    <div class=\"relative inline-block w-10 align-middle transition duration-200 ease-in ltr:mr-2 rtl:ml-2\">
                        <input type=\"checkbox\" name=\"blockAccount1\" id=\"blockAccount1\" class=\"absolute block size-5 transition duration-300 ease-linear border-2 rounded-full appearance-none cursor-pointer border-slate-200 dark:border-zink-600 bg-white/80 dark:bg-zink-400 peer/published checked:bg-custom-500 dark:checked:bg-custom-500 ltr:checked:right-0 rtl:checked:left-0 checked:border-custom-100 dark:checked:border-custom-900 arrow-none checked:bg-none\">
        ...
        <div class=\"max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto p-4\">
            <form action=\"#!\">
                <div class=\"relative size-24 mx-auto mb-4 rounded-full shadow-md bg-slate-100 profile-user dark:bg-zink-500\">
                    ...
                    <div class=\"absolute bottom-0 right-0 flex items-center justify-center size-8 rounded-full profile-photo-edit\">
...
";
    ...
    public function block_javascripts($context, array $blocks = [])
    {
        ...
        // line 1299
        yield "
<script src=\"assets/js/pages/apps-chat.init.js\"></script>
...
";
    ...
    {
        return array (  1413 => 1305,  1409 => 1303,  1403 => 1299,  1393 => 1298,  91 => 5,  81 => 4,  61 => 2,  38 => 1,);
    }
...
{% endblock %}", "apps-chat.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\apps-chat.html.twig");
    }
}
