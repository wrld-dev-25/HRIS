...
/* apps-hr-holidays.html.twig */
class __TwigTemplate_bbf68a293d8747cb0454173113c90f9c extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps-hr-holidays.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "apps-hr-holidays.html.twig"));

        $this->parent = $this->loadTemplate("partials/base.html.twig", "apps-hr-holidays.html.twig", 1);
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        yield "
            ";
        // line 6
        yield $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("breadcrumb", ["pagetitle" => "HR Management", "title" => "Holidays"]);
        yield "
                                    ...
                                    <tr>
                                        ...
                                        <td class=\"px-3.5 py-2.5 border border-slate-200 dark:border-zink-500\">
                                            <div class=\"flex gap-2\">
                                                <a href=\"#!\" data-modal-target=\"addHolidayModal\" class=\"flex items-center justify-center size-8 transition-all duration-200 ease-linear rounded-md bg-slate-100 text-slate-500 hover:text-custom-500 hover:bg-custom-100 dark:bg-zink-600 dark:text-zink-200 dark:hover:bg-custom-500/20 dark:hover:text-custom-500\"><i data-lucide=\"pencil\" class=\"size-4\"></i></a>
                                                <a href=\"#!\" data-modal-target=\"deleteModal\" class=\"flex items-center justify-center size-8 transition-all duration-200 ease-linear rounded-md bg-slate-100 text-slate-500 hover:text-red-500 hover:bg-red-100 dark:bg-zink-600 dark:text-zink-200 dark:hover:text-red-500 dark:hover:bg-red-500/20\"><i data-lucide=\"trash-2\" class=\"size-4\"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
...
<div id=\"addHolidayModal\" modal-center class=\"fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show \">
    <div class=\"w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600\">
        <div class=\"flex items-center justify-between p-4 border-b dark:border-zink-500\">
            ...
            <button data-modal-close=\"addHolidayModal\" class=\"transition-all duration-200 ease-linear text-slate-400 hover:text-red-500\"><i data-lucide=\"x\" class=\"size-5\"></i></button>
        </div>
...
";
    ...
    {
        return "apps-hr-holidays.html.twig";
    }
    ...
    {
        return array (  360 => 249,  356 => 247,  352 => 245,  342 => 244,  94 => 6,  91 => 5,  81 => 4,  61 => 2,  38 => 1,);
    }
...
{% block content %}
            ...
            {{ component('breadcrumb', { pagetitle: 'HR Management', title: 'Holidays' }) }}
...
{% endblock %}", "apps-hr-holidays.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\apps-hr-holidays.html.twig");
    }
}
