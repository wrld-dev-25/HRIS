...
class __TwigTemplate_8e5b6187a4bf9f5e6220403452c70912 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("partials/without-nav.html.twig", "auth-logout-basic.html.twig", 1);
    ...
    <div class=\"relative\">
        ...
        <div class=\"mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative\">
            <div class=\"!px-10 !py-12 card-body\">
                ...
                <a href=\"auth-login-basic\" class=\"w-full text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20\">Sign In</a>
            </div>
        </div>
    </div>
...
";
    ...
    {
        return array (  176 => 71,  166 => 70,  91 => 4,  81 => 3,  61 => 2,  38 => 1,);
    }
...
{% endblock %}", "auth-logout-basic.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\auth-logout-basic.html.twig");
    }
}
