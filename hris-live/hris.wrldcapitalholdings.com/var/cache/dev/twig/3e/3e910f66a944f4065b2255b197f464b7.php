...
/* auth-login-modern.html.twig */
class __TwigTemplate_e855e6f834948bf32cb266f27857c36b extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "auth-login-modern.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "auth-login-modern.html.twig"));

        $this->parent = $this->loadTemplate("partials/without-nav.html.twig", "auth-login-modern.html.twig", 1);
            ...
            <div class=\"flex flex-col w-full h-full\">
                    ...
                    <div class=\"lg:w-[20rem] mx-auto mt-10\">
                        <ul class=\"flex flex-wrap w-full gap-2 text-sm font-medium text-center nav-tabs\">
                            <li class=\"group grow active\">
                                <a href=\"javascript:void(0);\" data-tab-toggle data-target=\"emailLogin\" class=\"inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 bg-slate-100 dark:text-zink-200 dark:bg-zink-600 border border-transparent group-[.active]:bg-custom-500 dark:group-[.active]:bg-custom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-custom-500 dark:hover:text-custom-500 active:text-custom-500 dark:active:text-custom-500 -mb-[1px]\"><i data-lucide=\"mail\" class=\"inline-block size-4 mr-1\"></i> <span class=\"align-middle\">Email</span></a>
                            </li>
                            <li class=\"group grow\">
                                <a href=\"javascript:void(0);\" data-tab-toggle data-target=\"phoneLogin\" class=\"inline-block px-4 w-full py-2 text-base transition-all duration-300 ease-linear rounded-md text-slate-500 bg-slate-100 dark:text-zink-200 dark:bg-zink-600 border border-transparent group-[.active]:bg-custom-500 dark:group-[.active]:bg-custom-500 group-[.active]:text-white dark:group-[.active]:text-white hover:text-custom-500 dark:hover:text-custom-500 active:text-custom-500 dark:active:text-custom-500 -mb-[1px]\"><i data-lucide=\"smartphone\" class=\"inline-block size-4 mr-1\"></i> <span class=\"align-middle\">Phone</span></a>
                            </li>
                        </ul>
                    </div>
                    <div class=\"lg:w-[25rem] mx-auto\">
                        <div class=\"mt-5 tab-content\">
                            <div class=\"block tab-pane\" id=\"emailLogin\">
                                <form action=\"index\" class=\"mt-10\" id=\"signInForm\">
                            ...
                            <div class=\"hidden tab-pane\" id=\"phoneLogin\">
                                <form action=\"index\" class=\"mt-10\" id=\"signInForm\">
                                    ...
                                    <div class=\"mb-3\">
                                        ...
                                        <input type=\"number\" id=\"phoneNumber\" class=\"form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" placeholder=\"Enter phone\">
                                        <div id=\"phone-error\" class=\"hidden mt-1 text-sm text-red-500\">Please enter a valid email address.</div>
                                    </div>
                                    <div class=\"mb-3\">
                                        <label for=\"password\" class=\"inline-block mb-2 text-base font-medium\">Password</label>
                                        <input type=\"password\" id=\"password\" class=\"form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" placeholder=\"Enter password\">
                                    ...
                                    <div>
                                        <div class=\"flex items-center gap-2\">
                                            <input id=\"phoneCheckRememberMe\" class=\"size-4 border rounded-sm appearance-none bg-slate-100 border-slate-200 dark:bg-zink-600 dark:border-zink-500 checked:bg-custom-500 checked:border-custom-500 dark:checked:bg-custom-500 dark:checked:border-custom-500 checked:disabled:bg-custom-400 checked:disabled:border-custom-400\" type=\"checkbox\" value=\"\">
                                            <label for=\"phoneCheckRememberMe\" class=\"inline-block text-base font-medium align-middle cursor-pointer\">Remember me</label>
                                        </div>
                                        <div id=\"remember-error\" class=\"hidden mt-1 text-sm text-red-500\">Please check the \"Remember me\" before submitting the form.</div>
                                    </div>
                                    <div class=\"mt-10\">
                                        <button type=\"submit\" class=\"w-full font-medium text-white uppercase transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100\">Sign In</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class=\"relative text-center my-9 before:absolute before:top-3 before:left-0 before:right-0 before:border-t before:border-t-slate-200 dark:before:border-t-zink-500\">
                            <h5 class=\"inline-block px-4 py-0.5 text-sm bg-white text-slate-500 dark:bg-zink-700 dark:text-zink-200 rounded relative\">Sign In with</h5>
                        </div>

                        <div class=\"flex flex-wrap justify-center gap-2\">
                            <button type=\"button\" class=\"flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 text-custom-500 btn bg-custom-100 border-custom-100 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 active:text-white active:bg-custom-600 active:border-custom-600\"><i data-lucide=\"facebook\" class=\"size-4\"></i></button>
                            <button type=\"button\" class=\"flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 text-orange-500 btn bg-orange-100 border-orange-100 hover:text-white hover:bg-orange-600 hover:border-orange-600 focus:text-white focus:bg-orange-600 focus:border-orange-600 active:text-white active:bg-orange-600 active:border-orange-600\"><i data-lucide=\"mail\" class=\"size-4\"></i></button>
                            ...
                            <button type=\"button\" class=\"flex items-center justify-center size-[37.5px] transition-all duration-200 ease-linear p-0 text-slate-500 btn bg-slate-200 border-slate-200 hover:text-white hover:bg-slate-600 hover:border-slate-600 focus:text-white focus:bg-slate-600 focus:border-slate-600 active:text-white active:bg-slate-600 active:border-slate-600\"><i data-lucide=\"github\" class=\"size-4\"></i></button>
                        </div>

                        <div class=\"mt-10 text-center\">
                            <p class=\"mb-0 text-slate-500 dark:text-zink-200\">Don't have an account ? <a href=\"auth-signup-cover\" class=\"font-semibold underline transition-all duration-150 ease-linear text-slate-500 dark:text-zink-200 hover:text-custom-500\"> SignUp</a> </p>
                        </div>
                ...
                <div class=\"mt-5\">
                    <p class=\"mb-0 text-center text-15 text-slate-500 dark:text-zink-200\">©
                        <script>document.write(new Date().getFullYear())</script> Tailwick. Crafted with <i class=\"text-red-500 ri-heart-fill\"></i> by <a href=\"http://themesdesign.in\" class=\"underline transition-all duration-200 ease-linear text-slate-800 dark:text-zink-50 hover:text-custom-500\">Themesdesign</a>
                    </p>
                </div>
            </div>
        </div>
...
";
    ...
    {
        return "auth-login-modern.html.twig";
    }
...
{% endblock %}", "auth-login-modern.html.twig", "C:\\Users\\SUNIT226\\Desktop\\Repos\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\auth-login-modern.html.twig");
    }
}
