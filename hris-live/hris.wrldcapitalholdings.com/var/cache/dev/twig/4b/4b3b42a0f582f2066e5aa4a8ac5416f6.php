...
class __TwigTemplate_59179aa5a6d7492028169ec722e785d7 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "bir_config/bir_config.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "bir_config/bir_config.html.twig"));
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        yield "
            ";
        // line 6
        yield $this->env->getRuntime('Symfony\UX\TwigComponent\Twig\ComponentRuntime')->render("breadcrumb", ["pagetitle" => "BIR", "title" => "BIR Configuration"]);
        yield "
        ...
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["bir_config"]) || array_key_exists("bir_config", $context) ? $context["bir_config"] : (function () { throw new RuntimeError('Variable "bir_config" does not exist.', 47, $this->source); })()));
        ...
        unset($context['_seq'], $context['_key'], $context['birConfigitem'], $context['_parent']);
...
";
        // line 144
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["bir_config"]) || array_key_exists("bir_config", $context) ? $context["bir_config"] : (function () { throw new RuntimeError('Variable "bir_config" does not exist.', 144, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["birConfigitem"]) {
            // line 145
...
";
    ...
    {
        return array (  457 => 225,  453 => 223,  447 => 220,  443 => 219,  439 => 218,  436 => 217,  423 => 216,  411 => 213,  402 => 211,  398 => 210,  394 => 208,  374 => 194,  370 => 193,  366 => 192,  357 => 186,  346 => 178,  339 => 174,  331 => 169,  323 => 164,  319 => 163,  311 => 158,  303 => 153,  299 => 152,  293 => 149,  285 => 145,  281 => 144,  265 => 131,  222 => 91,  197 => 68,  184 => 61,  178 => 58,  169 => 52,  165 => 51,  159 => 50,  155 => 49,  152 => 48,  147 => 47,  104 => 6,  101 => 5,  88 => 4,  65 => 2,  42 => 1,);
    }
...
{% block content %}
            ...
            {{ component('breadcrumb', { pagetitle: 'BIR', title: 'BIR Configuration' }) }}
                            ...
                            <div class=\"card-body\">
                                <div class=\"-mx-5 -mb-5 overflow-x-auto\">
                                    <table class=\"w-full border-separate table-custom border-spacing-y-1 whitespace-nowrap\">
                                        ...
                                        <tbody class=\"list\">
                                        {# {{ dump(bir_config) }} #}
                                            {% for birConfigitem in bir_config %}
                                                <tr class=\"relative rounded-md after:absolute ltr:after:border-l-2 rtl:after:border-r-2 ltr:after:left-0 rtl:after:right-0 after:top-0 after:bottom-0 after:border-transparent [&.active]:after:border-custom-500 [&.active]:bg-slate-100 dark:[&.active]:bg-zink-600\">
                                                    <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 employee_share\">{{ birConfigitem.tax_bracket_name }}</td>
                                                    <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 employer_share\">{{ birConfigitem.tax_bracket_range }} to {{ birConfigitem.tax_bracket_range_end }}</td>
                                                    <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 employee_share\">{{ birConfigitem.tax_deduction_percent }} %</td>
                                                    <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 employer_share\">{{ birConfigitem.tax_deduction_amount }}</td>
                                                    <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5\">
                                                        <div class=\"action-bir_config relative dropdown\">
                                                            <button class=\"flex items-center justify-center size-[30px] dropdown-toggle p-0 text-slate-500 btn bg-slate-100 hover:text-white hover:bg-slate-600 focus:text-white focus:bg-slate-600 focus:ring focus:ring-slate-100 active:text-white active:bg-slate-600 active:ring active:ring-slate-100 dark:bg-slate-500/20 dark:text-slate-400 dark:hover:bg-slate-500 dark:hover:text-white dark:focus:bg-slate-500 dark:focus:text-white dark:active:bg-slate-500 dark:active:text-white dark:ring-slate-400/20\" id=\"usersAction1\" data-bs-toggle=\"dropdown\"><i data-lucide=\"more-horizontal\" class=\"size-3\"></i></button>
                                                            <ul class=\"absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600\" aria-labelledby=\"usersAction1\">
                                                                <li>
                                                                    <a data-modal-target=\"editBIRConfig{{birConfigitem.id}}\" class=\"edit-bir_config block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200\" href=\"#!\"><i data-lucide=\"file-edit\" class=\"inline-block size-3 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">Edit</span></a>
                                                                </li>
                                                                <li>
                                                                    <a data-modal-target=\"deleteSSSConfig{{birConfigitem.id}}\" class=\"delete-bir_config block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200\" href=\"#!\"><i data-lucide=\"trash-2\" class=\"inline-block size-3 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">Delete</span></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
...
<div id=\"addBIRConfig\" modal-center class=\"fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show \">
    <div class=\"w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600\">
        ...
        <div class=\"max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto\">
            <form action=\"{{ path('app_bir_create_config') }}\" method=\"post\">
            <div class=\"grid grid-cols-1 gap-4 xl:grid-cols-12\">
                <div class=\"xl:col-span-12\">
                    <label for=\"model_type_name\" class=\"inline-block mb-2 text-base font-medium\">Tax Bracket Name</label>
                    <span class=\"text-red-500\">*</span>
...
<div id=\"importCSV\" modal-center class=\"fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show \">
    <div class=\"w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600\">
        ...
        <div class=\"max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto\">
            <form action=\"{{path('app_tax_import_config')}}\" method=\"post\" enctype=\"multipart/form-data\">
                <div>
                    <input type=\"file\" class=\"cursor-pointer form-file form-file-sm border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500\" placeholder=\"Employee CSV\" name=\"csv_file\" accept=\".csv\" required>
                </div>
                <div class=\"flex justify-end gap-2 mt-4\">
...
{% for birConfigitem in bir_config %}
<div id=\"editBIRConfig{{birConfigitem.id}}\" modal-center class=\"fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show \">
    <div class=\"w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600\">
        <div class=\"flex items-center justify-between p-4 border-b dark:border-zink-300/20\">
            <h5 class=\"text-16\">Edit Model Type</h5>
            <button data-modal-close=\"editBIRConfig{{birConfigitem.id}}\" class=\"transition-all duration-200 ease-linear text-slate-400 hover:text-red-500\"><i data-lucide=\"x\" class=\"size-5\"></i></button>
        </div>
        <div class=\"max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto\">
            <form action=\"{{ path('app_bir_update_config') }}\" method=\"post\">
            <input type=\"hidden\" name=\"bir_config_id\" value=\"{{birConfigitem.id}}\">
            <div class=\"grid grid-cols-1 gap-4 xl:grid-cols-12\">
                <div class=\"xl:col-span-12\">
                    <label for=\"tax_bracket_name\" class=\"inline-block mb-2 text-base font-medium\">Tax Bracket Name</label>
                    <span class=\"text-red-500\">*</span>
                    <input type=\"text\" id=\"tax_bracket_name\" name=\"tax_bracket_name\" class=\"form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" placeholder=\"Enter Employee Share\" value=\"{{birConfigitem.tax_bracket_name}}\" required>
                </div>
                <div class=\"xl:col-span-12\">
                    <label for=\"tax_bracket_range_start\" class=\"inline-block mb-2 text-base font-medium\">Tax Bracket Income Range</label>
                    <span class=\"text-red-500\">*</span>
                    <input type=\"number\" min=\"0\" step=\"0.01\" id=\"tax_bracket_range_start\" name=\"tax_bracket_range_start\" class=\"form-input numbers-only border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" placeholder=\"Enter Mimimum range\" value=\"{{birConfigitem.tax_bracket_range}}\" required>
                    <input type=\"number\" min=\"0\" step=\"0.01\" id=\"tax_bracket_range_end\" name=\"tax_bracket_range_end\" class=\"form-input numbers-only border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" placeholder=\"Enter Maximum range\" value=\"{{birConfigitem.tax_bracket_range_end}}\" required>
                </div>
                <div class=\"xl:col-span-12\">
                    <label for=\"tax_deduction_percent\" class=\"inline-block mb-2 text-base font-medium\">Tax Bracket Deduction (Percentage)</label>
                    <span class=\"text-red-500\">*</span>
                    <input type=\"number\" min=\"0\" step=\"0.01\" id=\"tax_deduction_percent\" name=\"tax_deduction_percent\" class=\"form-input numbers-only border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" placeholder=\"Enter Employee Share\" value=\"{{birConfigitem.tax_deduction_percent}}\" required>
                </div>
                <div class=\"xl:col-span-12\">
                    <label for=\"tax_deduction_amount\" class=\"inline-block mb-2 text-base font-medium\">Tax Bracket Deduction (Amount)</label>
                    <span class=\"text-red-500\">*</span>
                    <input type=\"number\" min=\"0\" step=\"0.01\" id=\"tax_deduction_amount\" name=\"tax_deduction_amount\" class=\"form-input numbers-only border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200\" placeholder=\"Enter amount\" value=\"{{birConfigitem.tax_deduction_amount}}\" required>
                </div>
            </div>
                <div class=\"flex justify-end gap-2 mt-4\">
                    <button type=\"reset\" id=\"close-modal\" data-modal-close=\"editBIRConfig{{birConfigitem.id}}\" class=\"text-red-500 bg-white btn hover:text-red-500 hover:bg-red-100 focus:text-red-500 focus:bg-red-100 active:text-red-500 active:bg-red-100 dark:bg-zink-600 dark:hover:bg-red-500/10 dark:focus:bg-red-500/10 dark:active:bg-red-500/10\">Cancel</button>
                    <button type=\"submit\" class=\"text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20\">Save</button>
                </div>
            </form>
        </div>
...
<div id=\"deleteSSSConfig{{birConfigitem.id}}\" modal-center class=\"fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show\">
    <div class=\"w-screen md:w-[25rem] bg-white shadow rounded-md dark:bg-zink-600\">
        <div class=\"max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto px-6 py-8\">
            <div class=\"float-right\">
                <button data-modal-close=\"deleteSSSConfig\" class=\"transition-all duration-200 ease-linear text-slate-500 hover:text-red-500\"><i data-lucide=\"x\" class=\"size-5\"></i></button>
            ...
            <form action=\"{{ path('app_bir_delete_config') }}\" method=\"post\">
                <input type=\"hidden\" name=\"bir_config_id\" value=\"{{birConfigitem.id}}\">
                <div class=\"mt-5 text-center\">
                    <h5 class=\"mb-1\">Are you sure?</h5>
                    <p class=\"text-slate-500 dark:text-zink-200\">Are you certain you want to delete this record?</p>
...
{% endblock %}", "bir_config/bir_config.html.twig", "C:\\xampp\\htdocs\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\bir_config\\bir_config.html.twig");
    }
}
