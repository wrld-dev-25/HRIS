...
class __TwigTemplate_0c5b6499a89a7cf7f1259177b27e2580 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $__internal_5a27a8ba21ca79b61932376b2fa922d2->enter($__internal_5a27a8ba21ca79b61932376b2fa922d2_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "sss_config/sss_config.html.twig"));

        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "sss_config/sss_config.html.twig"));
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        ...
        yield "
            ";
        // line 6
        yield $this->env->getRuntime('Symfony\UX\TwigComponent\Twig\ComponentRuntime')->render("breadcrumb", ["pagetitle" => "SSS", "title" => "SSS Configuration"]);
        yield "
        ...
        unset($context['_seq'], $context['_key'], $context['sss_config'], $context['_parent']);
...
";
        // line 212
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable((isset($context["sss_config"]) || array_key_exists("sss_config", $context) ? $context["sss_config"] : (function () { throw new RuntimeError('Variable "sss_config" does not exist.', 212, $this->source); })()));
...
";
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_key'], $context['sss_config_item'], $context['_parent']);
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 314
        yield "
...
";
        // line 316
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 316, $this->source); })()), "flashes", ["status"], "method", false, false, false, 316));
...
";
    ...
    {
        return array (  609 => 331,  605 => 329,  599 => 326,  595 => 325,  591 => 324,  588 => 323,  575 => 322,  563 => 319,  554 => 317,  550 => 316,  546 => 314,  526 => 300,  522 => 299,  518 => 298,  509 => 292,  498 => 284,  491 => 280,  484 => 276,  477 => 272,  470 => 268,  463 => 264,  456 => 260,  449 => 256,  442 => 252,  435 => 248,  427 => 243,  419 => 238,  411 => 233,  403 => 228,  395 => 223,  391 => 222,  383 => 217,  375 => 213,  371 => 212,  355 => 199,  268 => 115,  241 => 90,  228 => 83,  222 => 80,  213 => 74,  209 => 73,  205 => 72,  201 => 71,  197 => 70,  193 => 69,  189 => 68,  185 => 67,  181 => 66,  177 => 65,  171 => 64,  168 => 63,  163 => 62,  146 => 46,  104 => 6,  101 => 5,  88 => 4,  65 => 2,  42 => 1,);
    }
...
{% block content %}
            ...
            {{ component('breadcrumb', { pagetitle: 'SSS', title: 'SSS Configuration' }) }}
                                        ...
                                        {# {{ dump(sss_config) }} #}
                                            {% for sss_config in sss_config %}
                                                    <tr class=\"relative rounded-md after:absolute ltr:after:border-l-2 rtl:after:border-r-2 ltr:after:left-0 rtl:after:right-0 after:top-0 after:bottom-0 after:border-transparent [&.active]:after:border-custom-500 [&.active]:bg-slate-100 dark:[&.active]:bg-zink-600\">
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 employee_share\">{{ sss_config.range_start }} to {{ sss_config.range_end }}</td>
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 employer_share\">{{ sss_config.msc_ec }}</td>
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 employee_share\">{{ sss_config.msc_wisp }}</td>
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 employer_share\">{{ sss_config.contribution_regular_er }}</td>
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 employee_share\">{{ sss_config.contribution_regular_ee }}</td>
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 employer_share\">{{ sss_config.contribution_ec_er }}</td>
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 employee_share\">{{ sss_config.contribution_ec_ee }}</td>
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 employer_share\">{{ sss_config.contribution_wisp_er }}</td>
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 employee_share\">{{ sss_config.contribution_wisp_ee }}</td>
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 employer_share\">{{ sss_config.contribution_total_er }}</td>
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5 employee_share\">{{ sss_config.contribution_total_ee }}</td>
                                                        <td class=\"px-3.5 py-2.5 first:pl-5 last:pr-5\">
                                                            <div class=\"action-sss_config relative dropdown\">
                                                                <button class=\"flex items-center justify-center size-[30px] dropdown-toggle p-0 text-slate-500 btn bg-slate-100 hover:text-white hover:bg-slate-600 focus:text-white focus:bg-slate-600 focus:ring focus:ring-slate-100 active:text-white active:bg-slate-600 active:ring active:ring-slate-100 dark:bg-slate-500/20 dark:text-slate-400 dark:hover:bg-slate-500 dark:hover:text-white dark:focus:bg-slate-500 dark:focus:text-white dark:active:bg-slate-500 dark:active:text-white dark:ring-slate-400/20\" id=\"usersAction1\" data-bs-toggle=\"dropdown\"><i data-lucide=\"more-horizontal\" class=\"size-3\"></i></button>
                                                                <ul class=\"absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600\" aria-labelledby=\"usersAction1\">
                                                                    <li>
                                                                        <a data-modal-target=\"editModelType{{sss_config.id}}\" class=\"edit-sss_config block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200\" href=\"#!\"><i data-lucide=\"file-edit\" class=\"inline-block size-3 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">Edit</span></a>
                                                                    </li>
                                                                    <li>
                                                                        <a data-modal-target=\"deleteSSSConfig{{sss_config.id}}\" class=\"delete-sss_config block px-4 py-1.5 text-base transition-all duration-200 ease-linear text-slate-600 dropdown-item hover:bg-slate-100 hover:text-slate-500 focus:bg-slate-100 focus:text-slate-500 dark:text-zink-100 dark:hover:bg-zink-500 dark:hover:text-zink-200 dark:focus:bg-zink-500 dark:focus:text-zink-200\" href=\"#!\"><i data-lucide=\"trash-2\" class=\"inline-block size-3 ltr:mr-1 rtl:ml-1\"></i> <span class=\"align-middle\">Delete</span></a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </td>
...
<div id=\"addSSSConfig\" modal-center class=\"fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show\">
    <div class=\"w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600\">
        ...
        <div class=\"max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto\">
            <form action=\"{{ path('app_sss_create_config') }}\" method=\"post\">
                <div class=\"grid grid-cols-1 gap-4 xl:grid-cols-12\">
                    <div class=\"xl:col-span-12\">
                        <label for=\"range_start\" class=\"inline-block mb-2 text-base font-medium\">Range Start</label>
                        <span class=\"text-red-500\">*</span>
...
<div id=\"importCSV\" modal-center class=\"fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show \">
    <div class=\"w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600\">
        ...
        <div class=\"max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto\">
            <form action=\"{{path('app_sss_import_config')}}\" method=\"post\" enctype=\"multipart/form-data\">
                <div>
                    <input type=\"file\" class=\"cursor-pointer form-file form-file-sm border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500\" placeholder=\"Employee CSV\" name=\"csv_file\" accept=\".csv\" required>
                </div>
                <div class=\"flex justify-end gap-2 mt-4\">
...
{% for sss_config_item in sss_config %}
<div id=\"editModelType{{ sss_config_item.id }}\" modal-center class=\"fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show\">
    <div class=\"w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600\">
        <div class=\"flex items-center justify-between p-4 border-b dark:border-zink-300/20\">
            <h5 class=\"text-16\">Edit SSS Configuration</h5>
            <button data-modal-close=\"editModelType{{ sss_config_item.id }}\" class=\"transition-all duration-200 ease-linear text-slate-400 hover:text-red-500\">
                <i data-lucide=\"x\" class=\"size-5\"></i>
            </button>
        </div>
        <div class=\"max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto\">
            <form action=\"{{ path('app_sss_update_config') }}\" method=\"post\">
                <input type=\"hidden\" name=\"sss_config_id\" value=\"{{ sss_config_item.id }}\">
                <div class=\"grid grid-cols-1 gap-4 xl:grid-cols-12\">
                    <div class=\"xl:col-span-12\">
                        <label for=\"range_start\" class=\"inline-block mb-2 text-base font-medium\">Range Start</label>
                        <span class=\"text-red-500\">*</span>
                        <input type=\"number\" step=\"0.01\" id=\"range_start\" name=\"range_start\" class=\"form-input numbers-only\" placeholder=\"Enter Range Start\" value=\"{{ sss_config_item.range_start }}\" required>
                    </div>
                    <div class=\"xl:col-span-12\">
                        <label for=\"range_end\" class=\"inline-block mb-2 text-base font-medium\">Range End</label>
                        <span class=\"text-red-500\">*</span>
                        <input type=\"number\" step=\"0.01\" id=\"range_end\" name=\"range_end\" class=\"form-input numbers-only\" placeholder=\"Enter Range End\" value=\"{{ sss_config_item.range_end }}\" required>
                    </div>
                    <div class=\"xl:col-span-12\">
                        <label for=\"msc_ec\" class=\"inline-block mb-2 text-base font-medium\">MSC EC</label>
                        <span class=\"text-red-500\">*</span>
                        <input type=\"number\" step=\"0.01\" id=\"msc_ec\" name=\"msc_ec\" class=\"form-input numbers-only\" placeholder=\"Enter MSC EC\" value=\"{{ sss_config_item.msc_ec }}\" required>
                    </div>
                    <div class=\"xl:col-span-12\">
                        <label for=\"msc_wisp\" class=\"inline-block mb-2 text-base font-medium\">MSC WISP</label>
                        <span class=\"text-red-500\">*</span>
                        <input type=\"number\" step=\"0.01\" id=\"msc_wisp\" name=\"msc_wisp\" class=\"form-input numbers-only\" placeholder=\"Enter MSC WISP\" value=\"{{ sss_config_item.msc_wisp }}\" required>
                    </div>
                    <div class=\"xl:col-span-12\">
                        <label for=\"msc_total\" class=\"inline-block mb-2 text-base font-medium\">MSC Total</label>
                        <span class=\"text-red-500\">*</span>
                        <input type=\"number\" step=\"0.01\" id=\"msc_total\" name=\"msc_total\" class=\"form-input numbers-only\" placeholder=\"Enter MSC Total\" value=\"{{ sss_config_item.msc_total }}\" required>
                    </div>
                    <div class=\"xl:col-span-12\">
                        <label for=\"contribution_regular_er\" class=\"inline-block mb-2 text-base font-medium\">Contribution Regular ER</label>
                        <input type=\"number\" step=\"0.01\" id=\"contribution_regular_er\" name=\"contribution_regular_er\" class=\"form-input numbers-only\" placeholder=\"Enter Contribution Regular ER\" value=\"{{ sss_config_item.contribution_regular_er }}\">
                    </div>
                    <div class=\"xl:col-span-12\">
                        <label for=\"contribution_regular_ee\" class=\"inline-block mb-2 text-base font-medium\">Contribution Regular EE</label>
                        <input type=\"number\" step=\"0.01\" id=\"contribution_regular_ee\" name=\"contribution_regular_ee\" class=\"form-input numbers-only\" placeholder=\"Enter Contribution Regular EE\" value=\"{{ sss_config_item.contribution_regular_ee }}\">
                    </div>
                    <div class=\"xl:col-span-12\">
                        <label for=\"contribution_ec_er\" class=\"inline-block mb-2 text-base font-medium\">Contribution EC ER</label>
                        <input type=\"number\" step=\"0.01\" id=\"contribution_ec_er\" name=\"contribution_ec_er\" class=\"form-input numbers-only\" placeholder=\"Enter Contribution EC ER\" value=\"{{ sss_config_item.contribution_ec_er }}\">
                    </div>
                    <div class=\"xl:col-span-12\">
                        <label for=\"contribution_ec_ee\" class=\"inline-block mb-2 text-base font-medium\">Contribution EC EE</label>
                        <input type=\"number\" step=\"0.01\" id=\"contribution_ec_ee\" name=\"contribution_ec_ee\" class=\"form-input numbers-only\" placeholder=\"Enter Contribution EC EE\" value=\"{{ sss_config_item.contribution_ec_ee }}\">
                    </div>
                    <div class=\"xl:col-span-12\">
                        <label for=\"contribution_wisp_er\" class=\"inline-block mb-2 text-base font-medium\">Contribution WISP ER</label>
                        <input type=\"number\" step=\"0.01\" id=\"contribution_wisp_er\" name=\"contribution_wisp_er\" class=\"form-input numbers-only\" placeholder=\"Enter Contribution WISP ER\" value=\"{{ sss_config_item.contribution_wisp_er }}\">
                    </div>
                    <div class=\"xl:col-span-12\">
                        <label for=\"contribution_wisp_ee\" class=\"inline-block mb-2 text-base font-medium\">Contribution WISP EE</label>
                        <input type=\"number\" step=\"0.01\" id=\"contribution_wisp_ee\" name=\"contribution_wisp_ee\" class=\"form-input numbers-only\" placeholder=\"Enter Contribution WISP EE\" value=\"{{ sss_config_item.contribution_wisp_ee }}\">
                    </div>
                    <div class=\"xl:col-span-12\">
                        <label for=\"contribution_total_er\" class=\"inline-block mb-2 text-base font-medium\">Contribution Total ER</label>
                        <input type=\"number\" step=\"0.01\" id=\"contribution_total_er\" name=\"contribution_total_er\" class=\"form-input numbers-only\" placeholder=\"Enter Contribution Total ER\" value=\"{{ sss_config_item.contribution_total_er }}\">
                    </div>
                    <div class=\"xl:col-span-12\">
                        <label for=\"contribution_total_ee\" class=\"inline-block mb-2 text-base font-medium\">Contribution Total EE</label>
                        <input type=\"number\" step=\"0.01\" id=\"contribution_total_ee\" name=\"contribution_total_ee\" class=\"form-input numbers-only\" placeholder=\"Enter Contribution Total EE\" value=\"{{ sss_config_item.contribution_total_ee }}\">
                    </div>
                </div>
                <div class=\"flex justify-end gap-2 mt-4\">
                    <button type=\"reset\" id=\"close-modal\" data-modal-close=\"editModelType{{ sss_config_item.id }}\" class=\"text-red-500 bg-white btn\">Cancel</button>
                    <button type=\"submit\" class=\"text-white btn bg-custom-500\">Save</button>
                </div>
            </form>
        </div>
...
<div id=\"deleteSSSConfig{{sss_config_item.id}}\" modal-center class=\"fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show\">
    <div class=\"w-screen md:w-[25rem] bg-white shadow rounded-md dark:bg-zink-600\">
        <div class=\"max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto px-6 py-8\">
            <div class=\"float-right\">
                <button data-modal-close=\"deleteSSSConfig\" class=\"transition-all duration-200 ease-linear text-slate-500 hover:text-red-500\"><i data-lucide=\"x\" class=\"size-5\"></i></button>
            ...
            <form action=\"{{ path('app_sss_delete_config') }}\" method=\"post\">
                <input type=\"hidden\" name=\"sss_config_id\" value=\"{{sss_config_item.id}}\">
                <div class=\"mt-5 text-center\">
                    <h5 class=\"mb-1\">Are you sure?</h5>
                    <p class=\"text-slate-500 dark:text-zink-200\">Are you certain you want to delete this record?</p>
...
{% endblock %}", "sss_config/sss_config.html.twig", "C:\\xampp\\htdocs\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\sss_config\\sss_config.html.twig");
    }
}
