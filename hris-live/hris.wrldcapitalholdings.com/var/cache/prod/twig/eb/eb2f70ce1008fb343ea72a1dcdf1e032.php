...
class __TwigTemplate_a2232fbe40fd7df78156890f894a5398 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return new Source("", "@Security/Collector/icon.svg", "/var/www/hris.wrldcapitalholdings.com/vendor/symfony/security-bundle/Resources/views/Collector/icon.svg");
    }
}
