...
class __TwigTemplate_cef93c78ba9f1c40b5ceaa489205d22f extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("partials/base.html.twig", "administration/department.html.twig", 1);
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        yield "
            ";
        // line 6
        yield $this->extensions['Symfony\UX\TwigComponent\Twig\ComponentExtension']->render("breadcrumb", ["pagetitle" => "Department", "title" => "Department"]);
        yield "
        ...
        // line 78
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(Twig\Extension\CoreExtension::length($this->env->getCharset(), ($context["departments"] ?? null)), "html", null, true);
        yield "</b> Results</p>
                                    </div>
...
<div id=\"addDepartmentModal\" modal-center class=\"fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show \">
    <div class=\"w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600\">
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['divisionItem'], $context['_parent'], $context['loop']);
        $context = array_intersect_key($context, $_parent) + $_parent;
        // line 126
        yield "                    </select>
                </div>
...
";
        // line 227
        $context['_parent'] = $context;
        $context['_seq'] = CoreExtension::ensureTraversable(CoreExtension::getAttribute($this->env, $this->source, ($context["app"] ?? null), "flashes", ["status"], "method", false, false, false, 227));
...
";
    ...
    {
        return array (  456 => 240,  452 => 239,  447 => 238,  443 => 236,  439 => 234,  435 => 233,  429 => 230,  420 => 228,  416 => 227,  413 => 226,  398 => 217,  390 => 212,  386 => 211,  382 => 210,  377 => 208,  370 => 204,  358 => 195,  354 => 193,  349 => 186,  342 => 181,  335 => 179,  325 => 177,  315 => 175,  312 => 174,  308 => 173,  300 => 168,  292 => 163,  284 => 158,  280 => 157,  274 => 154,  266 => 150,  262 => 149,  249 => 138,  240 => 126,  227 => 124,  223 => 123,  205 => 108,  172 => 78,  158 => 66,  145 => 59,  139 => 56,  131 => 50,  127 => 49,  123 => 48,  119 => 47,  115 => 46,  111 => 45,  108 => 44,  104 => 43,  64 => 6,  61 => 5,  57 => 4,  49 => 2,  38 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "administration/department.html.twig", "C:\\xampp\\htdocs\\HRIS\\hris-live\\hris.wrldcapitalholdings.com\\templates\\administration\\department.html.twig");
    }
}
