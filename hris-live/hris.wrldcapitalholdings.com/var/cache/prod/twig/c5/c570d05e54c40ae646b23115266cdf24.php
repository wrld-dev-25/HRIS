...
class __TwigTemplate_23d50937d0c978a7d9c312b66bec5cc3 extends Template
{
    private $source;
    private $macros = [];
...
<div id=\"customizerButton\" drawer-end class=\"fixed inset-y-0 flex flex-col w-full transition-transform duration-300 ease-in-out transform bg-white shadow ltr:right-0 rtl:left-0 md:w-96 z-drawer show dark:bg-zink-600\">
    ...
    {
        return new Source("", "partials/_customizer.html.twig", "/var/www/hris.wrldcapitalholdings.com/templates/partials/_customizer.html.twig");
    }
}
