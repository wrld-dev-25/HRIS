document.addEventListener('DOMContentLoaded', function () {
    ...
    const submitBtn = document.querySelector('[data-action="finish"]');
    ...
    function updateButtonState() {
        ...
        currentTab >= 1 ? prevBtn.classList.remove("invisible") : prevBtn.add("invisible");
        currentTab == tabContents.length ? nextBtn.classList.add("hidden") : nextBtn.classList.remove("hidden") ;
        currentTab == tabContents.length ? submitBtn.classList.remove("hidden") : submitBtn.classList.add("hidden") ;
    }
