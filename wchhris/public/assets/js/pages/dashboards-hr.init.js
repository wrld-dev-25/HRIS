...
var totalDivisionChart = "";
var totalDepartmentChart = "";
var totalProjectChart = "";
var totalManpowerChart = "";
var applicationReceivedChart = "";

function loadCharts() {
    //  Total Employee
    var totalDivisionColors = "";
    totalDivisionColors = getChartColorsArray("totalDivision");
    if (totalDivisionColors) {
        var options = {
            series: [10],
            chart: {
                height: 110,
            ...
            colors: totalDivisionColors
        };

        if (totalDivisionChart != "")
            totalDivisionChart.destroy();
        totalDivisionChart = new ApexCharts(document.querySelector("#totalDivision"), options);
        totalDivisionChart.render();
    }

    //  Total Application
    var totalDepartmentColors = "";
    totalDepartmentColors = getChartColorsArray("totalDepartment");
    if (totalDepartmentColors) {
        var options = {
            series: [60],
            chart: {
                height: 110,
            ...
            labels: ['Total Employee'],
            colors: totalDepartmentColors
        };

        if (totalDepartmentChart != "")
            totalDepartmentChart.destroy();
        totalDepartmentChart = new ApexCharts(document.querySelector("#totalDepartment"), options);
        totalDepartmentChart.render();
    }

    //  Hired Candidates
    var totalProjectColors = "";
    totalProjectColors = getChartColorsArray("totalProject");
    if (totalProjectColors) {
        var options = {
            series: [25],
            chart: {
                height: 110,
            ...
            labels: ['Total Employee'],
            colors: totalProjectColors
        };

        if (totalProjectChart != "")
            totalProjectChart.destroy();
        totalProjectChart = new ApexCharts(document.querySelector("#totalProject"), options);
        totalProjectChart.render();
    }

    //  Rejected Candidates
    var totalManpowerColors = "";
    totalManpowerColors = getChartColorsArray("totalManpower");
    if (totalManpowerColors) {
        var options = {
            series: [75],
            chart: {
                height: 110,
            ...
            labels: ['Total Employee'],
            colors: totalManpowerColors
        };

        if (totalManpowerChart != "")
            totalManpowerChart.destroy();
        totalManpowerChart = new ApexCharts(document.querySelector("#totalManpower"), options);
        totalManpowerChart.render();
    }
