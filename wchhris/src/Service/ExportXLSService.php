...
{
    private function formatFilenameSegment(?string $value): ?string
    {
        if ($value === null) {
            return null;
        }
    ...
    private function buildExportFilename(string $prefix, string $dateFrom, string $dateTo, ?string $companyName = null): string
    {
        $segments = [$this->formatFilenameSegment($prefix)];
        $companySegment = $this->formatFilenameSegment($companyName);
        if ($companySegment !== null) {
            $segments[] = $companySegment;
        }
        $fromSegment = $this->formatFilenameSegment($dateFrom) ?? strtolower($dateFrom);
        $toSegment = $this->formatFilenameSegment($dateTo) ?? strtolower($dateTo);
        $segments[] = 'from-' . $fromSegment;
        $segments[] = 'to-' . $toSegment;
        return implode('_', array_filter($segments)) . '.xlsx';
    }
    ...
    public function exportProjects($filters, $data): Response
    {
        ...
        $filename = $this->buildExportFilename('Time_Sheet_Report', $dateFrom, $dateTo, null);
    ...
    public function generateSalaryAdjustmentsReport($dateFrom, $dateTo, $data, ?string $companyName = null): Response
    {
        // Initialize Spreadsheet
        $spreadsheet = new Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
        ...
        // Set header rows with variables
        $sheet->setCellValue('A1', $companyName ?: 'WRLD CAPITAL HOLDINGS INC.');
        ...
        $filename = $this->buildExportFilename('Salary_Adjustments_Report', $dateFrom, $dateTo, $companyName);
    ...
    public function generateTimeSheetReport($dateFrom, $dateTo, $data, ?string $companyName = null): Response
    {
        // Initialize Spreadsheet
        $spreadsheet = new Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
        ...
        $filename = $this->buildExportFilename('Time_Sheet_Report', $dateFrom, $dateTo, $companyName);
    ...
    public function generatePayrollSheetReport($dateFrom, $dateTo, $data, ?string $companyName = null): Response
    {
        // Initialize Spreadsheet
        $spreadsheet = new Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
        ...
        // Save the file
        $writer = new Xlsx($spreadsheet);
        $temp_file = tempnam(sys_get_temp_dir(), 'payroll_sheet_');
        $writer->save($temp_file);

        $fileName = $this->buildExportFilename('Payroll_Sheet', $dateFrom, $dateTo, $companyName);
    ...
    public function generatePayrollRegisterReport($dateFrom, $dateTo, $data, ?string $companyName = null): Response
    {
        // Initialize Spreadsheet
        $spreadsheet = new Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
        ...
        // Save the file
        $writer = new Xlsx($spreadsheet);
        $temp_file = tempnam(sys_get_temp_dir(), 'payroll_register_');
        $writer->save($temp_file);

        $fileName = $this->buildExportFilename('Payroll_Register', $dateFrom, $dateTo, $companyName);
    ...
    public function generatePayrollSummaryReport($dateFrom, $dateTo, $data, ?string $companyName = null) : Response
    {
        // Initialize Spreadsheet
        $spreadsheet = new Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
        ...
        // Set header rows with variables
        $sheet->setCellValue('A1', $companyName ?: 'ALSDC and WRLD CAPITAL HOLDINGS');
        $sheet->mergeCells('A1:O1'); // Adjust to fit the header width
        $sheet->getStyle('A1')->getFont()->setBold(true)->setSize(14);
        $sheet->getStyle('A1')->getAlignment()->setHorizontal('center');
        ...
        $filename = $this->buildExportFilename('Payroll_Summary_Report', $dateFrom, $dateTo, $companyName);
    ...
    public function generateCashAdvanceReport($dateFrom, $dateTo, $project, ?string $companyName = null): Response
    {
        // Initialize Spreadsheet
        $spreadsheet = new Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
        ...
        $filename = $this->buildExportFilename('Cash_Advance', $dateFrom, $dateTo, $companyName);
    ...
    public function generateTaxShieldReport($dateFrom, $dateTo, $data, ?string $companyName = null): Response
    {
        // Initialize Spreadsheet
        $spreadsheet = new Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
        ...
        $filename = $this->buildExportFilename('Tax_Shield', $dateFrom, $dateTo, $companyName);
    ...
    public function generateContributionReport($dateFrom, $dateTo, $data, ?string $companyName = null): Response
    {
        // Initialize Spreadsheet
        $spreadsheet = new Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
        ...
        $filename = $this->buildExportFilename('Contribution_Report', $dateFrom, $dateTo, $company_name);
    ...
    public function generateTotalContributionReport($dateFrom, $dateTo, $data, ?string $companyName = null): Response
    {
        // Initialize Spreadsheet
        $spreadsheet = new Spreadsheet();
        $sheet = $spreadsheet->getActiveSheet();
        ...
        $filename = $this->buildExportFilename('Total_Contribution_Report', $dateFrom, $dateTo, $companyName);
