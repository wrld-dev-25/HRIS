...
class SubModules
{
    ...
    #[ORM\Column(type: Types::ARRAY, nullable: true)]
    #[Groups(['user_permissions'])]
    private ?array $overtime_request = null;
    ...
    public function setPermissions(
        ...
        $this->overtime_request              = $overtime_request     ?? $defaultPermissions;
    
        return $this;
    }

    public function getOvertimeRequest(): ?array
    {
        return $this->overtime_request;
    }

    public function setOvertimeRequest(?array $overtime_request): static
    {
