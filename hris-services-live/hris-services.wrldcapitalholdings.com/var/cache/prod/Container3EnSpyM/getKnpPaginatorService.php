 ...
 */
class getKnpPaginatorService extends App_KernelProdDebugContainer
{
    /**
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['knp_paginator'] = $container->createProxy('PaginatorProxyF841c82', static fn () => \PaginatorProxyF841c82::createLazyProxy(static fn () => self::do($container, false)));
        }
