 ...
 */
class getYearlyHolidayRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\YearlyHolidayRepository' shared autowired service.
     *
     * @return \App\Repository\YearlyHolidayRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'YearlyHolidayRepository.php';

        return $container->privates['App\\Repository\\YearlyHolidayRepository'] = new \App\Repository\YearlyHolidayRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
