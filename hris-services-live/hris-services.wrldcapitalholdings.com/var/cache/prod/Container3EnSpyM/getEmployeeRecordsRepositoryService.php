 ...
 */
class getEmployeeRecordsRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmployeeRecordsRepository' shared autowired service.
     *
     * @return \App\Repository\EmployeeRecordsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmployeeRecordsRepository.php';

        return $container->privates['App\\Repository\\EmployeeRecordsRepository'] = new \App\Repository\EmployeeRecordsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
