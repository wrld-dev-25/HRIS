 ...
 */
class getPayrollGroupsRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\PayrollGroupsRepository' shared autowired service.
     *
     * @return \App\Repository\PayrollGroupsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PayrollGroupsRepository.php';

        return $container->privates['App\\Repository\\PayrollGroupsRepository'] = new \App\Repository\PayrollGroupsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
