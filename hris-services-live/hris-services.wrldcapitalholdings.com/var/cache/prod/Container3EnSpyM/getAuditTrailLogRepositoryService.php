 ...
 */
class getAuditTrailLogRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\AuditTrailLogRepository' shared autowired service.
     *
     * @return \App\Repository\AuditTrailLogRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AuditTrailLogRepository.php';

        return $container->privates['App\\Repository\\AuditTrailLogRepository'] = new \App\Repository\AuditTrailLogRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
