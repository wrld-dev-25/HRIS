 ...
 */
class getLoanHistoryRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\LoanHistoryRepository' shared autowired service.
     *
     * @return \App\Repository\LoanHistoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'LoanHistoryRepository.php';

        return $container->privates['App\\Repository\\LoanHistoryRepository'] = new \App\Repository\LoanHistoryRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
