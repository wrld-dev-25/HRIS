 ...
 */
class getPayrollCalculationConfigRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\PayrollCalculationConfigRepository' shared autowired service.
     *
     * @return \App\Repository\PayrollCalculationConfigRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PayrollCalculationConfigRepository.php';

        return $container->privates['App\\Repository\\PayrollCalculationConfigRepository'] = new \App\Repository\PayrollCalculationConfigRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
