 ...
 */
class getEmployeePayrollProfileRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmployeePayrollProfileRepository' shared autowired service.
     *
     * @return \App\Repository\EmployeePayrollProfileRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmployeePayrollProfileRepository.php';

        return $container->privates['App\\Repository\\EmployeePayrollProfileRepository'] = new \App\Repository\EmployeePayrollProfileRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
