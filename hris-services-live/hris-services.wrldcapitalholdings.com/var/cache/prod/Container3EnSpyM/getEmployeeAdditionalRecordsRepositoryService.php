 ...
 */
class getEmployeeAdditionalRecordsRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmployeeAdditionalRecordsRepository' shared autowired service.
     *
     * @return \App\Repository\EmployeeAdditionalRecordsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmployeeAdditionalRecordsRepository.php';

        return $container->privates['App\\Repository\\EmployeeAdditionalRecordsRepository'] = new \App\Repository\EmployeeAdditionalRecordsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
