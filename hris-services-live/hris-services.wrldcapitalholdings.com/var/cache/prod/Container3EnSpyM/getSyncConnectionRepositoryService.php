 ...
 */
class getSyncConnectionRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\SyncConnectionRepository' shared autowired service.
     *
     * @return \App\Repository\SyncConnectionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SyncConnectionRepository.php';

        return $container->privates['App\\Repository\\SyncConnectionRepository'] = new \App\Repository\SyncConnectionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
