 ...
 */
class getCashAdvanceRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\CashAdvanceRepository' shared autowired service.
     *
     * @return \App\Repository\CashAdvanceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CashAdvanceRepository.php';

        return $container->privates['App\\Repository\\CashAdvanceRepository'] = new \App\Repository\CashAdvanceRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
