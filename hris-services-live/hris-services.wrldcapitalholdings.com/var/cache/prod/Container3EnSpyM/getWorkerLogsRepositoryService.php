 ...
 */
class getWorkerLogsRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\WorkerLogsRepository' shared autowired service.
     *
     * @return \App\Repository\WorkerLogsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'WorkerLogsRepository.php';

        return $container->privates['App\\Repository\\WorkerLogsRepository'] = new \App\Repository\WorkerLogsRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
