 ...
 */
class getSelectedEmployeeLeavesRepositoryService extends App_KernelProdDebugContainer
{
    /**
     * Gets the private 'App\Repository\SelectedEmployeeLeavesRepository' shared autowired service.
     *
     * @return \App\Repository\SelectedEmployeeLeavesRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SelectedEmployeeLeavesRepository.php';

        return $container->privates['App\\Repository\\SelectedEmployeeLeavesRepository'] = new \App\Repository\SelectedEmployeeLeavesRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
